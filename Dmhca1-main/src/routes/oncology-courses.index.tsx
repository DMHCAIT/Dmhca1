...
export const Route = createFileRoute("/oncology-courses/")({
  head: () => ({
    meta: [
      { title: "Oncology Courses — DMHCA" },
      {
        name: "description",
        content: "Browse all oncology courses, fellowships, and certifications at DMHCA.",
      },
    ],
  }),
...
function SpecialtyCourses() {
  const categorySlug = "oncology";
  const displayName = "Oncology";
