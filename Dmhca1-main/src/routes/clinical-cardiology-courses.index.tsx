...
export const Route = createFileRoute("/clinical-cardiology-courses/")({
  head: () => ({
    meta: [
      { title: "Clinical Cardiology Courses — DMHCA" },
      {
        name: "description",
        content: "Browse all clinical cardiology courses, fellowships, and certifications at DMHCA.",
      },
    ],
  }),
...
function SpecialtyCourses() {
  ...
  const displayName = "Clinical Cardiology";
