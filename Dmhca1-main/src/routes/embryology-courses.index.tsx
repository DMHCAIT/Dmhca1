...
export const Route = createFileRoute("/embryology-courses/")({
  head: () => ({
    meta: [
      { title: "Embryology Courses — DMHCA" },
      {
        name: "description",
        content: "Browse all embryology courses, fellowships, and certifications at DMHCA.",
      },
    ],
  }),
