...
export const Route = createFileRoute("/critical-care-medicine-courses/")({
  head: () => ({
    meta: [
      { title: "Critical Care Medicine Courses — DMHCA" },
      {
        name: "description",
        content: "Browse all critical care medicine courses, fellowships, and certifications at DMHCA.",
      },
    ],
  }),
...
function SpecialtyCourses() {
  const categorySlug = "emergency";
  const displayName = "Critical Care Medicine";
