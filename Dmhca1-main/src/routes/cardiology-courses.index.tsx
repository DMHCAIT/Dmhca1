...
export const Route = createFileRoute("/cardiology-courses/")({
  head: () => ({
    meta: [
      { title: "Cardiology Courses — DMHCA" },
      {
        name: "description",
        content: "Browse all cardiology courses, fellowships, and certifications at DMHCA.",
      },
    ],
  }),
