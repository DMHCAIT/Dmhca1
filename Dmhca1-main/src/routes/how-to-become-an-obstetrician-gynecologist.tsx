...
export const Route = createFileRoute("/how-to-become-an-obstetrician-gynecologist")({
  head: () => ({
    meta: [
      { title: "How to Become an Obstetrician-Gynecologist - DMHCA" },
      { name: "description", content: "Step-by-step guide to becoming an obstetrician-gynecologist in India." },
    ],
  }),
  component: BlogPost,
});
...
function BlogPost() {
  ...
  const faqs = [
    {
      question: "What is an obstetrician-gynecologist and what do they do?",
      answer: "An obstetrician-gynecologist is a medical specialist who provides comprehensive care for women's reproductive health. Obstetricians manage pregnancy and childbirth, while gynecologists treat disorders of the female reproductive system. Many OB-GYNs provide both services."
    },
    {
      question: "What are the eligibility criteria to become an obstetrician-gynecologist?",
      answer: "Complete 12th with Physics, Chemistry, Biology, qualify NEET-UG for MBBS, complete 5.5 years of MBBS, one year of internship, then pursue MS (Master of Surgery) in Obstetrics & Gynecology specialization."
    },
    {
      question: "How long does it take to become an obstetrician-gynecologist?",
      answer: "Total time is 9.5-10 years: 5.5 years for MBBS, one year of internship, and 3 years for MS in Obstetrics & Gynecology. This is relatively shorter compared to other specialties, making it an attractive career option."
    },
    {
      question: "Is obstetrician-gynecology a competitive specialty?",
      answer: "OB-GYN is moderately to highly competitive due to high demand and relatively limited seats. You need to score in the top 5-10% in NEET-PG to secure a seat in prestigious institutes. Consistent preparation and clinical interest are essential."
    },
    {
      question: "What skills are essential for obstetrician-gynecology?",
      answer: "Strong clinical examination skills, excellent communication abilities for patient counseling, dexterity for surgical procedures, understanding of fetal physiology and pregnancy management, emergency handling capabilities, and compassionate patient care particularly for women's health issues."
    },
    {
      question: "What career options exist after becoming an obstetrician-gynecologist?",
      answer: "Work in hospitals, maternity centers, private clinics, establish private OB-GYN practice, teach in medical colleges, pursue sub-specialties like infertility or maternal-fetal medicine, work in healthcare policy, establish women's health centers, or work internationally in reproductive medicine."
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50">
      ...
      <section className="site-hero relative overflow-hidden">
        ...
        <div className="container-home max-w-5xl relative z-10">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">How to Become an Obstetrician-Gynecologist</h1>
          <p className="text-white/90 text-xl mb-6 max-w-2xl">Step-by-step guide to becoming an obstetrician-gynecologist in India</p>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          <div className="rounded-2xl overflow-hidden shadow-2xl">
            <img 
              src="/blog-images/How-to-Become-an-Obstetrician-Gynecologist.webp"
              alt="How to Become an Obstetrician-Gynecologist"
              className="w-full h-auto object-cover"
            />
          </div>
          <p className="text-center text-gray-600 text-sm mt-4">Comprehensive guide to pursuing obstetrics & gynecology as a medical specialty in India</p>
        </div>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="bg-blue-50 rounded-xl p-6 mb-12 border border-blue-200">
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#step-6" className="text-blue-600 hover:text-blue-700 text-sm">Step 6: Complete MS Obstetrics & Gynecology</a></li>
                <li><a href="#step-7" className="text-blue-600 hover:text-blue-700 text-sm">Step 7: Sub-specialization (Optional)</a></li>
              </ul>
            </div>
            ...
            <article className="space-y-8">
              <section>
                <h2 className="text-4xl font-bold text-gray-900 mb-6">Path to Becoming an Obstetrician-Gynecologist</h2>
                <p className="text-gray-700 text-lg leading-relaxed mb-6">
                  Becoming an obstetrician-gynecologist in India requires a systematic approach combining medical education, competitive entrance exams, and specialized training in women's health and reproductive medicine. This guide outlines the complete pathway to help you navigate your journey into this fulfilling medical specialty.
                </p>
              </section>
              ...
              <div id="step-1" className="bg-white rounded-xl p-8 border-l-4 border-blue-600 shadow-md hover:shadow-lg transition">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-700 mb-4">You must complete 12th with Science (Physics, Chemistry, Biology) from a recognized board. A strong foundation in these subjects is essential for medical studies and understanding reproductive biology.</p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-green-600 flex-shrink-0 mt-1" />
                        <span>Study 4.5 years of MBBS coursework including reproductive physiology</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-green-600 flex-shrink-0 mt-1" />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-green-600 flex-shrink-0 mt-1" />
                        <span>Study from OB-GYN textbooks and comprehensive resources</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-green-600 flex-shrink-0 mt-1" />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-green-600 flex-shrink-0 mt-1" />
                        <span>Secure good rank for MS OB-GYN seat allocation</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-green-600 flex-shrink-0 mt-1" />
                        <span>OB-GYN is moderately to highly competitive specialty</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div id="step-6" className="bg-white rounded-xl p-8 border-l-4 border-blue-600 shadow-md hover:shadow-lg transition">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-gray-900 mb-3">Complete MS Obstetrics & Gynecology (3 years)</h3>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-green-600 flex-shrink-0 mt-1" />
                      ...
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-green-600 flex-shrink-0 mt-1" />
                        <span>Undergo 3-year intensive training in OB-GYN</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-green-600 flex-shrink-0 mt-1" />
                        <span>Gain hands-on experience in obstetrics and gynecological surgery</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-green-600 flex-shrink-0 mt-1" />
              ...
              <div id="step-7" className="bg-white rounded-xl p-8 border-l-4 border-blue-600 shadow-md hover:shadow-lg transition">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-gray-900 mb-3">Sub-specialization (Optional)</h3>
                    <p className="text-gray-700 mb-4">After MS, you can pursue sub-specialties to advance your career:</p>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-purple-600 flex-shrink-0 mt-1" />
                        <span><strong>DM in Infertility & Reproductive Medicine</strong> - Specialize in fertility treatments</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-purple-600 flex-shrink-0 mt-1" />
                        <span><strong>Fellowship in Maternal-Fetal Medicine</strong> - Focus on high-risk pregnancy</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-purple-600 flex-shrink-0 mt-1" />
                        <span><strong>Fellowship in Gynecological Oncology</strong> - Pursue cancer treatment in women</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-8 border border-blue-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-white rounded-lg p-4">
                    <p className="text-gray-600 text-sm">MBBS to MS OB-GYN</p>
                    <p className="text-2xl font-bold text-blue-600">3-4 years</p>
                  </div>
                  <div className="bg-white rounded-lg p-4">
                    <p className="text-gray-600 text-sm">Total Duration</p>
                    <p className="text-2xl font-bold text-blue-600">9.5-10 years</p>
                  </div>
                </div>
              </div>
              ...
              <section className="bg-white rounded-xl p-8 border border-green-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700">Master surgical techniques early in training</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="bg-green-100 rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 mt-1">
                      <CheckCircle2 size={16} className="text-green-600" />
                    </div>
                    <p className="text-gray-700">Build strong communication skills for patient counseling</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="bg-green-100 rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 mt-1">
                      <CheckCircle2 size={16} className="text-green-600" />
                    </div>
                    <p className="text-gray-700">Develop proficiency in ultrasound techniques</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="bg-green-100 rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 mt-1">
                      <CheckCircle2 size={16} className="text-green-600" />
                    </div>
                    <p className="text-gray-700">Stay updated with latest obstetric practices</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="bg-green-100 rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 mt-1">
                      <CheckCircle2 size={16} className="text-green-600" />
                    </div>
                    <p className="text-gray-700">Cultivate compassion and empathy for patients</p>
                  </div>
                </div>
              </section>
            </article>
            ...
            <section className="mt-12 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 md:p-12 text-white">
              ...
              <p className="text-white/90 mb-6 text-lg">Need personalized guidance on pursuing obstetrics & gynecology? Our experts can help you plan your career path.</p>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              ...
              <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                ...
                <p className="text-sm text-gray-700">OB-GYN requires both clinical acumen and surgical skills. Build strong fundamentals in both areas during your MS training for comprehensive patient care.</p>
              </div>
            </div>
          </div>
        </div>
