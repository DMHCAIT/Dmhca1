...
export const Route = createFileRoute("/cosmetology-courses/")({
  head: () => ({
    meta: [
      { title: "Cosmetology Courses — DMHCA" },
      {
        name: "description",
        content: "Browse all cosmetology courses, fellowships, and certifications at DMHCA.",
      },
    ],
  }),
