...
export const Route = createFileRoute("/diabetology-courses/")({
  head: () => ({
    meta: [
      { title: "Diabetology Courses — DMHCA" },
      {
        name: "description",
        content: "Browse all diabetology courses, fellowships, and certifications at DMHCA.",
      },
    ],
  }),
