...
export const Route = createFileRoute("/${config.route}")({
  head: () => ({
    meta: [
      { title: "${title} - DMHCA" },
...
${mainContent}
            ...
            <section className="mt-12 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 md:p-12 text-white">
              ...
              <p className="text-white/90 mb-6 text-lg">Need personalized guidance? Our experts can help you plan your career path.</p>
