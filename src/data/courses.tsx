...
export const _courses: Course[] = [
  {
    ...
    faqs: [
      {
        q: "Who is eligible for a Fellowship in Echocardiography?",
        a: "Candidates with MBBS, MD/DNB (Medicine), DM Cardiology, or relevant clinical backgrounds are eligible; basic cardiology knowledge is preferred.",
      },
      {
        q: "What is the duration of a Fellowship in Echocardiography?",
        a: "The fellowship duration usually ranges from 10 to 12 months, depending on the training structure and clinical exposure.",
      },
      {
        q: "Can I do a Fellowship in Echocardiography after MBBS?",
        a: "Yes, MBBS graduates can pursue this fellowship to gain specialized skills in cardiac imaging and echocardiography.",
      },
      {
        q: "What are the career opportunities after a Fellowship in Echocardiography?",
        a: "Graduates can work as Echo Specialists, Cardiac Imaging Consultants, or in hospitals, diagnostic centers, and cardiac clinics.",
      },
      {
        q: "What is the fee for a Fellowship in Echocardiography?",
        a: "Fees vary based on course duration and clinical training; exact details are available on inquiry.",
      },
      {
        q: "What is the salary expectation after a Fellowship in Echocardiography?",
        a: "Salary depends on experience and location, with growth opportunities as clinical expertise increases.",
      },
    ],
    meta: {
      duration: "12 months",
    ...
    trainers: [{ name: "Dr. DMHCA Expert Faculty", title: "Echocardiography Specialist" }],
  },
  {
    ...
    heroDescription:
      "Certificate in Hypertension: Comprehensive Management of High Blood Pressure for Improved Patient Care",
    lessons: 35,
    months: 12,
    level: "intermediate",
    priceINR: 30000,
    ...
    moduleDetails: [
      [
        ...
        "Accurate BP measurement techniques",
      ...
      [
        ...
        "Pharmacological therapy (ACE inhibitors, ARBs, CCBs, diuretics, beta-blockers)",
        "Combination therapy strategies",
        "Follow-up and monitoring",
      ],
      [
        "Renal hypertension",
        "Endocrine causes (pheochromocytoma, hyperaldosteronism, thyroid disorders)",
    ...
    faqs: [
      {
        ...
        a: "MBBS, MD, MS, DGO, DNB holders and other healthcare professionals with a clinical background are eligible for the Certificate in Hypertension.",
      },
      {
        q: "What is the duration of the Certificate in Hypertension?",
        a: "The course runs for 12 months, providing comprehensive training in hypertension management and preventive care.",
      },
      {
        q: "What will I learn in this hypertension certification course?",
        a: "You’ll learn about blood pressure measurement, risk factors, diagnosis, treatment guidelines, lifestyle modification, and patient education for better outcomes.",
      },
      {
        q: "What are the career opportunities after completing this course?",
        a: "Graduates can work in hospitals, clinics, preventive care settings, and community health programs focusing on hypertension and cardiovascular risk management.",
      },
      {
        q: "What is the fee for the Certificate in Hypertension?",
        a: "Fees vary by program structure and training scope; exact details are available on inquiry or enrollment request with the academy.",
      },
      {
        q: "What is the salary expectation after completing the hypertension certificate?",
        a: "Salary depends on role, experience, and location; skilled professionals in hypertension care and chronic disease management typically earn competitive packages in clinical and preventive healthcare.",
      },
    ],
    meta: {
      duration: "12 months",
    ...
    trainers: [
      {
        ...
        bio: "Expert faculty with advanced training in interventional techniques.",
        image: "/logo.webp",
      },
    ],
  },
  {
    ...
    heroDescription:
      "Fellowship in Interventional Cardiology: Expertise in Advanced Cardiac Procedures and Life-Saving Interventions",
    lessons: 37,
    months: 12,
    level: "expert",
    priceINR: 190000,
    ...
    program: "Fellowship",
    overview:
      "The Fellowship in Interventional Cardiology is designed to provide specialized training in advanced cardiac procedures, including catheter-based treatments for heart disease. This program equips fellows with the skills needed to perform complex interventions like angioplasty, stent placement, and more, preparing them to manage critical cardiac conditions and improve patient outcomes.",
    ...
    faqs: [
      {
        q: "Who is eligible for a Fellowship in Interventional Cardiology?",
        a: "Candidates with a MD/MS/DM/DNB in Cardiology or equivalent cardiology qualification are eligible to pursue this advanced fellowship focused on interventional procedures.",
      },
      {
        q: "What is the duration of the Fellowship in Interventional Cardiology?",
        a: "The fellowship typically runs for 10–12 months, depending on the training structure.",
      },
      {
        q: "Can I do this fellowship after MD Cardiology?",
        a: "Yes, doctors who have completed MD/DNB Cardiology can pursue this program to gain specialized skills in cardiac interventions.",
      },
      {
        q: "What are the career opportunities after this fellowship?",
        a: "Graduates can work as Interventional Cardiologists, Cath Lab Specialists, Consultants in cardiac centers, hospitals, and specialized clinics.",
      },
      {
        q: "What is the fee for a Fellowship in Interventional Cardiology?",
        a: "Fees vary based on training duration and clinical exposure; detailed fee information is available on inquiry with the academy.",
      },
      {
        q: "What is the salary expectation after a Fellowship in Interventional Cardiology?",
        a: "Salary depends on knowledge, experience, and location; interventional cardiologists typically earn high salaries with strong growth potential in private and hospital settings.",
      },
    ],
    meta: {
      duration: "12 months",
    ...
    trainers: [{ name: "DMHCA Faculty", title: "Interventional Cardiology Specialists" }],
  },
  {
    ...
    heroDescription:
      "Become a Leader in Heart Health: Fellowship in Clinical Cardiology for Advanced Cardiovascular Care and Expertise",
    lessons: 70,
    months: 12,
    level: "expert",
    priceINR: 135000,
    ...
    program: "Fellowship",
    overview:
      "A Fellowship in Clinical Cardiology offers specialized training in diagnosing, managing, and treating a wide range of cardiovascular diseases. The program focuses on non-invasive and invasive cardiac procedures, patient care, and the latest advancements in cardiology. Fellows gain hands-on experience in echocardiography, cardiac catheterization, stress testing, and management of heart failure, preparing them for leadership roles in clinical cardiology and patient-centered cardiovascular care.",
    ...
    faqs: [
      {
        ...
        a: "MBBS and above-qualified professionals or those with relevant clinical experience can apply to strengthen cardiology expertise.",
      },
      {
        q: "What is the duration of this fellowship?",
        a: "The program typically runs for 10–12 months with structured clinical and theoretical training.",
      },
      {
        q: "Can I pursue it after MBBS?",
        a: "It is generally recommended for postgraduates in medicine or cardiology, as it requires advanced clinical understanding.",
      },
      {
        q: "What career opportunities are available after completion?",
        a: "Graduates can work as clinical cardiologists, consultants, or specialists in hospitals and cardiac care centers.",
      },
      {
        q: "What is the fee for this fellowship?",
        a: "Fees vary based on structure and clinical exposure; exact details are shared upon inquiry.",
      },
      {
        q: "What is the salary after completion?",
        a: "Salary depends on experience and location, with strong earning potential in both hospital and private practice settings.",
      },
    ],
    meta: {
      duration: "12 months",
    ...
    trainers: [{ name: "DMHCA Faculty", title: "Clinical Cardiology Specialists" }],
  },
  {
    ...
    requirements: ["MBBS/ MD/MS/Equivalent", "No previous experience is needed."],
    modules: ["Syllabus"],
    moduleDetails: [
      [
    ...
    trainers: [{ name: "DMHCA Faculty", title: "Cardiothoracic Surgery Specialists" }],
  },
  {
    ...
    trainers: [{ name: "DMHCA Faculty", title: "Cardio-Oncology Specialists" }],
  },
  ...
  // Radiology (5 courses)
  {
    ...
    heroDescription:
      "Advanced training in imaging of abdominal organs using ultrasound, Doppler, CT, and MRI with focus on oncologic.",
    lessons: 28,
    months: 6,
    level: "expert",
    priceINR: 110000,
    ...
    program: "Fellowship",
    overview:
      "The Fellowship in Abdominal Imaging is a focused postgraduate subspecialty training program designed to develop expertise in imaging of the abdominal organs, including the liver, pancreas, gastrointestinal tract, kidneys, adrenal glands, and retroperitoneum. The fellowship emphasizes multimodality imaging using ultrasound, Doppler, CT, and MRI, with strong focus on protocol optimization, accurate diagnosis, oncologic imaging, and clinical correlation. The program prepares radiologists for independent subspecialty practice in abdominal imaging.",
    ...
    moduleDetails: [
      ...
      [
        ...
        "Focal hepatic lesions and LI-RADS overview",
        "Biliary tree imaging",
        "Pancreatic inflammatory and neoplastic diseases",
        "MRCP and multiphasic CT protocols",
      ],
      [
        "Esophagus, stomach, and small bowel imaging",
        "Colorectal imaging",
        "Inflammatory bowel disease",
        "GI emergencies",
        "CT enterography overview",
      ],
      [
    ...
    faqs: [
      {
        q: "Who is the Fellowship in Abdominal Imaging designed for?",
        a: "This online program is suitable for OBG and radiology PG-qualified professionals, MBBS doctors, certified sonologists, and experienced residents seeking deeper expertise in abdominal imaging.",
      },
      {
        q: "What advanced imaging topics does the Abdominal Imaging fellowship at DMHCA cover?",
        a: "This fellowship from DMHCA focuses on ultrasound, CT, MRI interpretation of abdominal organs, liver and pancreas imaging, GI tract assessment, and evidence-based diagnostic strategies.",
      },
      {
        q: "How will I access the abdominal imaging fellowship content at DMHCA?",
        a: "The course is delivered via online lectures, expert-led sessions, case-based discussions, and comprehensive digital study materials accessible flexibly from anywhere.",
      },
      {
        q: "What improvements can this fellowship bring to my clinical practice?",
        a: "Completing this fellowship helps enhance your diagnostic confidence, deepen understanding of complex abdominal scans, and strengthen interpretation skills in cross-sectional imaging.",
      },
      {
        q: "What is the fee for the Abdominal Imaging fellowship at DMHCA?",
        a: "Fees vary depending on course structure and included learning resources; detailed pricing is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this abdominal imaging fellowship from DMHCA enhance my career and earning potential?",
        a: "Yes, This course providing advanced online training in abdominal imaging can boost your professional profile, expand clinical opportunities, and support higher earning prospects in radiology and diagnostic care.",
      },
    ],
    meta: {
      duration: "6 months",
  ...
  },
  {
    ...
    image: "/courses/fellowship_pulmonology.webp",
    lessons: 52,
    months: 12,
    level: "expert",
    priceINR: 140000,
    ...
    program: "Fellowship",
    heroDescription:
      "Advanced training in respiratory medicine including pulmonary diagnostics, critical respiratory care, and management of acute and chronic pulmonary disorders.",
    overview:
    ...
    requirements: ["MBBS / MD/MS or Equivalent"],
    ...
    faqs: [
      {
        q: "Who is eligible for the Fellowship in Pulmonology?",
        a: "MBBS, MD/MS or equivalent qualifications are required. Candidates should have a strong foundation in clinical medicine or internal medicine.",
      },
      {
        q: "What is the duration of the Fellowship in Pulmonology?",
        a: "The fellowship program runs for 12 months, providing comprehensive training in respiratory medicine and pulmonary diagnostics.",
      },
      {
        q: "What will I learn in this pulmonology fellowship?",
        a: "You'll learn respiratory system anatomy and physiology, diagnosis and management of pulmonary diseases, pulmonary function testing, imaging interpretation, bronchoscopy techniques, and critical respiratory care management.",
      },
      {
        q: "What are the career opportunities after this fellowship?",
        a: "Graduates can work as respiratory specialists in hospitals, clinics, research institutions, and critical care settings, managing respiratory diseases and providing expert pulmonary care.",
      },
      {
        q: "What is the fee for the Fellowship in Pulmonology?",
        a: "The program fee is ₹140,000. Payment options and financial arrangements are available on inquiry.",
      },
      {
        q: "What practical procedures will I learn?",
        a: "The program includes training in bronchoscopy, thoracentesis, pleural biopsy, airway management, and other pulmonary procedures with hands-on clinical experience.",
      },
    ],
    ...
    trainers: [
      {
        name: "DMHCA Faculty",
        title: "Pulmonology Specialists",
        bio: "Expert faculty with advanced training in respiratory medicine and pulmonary diagnostics.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Advanced fellowship focused on mammography, breast ultrasound, MRI, and early breast cancer diagnosis.",
    lessons: 23,
    months: 6,
    level: "expert",
    priceINR: 90000,
    ...
    program: "Fellowship",
    overview:
      "The Fellowship in Breast Imaging is a focused postgraduate subspecialty training program designed to develop expertise in the screening, diagnosis, and imaging-guided management of breast diseases. The fellowship provides structured training in mammography, breast ultrasound, breast MRI, and image-guided interventions, emphasizing early detection of breast cancer, standardized reporting, quality assurance, and multidisciplinary collaboration. The program prepares clinicians and radiologists for competent independent practice in breast imaging.",
    learn: [
      "Perform and interpret screening and diagnostic mammography.",
      "Conduct comprehensive breast ultrasound examinations.",
      "Interpret breast MRI studies using standard protocols.",
      "Apply BI-RADS classification accurately and consistently.",
      "Differentiate benign from malignant breast lesions.",
      "Participate in image-guided breast interventions (exposure).",
      "Correlate imaging findings with clinical and pathological data.",
      "Communicate imaging results effectively in multidisciplinary teams.",
      "Maintain radiation safety and quality assurance standards.",
      "Practice ethical, evidence-based breast imaging.",
    ],
    requirements: [
      "MD/ MS/ DNB/ PG Equivalent (OBG or Radio-diagnostic)",
      "MBBS, Sonologist / 6 months PCPNDT certificate/ resident doctor with 3 years’ experience",
    ...
    modules: [
      ...
      "Mammography",
      "Breast Ultrasound & Doppler",
      "Breast MRI & Interventional Exposure",
    ...
    moduleDetails: [
      [
        ...
        "Screening principles and protocols",
        "Breast density and risk assessment",
        "Reporting standards",
      ],
      [
        "Screening and diagnostic mammography",
        "Digital and tomosynthesis overview",
      ...
      [
        "Breast MRI protocols and interpretation",
    ...
    faqs: [
      {
        q: "Who can enroll in the Fellowship in Breast Imaging?",
        a: "This online program is suitable for MD, MS, DNB, or PG equivalent (OBG/Radio-diagnostic) holders and MBBS sonologists with PCPNDT certification or relevant experience seeking advanced breast imaging knowledge.",
      },
      {
        q: "What core topics are included in the Breast Imaging fellowship at DMHCA?",
        a: "This fellowship from DMHCA covers mammography, ultrasound evaluation, breast MRI interpretation, screening protocols, and evidence-based diagnostic strategies.",
      },
      {
        q: "How will I access the breast imaging fellowship content at DMHCA?",
        a: "The course is delivered via online lectures, expert-led sessions, case discussions, and comprehensive digital study materials that can be accessed flexibly from anywhere.",
      },
      {
        q: "In what ways can this fellowship improve clinical practice?",
        a: "Completing this fellowship helps enhance diagnostic confidence, improve interpretation accuracy, and strengthen your professional capabilities in breast imaging and cancer screening.",
      },
      {
        q: "What is the fee for the Breast Imaging fellowship at DMHCA?",
        a: "Fees vary depending on course structure and included learning resources; full pricing details are shared upon inquiry or enrollment request.",
      },
      {
        q: "Can the Breast Imaging fellowship from DMHCA support career advancement and higher earnings?",
        a: "Yes, This advanced online training in breast imaging can boost your professional credibility, expand clinical opportunities, and support enhanced earning potential in radiology and diagnostic practice.",
      },
    ],
    meta: {
      duration: "6 months",
  ...
  },
  {
    ...
    heroDescription:
      "Comprehensive imaging training for women's health including breast, gynecological, and pelvic imaging.",
    lessons: 27,
    months: 12,
    level: "expert",
    priceINR: 110000,
    ...
    moduleDetails: [
      [
        "Female pelvic and breast anatomy",
        "Imaging physics relevant to women’s imaging",
        "Ultrasound techniques and Doppler principles",
        "Radiation safety and contrast use",
        "Reporting standards and structured reports",
      ],
      [
        "Uterine and endometrial pathology",
        "Ovarian and adnexal masses",
        "Pelvic pain and infertility imaging",
        "Doppler assessment in gynecology",
      ...
      [
        ...
        "Image-guided breast interventions (exposure)",
      ],
      [
        "MRI of the female pelvis",
        "Gynecologic oncology imaging",
    ...
    faqs: [
      {
        q: "Who should enroll in the Fellowship in Women’s Imaging?",
        a: "This Course is designed for radiologists, gynecologists, obstetricians, and sonographers with MD/MS/DNB/PG equivalent (OBG or Radiodiagnosis) or eligible MBBS qualifications, the course provides structured online education in women’s health imaging.",
      },
      {
        q: "What advanced imaging skills are included in the Women’s Imaging fellowship at DMHCA?",
        a: "This fellowship from DMHCA covers breast imaging, pelvic ultrasound, obstetric and gynecologic imaging protocols, Doppler techniques, and interpretation of women’s health scans.",
      },
      {
        q: "How will I access the Women’s Imaging fellowship content at DMHCA?",
        a: "The course is delivered through online lectures, expert-led sessions, case-based discussions, and comprehensive digital study materials, allowing flexible learning from anywhere.",
      },
      {
        q: "How can this fellowship enhance my clinical imaging expertise?",
        a: "Completing this fellowship helps strengthen your interpretation skills, boost diagnostic confidence in women’s health imaging, and elevate your professional credibility.",
      },
      {
        q: "What is the fee for the Women’s Imaging fellowship at DMHCA?",
        a: "Fees vary based on course structure and included digital learning resources; full pricing details are provided upon inquiry or enrollment request.",
      },
      {
        q: "Can advanced online training in women’s imaging from DMHCA improve my career and earnings?",
        a: "Yes, after completing this fellowship can boost your professional profile, open advanced clinical opportunities, and support higher earning potential in women’s health and diagnostic imaging.",
      },
    ],
    meta: {
      duration: "12 months",
  ...
  },
  {
    ...
    heroDescription:
      "Master Advanced Techniques in Aesthetic Medicine with a Fellowship PG Diploma in Cosmetology for Career Growth",
    lessons: 46,
    months: 12,
    level: "expert",
    priceINR: 120000,
    ...
    moduleDetails: [
      ...
      ["Structure of skin", "Skin types and functions", "Aging of skin", "Skin microbiology"],
      ["Hair anatomy and growth cycle", "Hair loss disorders", "Nail anatomy and nail diseases"],
      [
      ...
      ["Botulinum toxin (Botox)", "Dermal fillers", "Mesotherapy", "Platelet-Rich Plasma (PRP)"],
      [
      ...
      ["PRP for hair loss", "Hair fall treatment", "Hair transplantation basics"],
      [
        "Patient assessment",
        "Case studies",
    ...
    faqs: [
      {
        q: "Who can apply for this PG Diploma course?",
        a: "The course is suitable for candidates with MBBS, MD, MS, DGO, or DNB qualifications seeking advanced academic knowledge in cosmetology and aesthetics.",
      },
      {
        q: "How is the PG Diploma in Cosmetology and Aesthetic Medicine delivered?",
        a: "The course is conducted through online lectures, digital study material, expert-guided sessions, and case-based discussions, allowing flexible learning from anywhere.",
      },
      {
        q: "What career benefits does this PG Diploma offer?",
        a: "Completing this course helps professionals enhance theoretical expertise, strengthen clinical understanding, and improve career prospects in cosmetology and aesthetic practice.",
      },
      {
        q: "What is the fee for the PG Diploma in Cosmetology and Aesthetic Medicine?",
        a: "Fees depend on the course structure and academic resources provided. Exact details are shared during the admission or inquiry process.",
      },
      {
        q: "Can this PG Diploma help increase professional income?",
        a: "Yes — advanced academic knowledge in cosmetology and aesthetic medicine can improve professional credibility, leading to better career opportunities and income growth.",
      },
    ],
    meta: {
      duration: "12 months",
  ...
  // Medicine (8 courses)
  {
    ...
    categories: ["medicine"],
    image: "/courses/pg_diploma_infectious_diseases.webp",
    heroDescription:
    ...
    faqs: [
      {
        q: "Who is eligible for enrolling in the PG Diploma in Infectious Diseases?",
        a: "The program is suitable for MBBS, MD/MS, and M.Sc. Nursing professionals seeking advanced expertise in infectious disease management.",
      },
      {
        q: "What key subjects are included in the PG Diploma in Infectious Diseases?",
        a: "The curriculum covers bacterial, viral, fungal, and parasitic infections, antimicrobial therapy, infection control, epidemiology, and outbreak management.",
      },
      {
        q: "What professional advantages can this diploma offer?",
        a: "This diploma enhances clinical decision-making, strengthens infectious disease expertise, and supports career advancement in healthcare settings.",
      },
      {
        q: "What is the fee for the PG Diploma in Infectious Diseases at DMHCA?",
        a: "Fees vary depending on the course structure and included learning resources; detailed pricing is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this infectious diseases diploma from DMHCA enhance my career and earning potential?",
        a: "Yes, it can improve professional credibility, expand specialized career opportunities, and support long-term career growth in healthcare.",
      },
    ],
    meta: {
      duration: "12 months",
  ...
  },
  {
    ...
    heroDescription:
      "The Certificate in Clinical Psychology is a short-term course that builds foundational knowledge of mental health, disorders, assessment, and basic counseling skills.",
    lessons: 25,
    months: 6,
    level: "intermediate",
    priceINR: 40000,
    ...
    program: "Certificate",
    overview:
      "A Certificate in Clinical Psychology is a short-term professional program designed to introduce learners to the fundamental concepts, theories, and practical skills used in the field of mental health. This course is ideal for students, healthcare professionals, counselors, social workers, and anyone interested in understanding human behavior, emotional wellbeing, and psychological disorders. It provides a strong foundation in how psychologists assess, diagnose, and support individuals facing mental health challenges.\n\nThe program typically covers key topics such as basic psychology principles, common mental health disorders, psychological assessment methods, counseling techniques, psychotherapy approaches, and ethical practices. Learners gain insight into conditions like anxiety, depression, personality disorders, stress-related disorders, and behavioral problems. The course also helps participants understand how biological, social, and environmental factors influence mental health.",
    ...
    requirements: ["Any graduate with psychology or allied health or nursing"],
    ...
    faqs: [
      {
        q: "Who can enroll in the Certificate in Clinical Psychology?",
        a: "This program is suitable for graduates with psychology, allied health, or nursing backgrounds seeking foundational knowledge in clinical psychology and mental health care.",
      },
      {
        q: "What topics are covered in the Certificate in Clinical Psychology?",
        a: "This certificate covers clinical psychology principles, mental health disorders, psychological assessment, counseling techniques, psychotherapy approaches, and ethical practices.",
      },
      {
        q: "How is the Certificate in Clinical Psychology delivered?",
        a: "The course is delivered through online lectures, expert-led sessions, case discussions, and digital study materials that can be accessed flexibly from anywhere.",
      },
      {
        q: "How can this certificate improve my professional practice?",
        a: "This certificate helps strengthen understanding of mental health conditions, improve counseling skills, and enhance confidence in psychological assessment and support.",
      },
      {
        q: "What is the fee for the Certificate in Clinical Psychology?",
      ...
      {
        q: "Can completing this certificate support career growth and earning potential?",
        a: "Yes, This specialized online training in clinical psychology can boost professional credibility, expand opportunities in mental health and counseling settings, and support enhanced income prospects in psychological care.",
      },
    ],
    meta: {
      duration: "6 months",
  ...
  },
  {
    ...
    image: "/courses/certificate_clinical_nutrition.webp",
    heroDescription:
      "Comprehensive Certificate in Clinical Nutrition: Master Dietary Strategies for Disease Prevention and Personalized Patient Care",
    lessons: 36,
    months: 6,
    level: "intermediate",
    priceINR: 28000,
    ...
    moduleDetails: [
      [
        ...
        "Nutritional assessment methods (anthropometry, dietary recall)",
      ...
      [
        ...
        "Calorie calculation and meal planning",
    ...
    faqs: [
      {
        q: "Who should consider enrolling in this clinical nutrition certificate course?",
        a: "The course welcomes MDS, dietitians, health assistants, BDS, MBBS, and AYUSH professionals aiming to build practical nutrition knowledge through flexible online study",
      },
      {
        q: "What key topics are included in the Certificate in Clinical Nutrition at DMHCA?",
        a: "This certificate from DMHCA covers macronutrient and micronutrient principles, clinical diet planning, metabolic health, therapeutic nutrition, and evidence-based dietary strategies.",
      },
      {
        q: "How is the Certificate in Clinical Nutrition delivered to students?",
        a: "The course is provided via online lectures, expert-led discussions, clinical case insights, and downloadable digital resources that you can access flexibly from anywhere.",
      },
      {
        q: "In what ways can this certificate improve my clinical practice?",
        a: "This certificate helps enhance your nutritional assessment skills, improve patient diet planning confidence, and deepen your understanding of nutrition-related health conditions.",
      },
      {
        q: "What is the fee for the Certificate in Clinical Nutrition at DMHCA?",
        a: "Fees vary depending on course structure and included learning resources; complete pricing information is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this clinical nutrition certificate from DMHCA boost my career and earning potential?",
        a: "Yes, This program in clinical nutrition can boost your professional credibility, expand your career opportunities, and support higher income prospects in clinical, community, and wellness settings.",
      },
    ],
    meta: {
      duration: "6 months",
  ...
  },
  {
    ...
    faqs: [
      {
        q: "Who should consider enrolling in the HIV Medicine certificate course?",
        a: "This online program is suitable for medical graduates, nursing graduates, AYUSH professionals, M.Sc (Microbiology or Biotechnology), and M.Pharm holders seeking focused knowledge in HIV care.",
      },

      {
        q: "What important topics are covered in the Certificate Course in HIV Medicine?",
        a: "This certificate from DMHCA explores HIV epidemiology, antiretroviral therapy basics, counseling strategies, opportunistic infections, and patient management principles through structured modules.",
      },

      {
        q: "How is the Certificate in HIV Medicine delivered by DMHCA?",
        a: "The course is offered via online lectures, expert-led discussions, evidence-based modules, and digital study materials, enabling you to learn flexibly from anywhere.",
      },

      {
        q: "What professional benefits can I expect after completing this certificate?",
        a: "Completing this certificate helps strengthen HIV care knowledge, improve patient management confidence, and enhance your professional credentials in HIV and infectious disease practice.",
      },

      {
        q: "What is the fee for the Certificate Course in HIV Medicine at DMHCA?",
        a: "Fees vary depending on course structure and included learning resources; detailed pricing information is shared upon inquiry or enrollment request.",
      },

      {
        q: "Can this HIV Medicine certificate from DMHCA support career growth and income potential?",
        a: "Yes, This Program is focused online training in HIV medicine can boost your professional credibility, expand clinical roles, and support improved earning opportunities in infectious disease and public health settings.",
      },
    ],
    meta: {
      duration: "6 months",
  ...
  },
  {
    ...
    faqs: [
      {
        q: "Who can benefit from enrolling in this TB certificate program?",
        a: "This online course is suitable for physicians, pulmonologists, nurses, public health workers, and healthcare professionals from medical and allied backgrounds seeking expertise in tuberculosis care.",
      },
      {
        q: "What will I learn in the Certificate in Tuberculosis course at DMHCA?",
        a: "This certificate from DMHCA covers TB epidemiology, diagnosis and screening methods, treatment regimens, drug resistance issues, and evidence-based patient management strategies.",
      },
      {
        q: "How is the Certificate in Tuberculosis delivered by DMHCA?",
        a: "The program is delivered through online lectures, expert-led discussions, case studies, and digital study materials that you can access easily from anywhere.",
      },
      {
        q: "In what ways can this certificate improve my clinical practice?",
        a: "This certificate helps enhance your skills in TB screening and management, improve patient counseling confidence, and deepen understanding of current TB protocols.",
      },
      {
        q: "What is the fee for the Certificate in Tuberculosis at DMHCA?",
        a: "Fees vary based on course structure and included learning resources; detailed pricing information is provided upon inquiry or enrollment request.",
      },
      {
        q: "Can completing this tuberculosis certificate from DMHCA support my career growth and earning potential?",
        a: "Yes, This Course is focused online training in TB medicine can boost your professional credibility, open clinical and public health opportunities, and support enhanced income prospects in infectious disease care.",
      },
    ],
    meta: {
      duration: "12 months",
  ...
  },
  {
    ...
    heroDescription:
      "A fellowship in nephrology provides advanced training in diagnosing and treating kidney diseases and disorders.",
    lessons: 48,
    months: 12,
    level: "expert",
    priceINR: 130000,
    ...
    program: "Fellowship",
    overview:
      "The Fellowship in Nephrology is a comprehensive one-year advanced training program designed to equip medical graduates with specialized knowledge and clinical competency in the prevention, diagnosis, and management of kidney diseases. This program bridges the gap between general medicine and subspecialty nephrology by providing intensive clinical exposure, hands-on procedural training, and evidence-based academic learning.",
    ...
    moduleDetails: [
      ...
      [
        "Types & causes of AKI",
        "KDIGO staging",
        "Prerenal/renal/postrenal AKI",
        "Drug-induced nephrotoxicity",
        "AKI in ICU & postoperative care",
      ],
      [
      ...
      [
        "Primary GN (MCD, FSGS, membranous, IgA, MPGN)",
        "Secondary GN (lupus, vasculitis)",
        "Renal immunology basics",
        "Approach to hematuria & proteinuria",
      ],
      [
        "HD machine basics",
        "Dialyzers & membranes",
        "Vascular access (AVF, AVG, catheters)",
      ...
      [
        ...
        "CRRT modalities (CVVH, CVVHD, CVVHDF)",
        "SLED",
      ...
      [
        ...
        "Pediatric dialysis basics",
      ],
      [
        "Kidney stones & metabolic evaluation",
        "Obstructive uropathy",
        "Hydronephrosis",
        "Imaging: USG, Doppler, CT, MRI",
        "Urodynamic basics",
      ],
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Fellowship in Rheumatology: Specialized Training in Diagnosing and Managing Rheumatic Diseases for Enhanced Patient Care",
    lessons: 24,
    months: 12,
    level: "expert",
    priceINR: 130000,
    ...
    moduleDetails: [
      [
        "Understanding basic anatomy of all joints",
        "Basic X-ray training of all joints",
        "How to approach different cases of rheumatic diseases",
      ],
      [
        "Measuring diseases activity",
        "Assessing damage of joints",
      ...
      [
        ...
        "PAN & Cryoglobulin vasculitis",
      ],
      [
        "Skin & Rheumatic disease",
        "Eyes & Rheumatic disease",
        "Lung & Rheumatic disease",
        "Kidney & Rheumatic disease",
      ],
    ],

    faqs: [
      {
        q: "Who is the Fellowship in Rheumatology designed for?",
        a: "This program is designed for MBBS/MS/MD/DNB or equivalent holders and provides structured online education in rheumatology.",
      },
      {
        q: "What major subjects are covered in the Rheumatology fellowship at DMHCA?",
        a: "This fellowship includes inflammatory arthritis, autoimmune disorders, diagnostic strategies, therapeutic approaches, and evidence-based management of musculoskeletal conditions.",
      },
      {
        q: "How will I access the Rheumatology fellowship training with DMHCA?",
        a: "The course is delivered through online lectures, expert-led discussions, clinical case reviews, and digital study materials accessible from anywhere.",
      },
      {
        q: "How can completing this fellowship improve my clinical practice?",
        a: "It helps enhance diagnostic confidence, deepen understanding of rheumatic conditions, and strengthen treatment planning skills.",
      },
      {
        q: "What are the fees for the Rheumatology fellowship at DMHCA?",
        a: "Fees vary based on course structure and learning resources; detailed pricing information is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this Rheumatology fellowship from DMHCA boost career opportunities and income potential?",
        a: "Yes, it can boost professional credibility, expand clinical roles, and support enhanced earning prospects in rheumatology and related specialties.",
      },
    ],
    meta: {
      duration: "12 months",
  ...
  // Obstetrics & Gynecology (8 courses)
  {
    ...
    faqs: [
      {
        q: "Who can enroll in the Certification in Obstetrics and Gynecology Nursing program?",
        a: "This program is suitable for nursing professionals and individuals from medical and healthcare backgrounds seeking specialized knowledge in obstetric and gynecological nursing through online learning.",
      },
      {
        q: "What topics are covered in the Certification in Obstetrics and Gynecology Nursing?",
        a: "This certification covers antenatal, intranatal, postnatal, neonatal, and gynecological nursing care, along with reproductive health, family planning, and obstetric emergency management.",
      },
      {
        q: "How is the Certification in Obstetrics and Gynecology Nursing delivered?",
        a: "The course is delivered through online lectures, expert-led sessions, case discussions, and digital study materials that can be accessed flexibly from anywhere.",
      },
      {
        q: "How can this certification improve my professional practice?",
        a: "This certification helps strengthen maternal and reproductive healthcare knowledge, improve patient care skills, and enhance confidence in obstetric and gynecological nursing practice.",
      },
      {
        q: "What is the fee for the Certification in Obstetrics and Gynecology Nursing?",
        a: "Fees vary based on course structure and included learning resources; detailed pricing information is provided upon inquiry or enrollment request.",
      },
      {
        q: "Can completing this certification support career growth and earning potential?",
        a: "Yes, This specialized online training in obstetric and gynecological nursing can boost professional credibility, expand career opportunities, and support enhanced income prospects in maternal healthcare settings.",
      },
    ],
    meta: {
      duration: "6 months",
  ...
  },
  {
    ...
    heroDescription:
      "Enhance your expertise in maternal and child care - learn prenatal, postnatal, and pediatric practices to deliver better healthcare outcomes.",
    lessons: 48,
    months: 12,
    level: "expert",
    priceINR: 100000,
    ...
    faqs: [
      {
        q: "Who is eligible for enrolling in the PG Diploma in Maternal & Child Health?",
        a: "The program is suitable for MBBS, BDS, BAMS, BHMS, BNYS, BUMS, and equivalent healthcare professionals seeking specialized knowledge in maternal and child healthcare.",
      },
      {
        q: "What key subjects are included in the PG Diploma in Maternal & Child Health?",
        a: "The curriculum covers antenatal care, childbirth management, neonatal care, child development, nutrition, immunization, and community health programs.",
      },
      {
        q: "What professional advantages can this diploma offer?",
        a: "This diploma enhances clinical and public health expertise, helping professionals improve maternal and child healthcare outcomes and advance their careers.",
      },
      {
        q: "What is the fee for the PG Diploma in Maternal & Child Health at DMHCA?",
        a: "Fees vary depending on the course structure and included learning resources; detailed pricing is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this maternal and child health diploma from DMHCA enhance my career and earning potential?",
        a: "Yes, it can strengthen professional credibility, expand healthcare career opportunities, and support long-term career growth in maternal and child health services.",
      },
    ],
    meta: {
      duration: "12 months",
  ...
  },
  {
    ...
    faqs: [
      {
        q: "Who should enroll in the Fellowship in High-Risk Pregnancy?",
        a: "This course welcomes MBBS/MD/MS/DGO/DNB or equivalent healthcare professionals seeking advanced knowledge in maternal-fetal medicine and the management of high-risk pregnancies through structured learning.",
      },
      {
        q: "What advanced topics are included in the Fellowship in High-Risk Pregnancy?",
        a: "This fellowship covers high-risk pregnancy assessment, hypertensive disorders, gestational diabetes, fetal growth restriction, fetal monitoring, obstetric emergencies, critical care, maternal-fetal surveillance, and evidence-based management strategies.",
      },
      {
        q: "How is the High-Risk Pregnancy fellowship delivered?",
        a: "The course is provided through online lectures, expert-led discussions, case-based modules, clinical scenarios, and comprehensive digital study materials.",
      },
      {
        q: "How will this fellowship help improve my clinical practice?",
        a: "It helps strengthen clinical decision-making, improve fetal surveillance skills, enhance management of obstetric complications, and increase confidence in handling complex maternal-fetal cases.",
      },
      {
        q: "What is the fee for the High-Risk Pregnancy fellowship?",
        a: "Fees vary based on course structure and included learning resources; detailed pricing is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this fellowship enhance my career prospects and earnings?",
        a: "Yes, it can boost your professional profile, expand opportunities in obstetrics and maternal-fetal medicine, and support higher earning potential in hospitals, maternity centers, and specialized pregnancy care services.",
      },
    ],
    meta: {
      duration: "12 months",
  ...
  },
  {
    ...
    heroDescription:
      "Advanced Fellowship in Fetal Medicine: Specialized Training for Excellence in Prenatal Diagnosis and Care",
    lessons: 28,
    months: 12,
    level: "expert",
    priceINR: 150000,
    ...
    faqs: [
      {
        q: "Who should enroll in the Fetal Medicine fellowship?",
        a: "This course welcomes MBBS/MD/MS or equivalent professionals aiming to enhance their knowledge of fetal medicine through structured online learning.",
      },
      {
        q: "What advanced topics are included in the Fellowship in Fetal Medicine?",
        a: "This fellowship covers fetal assessment techniques, prenatal screening protocols, diagnosis of fetal abnormalities, maternal-fetal medicine principles, and evidence-based care strategies.",
      },
      {
        q: "How is the Fetal Medicine fellowship delivered?",
        a: "The course is provided through online lectures, expert-led discussions, case-based modules, and comprehensive digital study materials.",
      },
      {
        q: "How will this fellowship help improve my clinical practice?",
        a: "It helps enhance prenatal diagnostic skills, strengthen decision-making in complex fetal care, and increase confidence in managing high-risk pregnancies.",
      },
      {
        q: "What is the fee for the Fetal Medicine fellowship?",
        a: "Fees vary based on course structure and included learning resources; detailed pricing is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this fellowship enhance my career prospects and earnings?",
        a: "Yes, it can boost your professional profile, expand clinical roles, and support higher earning potential in obstetrics, maternal-fetal medicine, and prenatal care.",
      },
    ],
    meta: {
      duration: "12 months",
  ...
  },
  {
    ...
    heroDescription:
      "Specialized fellowship offering advanced training in obstetric ultrasound, fetal imaging, Doppler, and prenatal diagnosis.",
    lessons: 24,
    months: 6,
    level: "expert",
    priceINR: 80000,
    ...
    moduleDetails: [
      [
        ...
        "First-trimester screening overview",
        "Multiple pregnancy assessment",
      ],
      [
        "Systematic fetal anatomy evaluation",
        "CNS, cardiac, abdominal, and skeletal assessment",
        "Soft markers and chromosomal risk assessment",
        "Placental and cord abnormalities",
        "Reporting standards",
      ],
      [
        "Fetal biometry and growth charts",
      ...
      [
        ...
        "Umbilical and MCA Doppler",
        "Doppler in preeclampsia and IUGR",
        "Twin and multiple pregnancy Doppler",
        "Clinical correlation",
      ],
      [
        "Ultrasound in obstetric emergencies",
        "Fetal well-being assessment (BPP, NST )",
        "Project work",
        "Communication and reporting excellence",
      ],
    ],
    ...
    faqs: [
      {
        q: "Who should consider enrolling in the Fellowship in Obstetrics Ultrasound?",
        a: "This Course is open to MD, MS, DNB, or PG equivalent (OBG or Radiodiagnosis) professionals, as well as MBBS-qualified sonologists with a 6-month PCPNDT certificate or resident doctors with 3 years of experience, this program offers advanced theoretical training in obstetric ultrasound through online learning.",
      },
      {
        q: "What specialized skills are taught in the Obstetrics Ultrasound fellowship at DMHCA?",
        a: "This fellowship from DMHCA includes fetal imaging techniques, prenatal anatomy scanning, Doppler protocols, anomaly detection, and evidence-based interpretation.",
      },
      {
        q: "How is the Obstetrics Ultrasound fellowship program delivered by DMHCA?",
        a: "The course is provided through online lectures, expert-led discussions, real-world case insights, and comprehensive digital resources, allowing flexible learning from anywhere.",
      },
      {
        q: "What improvements can this fellowship bring to my clinical practice?",
        a: "Completing this fellowship helps enhance ultrasound interpretation accuracy, improve prenatal diagnostic confidence, and strengthen your professional profile in obstetric care.",
      },
      {
        q: "What is the fee for the Obstetrics Ultrasound fellowship at DMHCA?",
        a: "Fees vary based on course structure and included digital study materials; detailed pricing is available upon inquiry or enrollment request.",
      },
      {
        q: "Can the Obstetrics Ultrasound fellowship from DMHCA help enhance my career and income potential?",
        a: "Yes, This advanced online training in obstetric ultrasound can boost your professional credibility, expand clinical roles, and support higher earning opportunities in prenatal diagnostic and maternal-fetal care.",
      },
    ],
    meta: {
      duration: "6 months",
  ...
  },
  {
    ...
    heroDescription:
      "Advanced minimal invasive gynecological surgery training including laparoscopy and hysteroscopy procedures.",
    lessons: 35,
    months: 12,
    level: "expert",
    priceINR: 190000,
    ...
    requirements: ["MBBS,MS/ MD/ DGO/ DNB", "No previous experience is needed."],
    ...
    moduleDetails: [
      ...
      ["Fetal endoscopy", "Laparoscopic abdominal cerclage"],
      [
    ...
    faqs: [
      {
        q: "Who is eligible for the Fellowship in Laparoscopy and Hysteroscopy?",
        a: "This online program is suitable for MBBS, MS, MD, DGO, or DNB-qualified professionals seeking to deepen their knowledge of minimally invasive gynecologic surgery.",
      },
      {
        q: "What surgical areas are covered in the Laparoscopy and Hysteroscopy fellowship at DMHCA?",
        a: "This fellowship explores minimally invasive laparoscopy techniques, hysteroscopic procedures, surgical planning, and procedural interpretation through structured expert modules.",
      },
      {
        q: "How does DMHCA deliver the Laparoscopy and Hysteroscopy fellowship curriculum?",
        a: "The course is delivered through online lectures, expert-led discussions, case-oriented content, and comprehensive digital study resources with flexible access from anywhere.",
      },
      {
        q: "How can completing this fellowship improve my surgical practice?",
        a: "Completing this fellowship helps strengthen your understanding of minimally invasive gynecologic procedures, enhance clinical decision-making, and elevate your professional confidence in surgical care.",
      },
      {
        q: "What is the fee for the Laparoscopy and Hysteroscopy fellowship at DMHCA?",
        a: "Fees vary based on course structure and included learning resources; comprehensive pricing details are shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this online fellowship from DMHCA enhance my career prospects and earning potential?",
        a: "Yes, this course in laparoscopy and hysteroscopy can boost your professional profile, expand clinical opportunities, and support higher earning potential in gynecologic surgery and women’s health care.",
      },
    ],
    meta: {
      duration: "12 months",
  ...
  },
  {
    ...
    heroDescription:
      "Enhance Women's Health and Aesthetics: Fellowship in Cosmetic Gynecology for Advanced Surgical and Non-Surgical Techniques.",
    lessons: 23,
    months: 12,
    level: "expert",
    priceINR: 140000,
    ...
    requirements: ["MBBS / DGO / MS / MD", "No previous experience is needed."],
    ...
    faqs: [
      {
        q: "Who is eligible for the Fellowship in Cosmetic Gynecology?",
        a: "This program is designed for MBBS/DGO/MS/MD-qualified professionals seeking structured training in cosmetic and functional gynecology with no prior experience required.",
      },
      {
        q: "What topics are covered in this fellowship?",
        a: "It covers aesthetic gynecology, non-surgical energy-based treatments, PRP applications, surgical procedures, sexual health, and evidence-based clinical care.",
      },
      {
        q: "How is the fellowship delivered?",
        a: "The course is delivered via online lectures, expert-led discussions, case-based learning, and digital study materials accessible from anywhere.",
      },
      {
        q: "What career benefits does it offer?",
        a: "It enhances clinical expertise in women’s aesthetic health, improves patient management skills, and expands opportunities in cosmetic gynecology practice.",
      },
      {
        q: "What is the fee for this fellowship?",
        a: "Fees vary based on course structure and included resources; exact details are shared during inquiry or enrollment.",
      },
      {
        q: "Can it improve earning potential?",
        a: "Yes, specialized training in cosmetic gynecology can increase professional credibility and expand income opportunities in private and aesthetic practice.",
      },
    ],
    meta: {
      duration: "12 months",
  ...
  },
  {
    ...
    heroDescription:
      "Advance Women's Health: Fellowship in Obstetrics & Gynecology for Expertise in Reproductive and Maternal Care.",
    lessons: 68,
    months: 12,
    level: "expert",
    priceINR: 135000,
    ...
    overview:
      "A Fellowship in Obstetrics & Gynecology offers specialized training in the comprehensive care of women’s reproductive health, pregnancy, and childbirth. The program provides advanced education in high-risk obstetrics, gynecologic surgery, reproductive endocrinology, and fertility management. Fellows gain hands-on experience in managing complex pregnancies, performing gynecologic procedures, and addressing reproductive health concerns, preparing them for leadership roles in women’s healthcare.",
    ...
    faqs: [
      {
        q: "Who can enroll in this fellowship?",
        a: "Candidates with MBBS, MD, MS, or equivalent qualifications can apply to enhance their expertise in obstetrics and gynecology.",
      },
      {
        q: "What areas are covered in this program?",
        a: "It covers pregnancy care, labor management, gynecological disorders, reproductive health, oncology, and evidence-based clinical practice.",
      },
      {
        q: "How is the fellowship delivered?",
        a: "The program is delivered through online lectures, expert sessions, case discussions, and digital learning materials accessible from anywhere.",
      },
      {
        q: "What skills will I gain after completion?",
        a: "You will improve clinical decision-making, patient management skills, and confidence in handling obstetric and gynecological cases.",
      },
      {
        q: "What is the fee for this fellowship?",
        a: "Fees vary based on structure and learning resources; exact details are provided during inquiry or enrollment.",
      },
      {
        q: "Can this fellowship improve career growth?",
        a: "Yes, it enhances clinical expertise, professional credibility, and can improve career opportunities and earning potential.",
      },
    ],
    meta: {
      duration: "12 months",
...

  {
    ...
    heroDescription:
      "Apply for Pediatric rheumatology fellowship training to treat childhood rheumatic conditions.",
    lessons: 42,
    months: 12,
    level: "expert",
    priceINR: 145000,
    ...
    moduleDetails: [
      [
        ...
        "Pediatric immune system & mechanisms of autoimmunity",
        "Musculoskeletal examination in children",
        "Clinical approach to a child with joint pain or swelling",
        "Orientation to inpatient, outpatient, and day-care workflows",
      ],
      [
        "Laboratory evaluation: inflammatory markers, autoantibodies, complements",
        "Synovial fluid analysis basics",
        "Radiology: X-ray, MRI, CT relevant to rheumatology",
        "Introduction to musculoskeletal ultrasound",
        "Pattern recognition in pediatric arthritis",
      ],
      [
        "Clinical presentation and diagnostic criteria",
        "Management with NSAIDs, steroids, csDMARDs",
        "IL 1, IL 6, and TNF inhibitors",
      ...
      [
        ...
        "Organ involvement monitoring and multidisciplinary care",
      ],
      [
        "Kawasaki disease, IgA vasculitis, PAN, Takayasu disease",
        "ANCA-associated vasculitis in children",
        "Periodic fever syndromes",
        "Genetic testing indications and pathways",
      ],
      [
        "Chronic pain syndromes: juvenile fibromyalgia",
        "Hypermobility & EDS spectrum disorders",
        "Metabolic bone disease",
        "Infectious & post-infectious arthritis",
        "Orthopedic mimickers of rheumatologic disease",
      ],
      [
        "TB-related musculoskeletal disease",
        "Viral and bacterial reactive arthritis",
        "Local prevalent infections mimicking autoimmune disease",
        "Vaccination protocols for immunosuppressed children",
      ],
      [
        "Monitoring DMARDs & biologics",
        "Psychosocial and school-related issues",
        "Adolescent transition to adult rheumatology",
        "Rehabilitation and physiotherapy integration",
      ],
      [
        "Joint aspiration & intra-articular injections",
        "Sedation methods & safety in children",
    ...
    faqs: [
      {
        q: "Who is the Pediatric Rheumatology fellowship designed for?",
        a: "The program is ideal for pediatricians, rheumatologists, internal medicine doctors, and healthcare professionals seeking deeper expertise in managing pediatric rheumatic disorders through structured online learning.",
      },
      {
        q: "What advanced pediatric rheumatology topics are included in this fellowship?",
        a: "This fellowship from DMHCA explores juvenile arthritis, autoimmune and inflammatory disorders, diagnostic evaluation, therapeutic approaches, and evidence-based care for musculoskeletal conditions in children.",
      },
      {
        q: "How will I access the pediatric rheumatology training at DMHCA?",
        a: "The course is delivered via online lectures, expert-led discussions, case-based insights, and comprehensive digital study resources that learners can access flexibly from anywhere.",
      },
      {
        q: "What benefits can this fellowship bring to my clinical practice?",
        a: "Completing this fellowship helps enhance pediatric rheumatologic assessment skills, improve clinical decision-making, and strengthen professional confidence in treating children with rheumatic conditions.",
      },
      {
        q: "What is the fee for the Pediatric Rheumatology fellowship at DMHCA?",
        a: "Fees vary based on course structure and included digital learning materials; comprehensive pricing details are provided upon inquiry or enrollment request.",
      },
      {
        q: "Can this online fellowship from DMHCA enhance my career prospects and earnings?",
        a: "Yes, This online training in pediatric rheumatology can boost your professional credibility, expand clinical roles, and support higher earning opportunities in pediatric care and autoimmune disease management.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Gain advanced skills in nutrition, diet planning, and wellness management in PG Diploma in Nutrition and Dietetics.",
    lessons: 32,
    months: 50,
    level: "expert",
    priceINR: 100000,
    ...
    faqs: [
      {
        q: "Who is eligible for enrolling in the PG Diploma in Nutrition and Dietetics?",
        a: "The program is suitable for Any Graduate, B.Sc., B. Pharma, MBBS, BDS, BUMS, and BAMS graduates seeking specialized knowledge in nutrition and dietetics.",
      },
      {
        q: "What key subjects are included in the PG Diploma in Nutrition and Dietetics?",
        a: "The curriculum covers human nutrition, food science, clinical nutrition, therapeutic diets, food safety, community nutrition, and nutrition education.",
      },
      {
        q: "What professional advantages can this diploma offer?",
        a: "This diploma enhances expertise in nutrition assessment, diet planning, therapeutic nutrition, and wellness management, supporting career growth in healthcare and nutrition sectors.",
      },
      {
        q: "What is the fee for the PG Diploma in Nutrition and Dietetics at DMHCA?",
        a: "Fees vary depending on the course structure and included learning resources; detailed pricing is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this nutrition and dietetics diploma from DMHCA enhance my career and earning potential?",
        a: "Yes, it can strengthen professional credibility, expand opportunities in healthcare, wellness, and nutrition services, and support long-term career growth.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Gain hands-on expertise in IVF, embryology lab techniques, and reproductive science to advance your career in fertility care.",
    lessons: 26,
    months: 6,
    level: "intermediate",
    priceINR: 350000,
    ...
    requirements: ["Graduation: Medical/ Healthcare"],
    ...
    faqs: [
      {
        q: "Who can enroll in the Certificate in Clinical Embryology?",
        a: "This program is suitable for graduates from medical and healthcare backgrounds seeking specialized knowledge in clinical embryology and assisted reproductive technologies through online learning.",
      },
      {
        q: "What topics are covered in the Certificate in Clinical Embryology?",
        a: "This certificate covers embryology laboratory techniques, gamete handling, IVF, ICSI, embryo culture, cryopreservation, and quality control practices in fertility laboratories.",
      },
      {
        q: "How is the Certificate in Clinical Embryology delivered?",
        a: "The course is delivered through online lectures, expert-led sessions, case discussions, and digital study materials that can be accessed flexibly from anywhere.",
      },
      {
        q: "How can this certificate improve my professional practice?",
        a: "This certificate helps strengthen embryology laboratory knowledge, improve understanding of ART procedures, and enhance confidence in fertility care and reproductive medicine.",
      },
      {
        q: "What is the fee for the Certificate in Clinical Embryology?",
        a: "Fees vary based on course structure and included learning resources; detailed pricing information is provided upon inquiry or enrollment request.",
      },
      {
        q: "Can completing this certificate support career growth and earning potential?",
        a: "Yes, This specialized online training in clinical embryology can boost professional credibility, expand opportunities in fertility centers and IVF laboratories, and support enhanced income prospects in reproductive medicine.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Certificate in Obesity Management is designed to enhance clinical skills in obesity assessment and treatment.",
    lessons: 26,
    months: 6,
    level: "intermediate",
    priceINR: 35000,
    ...
    requirements: ["MBBS, BAMS, BHMS, BUMS, or Equivalent"],
    ...
    faqs: [
      {
        q: "Who is eligible for the Certificate in Obesity Management?",
        a: "Candidates with MBBS, BAMS, BHMS, BUMS, or equivalent qualifications are eligible. No prior experience is required.",
      },
      {
        q: "What is the duration of the Certificate in Obesity Management?",
        a: "The course duration is approximately 24 weeks, allowing flexible online learning.",
      },
      {
        q: "Can I do the Certificate in Obesity Management after MBBS?",
        a: "Yes, MBBS graduates can enroll to gain specialized knowledge in obesity prevention and weight management strategies.",
      },
      {
        q: "What will I learn in the Certificate in Obesity Management?",
        a: "The course covers obesity assessment, nutrition planning, lifestyle modification, exercise strategies, medical management, and long-term weight control approaches.",
      },
      {
        q: "What are the career opportunities after completing this certificate?",
        a: "Graduates can enhance their clinical practice, offer structured weight management programs, and work in hospitals, wellness clinics, or independent practice.",
      },
      {
        q: "What is the fee for the Certificate in Obesity Management?",
        a: "The fee may vary depending on enrolment options. For the latest details, candidates are advised to contact DMHCA directly.",
      },
      {
        q: "What is the salary expectation after this certification?",
        a: "Income potential depends on experience, location, and practice setup. Professionals offering obesity management services can significantly increase their consultation and treatment revenue.",
      },
    ],
    meta: { duration: "6 months", lessons: "26", skill_level: "Certificate", certificate: "yes" },
  },
  {
    ...
    heroDescription:
      "Complete reproductive medicine training including IVF, embryo transfer, and infertility management.",
    lessons: 73,
    months: 12,
    level: "expert",
    priceINR: 115000,
    ...
    faqs: [
      {
        q: "Who is the PG Diploma in Clinical Embryology designed for?",
        a: "This course is designed for MBBS/MS/MD/DNB or equivalent holders, the program provides structured online education to deepen theoretical expertise in embryology.",
      },
      {
        q: "What core topics are included in the PG Diploma in Clinical Embryology at DMHCA?",
        a: "This diploma explores fertilization biology, gamete handling, embryo development, IVF laboratory techniques, cryopreservation, and evidence-based reproductive science.",
      },
      {
        q: "How can completing this diploma enhance my clinical practice?",
        a: "This diploma helps strengthen your understanding of assisted reproductive technologies, boost confidence in lab protocols, and improve decision-making in fertility care settings.",
      },
      {
        q: "What is the fee for the PG Diploma in Clinical Embryology at DMHCA?",
        a: "Fees vary based on course structure and included resources; detailed pricing information is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this clinical embryology diploma from DMHCA boost career opportunities and earning potential?",
        a: "Yes, This program is providing advanced online training in clinical embryology can enhance your professional credibility, open doors to IVF lab roles, and support better income prospects in reproductive medicine.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Fellowship in Reproductive Medicine: Mastering Advanced Fertility and Reproductive Health Solutions",
    lessons: 77,
    months: 12,
    level: "expert",
    priceINR: 135000,
    ...
    requirements: ["MBBS/MD/MS/Equivalent", "No previous experience is required"],
    ...
    faqs: [
      {
        q: "Who is the Fellowship in Reproductive Medicine designed for?",
        a: "The program welcomes MBBS/MD/MS or equivalent professionals seeking to enhance their knowledge of reproductive medicine through flexible online learning, without prior experience.",
      },
      {
        q: "What key areas are covered in the Fellowship in Reproductive Medicine at DMHCA?",
        a: "This fellowship from DMHCA explores fertility assessment, hormonal regulation, assisted reproductive technologies (ART), infertility protocols, and evidence-based reproductive care principles.",
      },
      {
        q: "How is the Reproductive Medicine fellowship structured and delivered?",
        a: "The course is delivered via online lectures, expert-led sessions, case-based discussions, and comprehensive digital study materials, enabling flexible access from anywhere.",
      },
      {
        q: "In what ways can this fellowship improve my clinical reproductive practice?",
        a: "Completing this fellowship helps enhance diagnostic confidence, refine fertility management strategies, and strengthen your ability to counsel and manage complex reproductive cases.",
      },
      {
        q: "What is the fee for the Fellowship in Reproductive Medicine at DMHCA?",
        a: "Fees vary depending on course structure and included learning resources; detailed pricing information is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can completing this online fellowship from DMHCA support my career growth and income potential?",
        a: "Yes, completing the DMHCA Fellowship in Reproductive Medicine can boost your career, enhance clinical credibility, and increase earning potential.",
      },
    ],
...

  {
    ...
    heroDescription:
      "Gain Specialized Skills in Reproductive Health with a Certificate in Infertility Diagnosis and Treatment",
    lessons: 28,
    months: 6,
    level: "intermediate",
    priceINR: 26000,
    ...
    moduleDetails: [
      [
        ...
        "Basics of fertility and conception",
      ],
      [
        ...
        "Male infertility evaluation",
        "Hormonal and imaging investigations",
      ],
      [
        "Ovulatory disorders",
        "Polycystic ovarian syndrome (PCOS)",
      ...
      [
        ...
        "Intracytoplasmic sperm injection (ICSI)",
        "Cryopreservation techniques",
        "Overview of embryology lab procedure",
      ],
      [
        "Counseling of infertile couples",
        "Psychological aspects of infertility",
        "Ethical and legal considerations",
        "Case discussions and clinical exposure",
        "Logbook submission and final assessment",
      ],
    ],
    faqs: [
      {
        q: "Who is eligible for the Certificate in Infertility?",
        a: "The course welcomes MBBS/equivalent professionals aiming to develop expertise in infertility management through structured online learning, without prior experience.",
      },
      {
        q: "What key areas are covered in the Certificate in Infertility course?",
        a: "This certificate from DMHCA explores infertility causes, evaluation protocols, reproductive endocrinology basics, treatment options, and evidence-based patient counseling strategies.",
      },
      {
        q: "How do learners access the Certificate in Infertility materials at DMHCA?",
        a: "Learners access the Certificate in Infertility materials through DMHCA’s online Learning Management System (LMS), where, after enrollment, they receive login details to attend live sessions and view recorded lectures and study content anytime online.",
      },
      {
        q: "In what ways can this certificate improve my clinical work?",
        a: "This certificate helps enhance your ability to assess and manage infertility, improve counseling skills, and boost professional confidence in reproductive health care.",
      },
      {
        q: "What is the fee for the Certificate in Infertility at DMHCA?",
        a: "Fees vary based on course structure and included learning resources; full pricing details are shared upon inquiry or enrollment request.",
      },
      {
        q: "Can completing this infertility certificate from DMHCA help my career and income potential?",
        a: "Yes, This Course in infertility can boost your professional credibility, expand clinical roles, and support higher earning opportunities in reproductive medicine and fertility care.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Specialize in Reproductive Science: Fellowship in Clinical Embryology for Advanced Fertility Treatment Expertise.",
    lessons: 55,
    months: 12,
    level: "expert",
    priceINR: 110000,
    ...
    program: "Fellowship",
    overview:
      "Clinical Embryology is a specialized field within reproductive medicine focused on assisted reproductive technologies (ART), including gamete handling, fertilization techniques, embryo culture, cryopreservation, and IVF laboratory quality control. This fellowship provides in-depth theoretical knowledge and structured training to enable candidates to understand and manage IVF laboratory processes effectively.",
    trainers: [
      {
        name: "Dr. Prabhdeep Kaur",
        title: "Obs & Gynea Specialist",
    ...
    faqs: [
      {
        q: "Who can enroll in the Clinical Embryology fellowship?",
        a: "MBBS or equivalent qualified candidates can enroll; no prior experience is required.",
      },
      {
        q: "What topics are covered in this fellowship?",
        a: "It includes IVF lab techniques, gamete handling, embryo culture, cryopreservation, genetics, and ART procedures.",
      },
      {
        q: "How is the course delivered?",
        a: "It is delivered via online lectures, expert sessions, case discussions, and digital study materials.",
      },
      {
        q: "What skills will I gain?",
        a: "You will gain expertise in IVF lab procedures, embryo handling, and assisted reproductive technologies.",
      },
      {
        q: "What is the fee for this program?",
        a: "Fees vary based on structure and resources; exact details are shared during inquiry.",
      },
      {
        q: "Can this fellowship improve career growth?",
        a: "Yes, it enhances clinical and laboratory expertise, improving career opportunities in fertility and ART labs.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Advanced Fellowship in Endocrinology: Master Diagnostic and Therapeutic Skills for Complex Hormonal and Metabolic Disorders",
    lessons: 16,
    months: 12,
    level: "expert",
    priceINR: 130000,
    ...
    moduleDetails: [
      ...
      ["Grasping Disorders Related to Lipoprotein Metabolism", "Investigating Diabetes Mellitus"],
      [
  ...
  },
  {
    ...
    heroDescription:
      "Fellowship in Diabetology: Mastering Comprehensive Diabetes Care for Enhanced Patient Outcomes and Clinical Expertise",
    lessons: 36,
    months: 12,
    level: "expert",
    priceINR: 110000,
    ...
    faqs: [
      {
        q: "Who should enroll in the Fellowship in Diabetology?",
        a: "MBBS and above qualified physicians and healthcare professionals seeking advanced diabetes management expertise.",
      },
      {
        q: "What topics are covered in the Fellowship in Diabetology?",
        a: "Diabetes pathophysiology, glucose management, complications prevention, therapeutic strategies, and lifestyle interventions.",
      },
      {
        q: "How is the Fellowship in Diabetology delivered?",
        a: "Through online lectures, expert-led discussions, evidence-based modules, and case studies.",
      },
      {
        q: "What career benefits can I expect from this diabetology fellowship?",
        a: "It enhances clinical decision-making, diabetes care expertise, and professional credentials.",
      },
      {
        q: "What is the fee for the Fellowship in Diabetology?",
        a: "Fees vary by course structure and resources; details are shared upon inquiry or enrollment.",
      },
      {
        q: "Can this fellowship improve professional credibility and earning potential?",
        a: "Yes, it can strengthen professional credibility, expand clinical opportunities, and support higher earning potential.",
      },
    ],
  ...
  },
  {
    ...
    faqs: [
      {
        q: "Who should enroll in the Certificate in Diabetic Foot Care?",
        a: "The course is ideal for physicians, podiatrists, diabetologists, nurses, and healthcare professionals seeking focused knowledge in diabetic foot care through online study.",
      },
      {
        q: "What topics are included in the Certificate in Diabetic Foot Care?",
        a: "This certificate covers diabetic foot assessment, ulcer prevention, wound care basics, risk classification, and practical management strategies through structured digital modules.",
      },
      {
        q: "How is the Certificate in Diabetic Foot Care delivered?",
        a: "The program is conducted via online lectures, expert-led sessions, case-based discussions, and downloadable study materials, allowing flexible learning from anywhere.",
      },
      {
        q: "What career benefits can I gain from this certificate?",
        a: "Completing this certificate helps strengthen diabetic foot assessment skills, clinical confidence, and professional credibility in managing foot complications.",
      },
      {
        q: "What is the fee for the Certificate in Diabetic Foot Care?",
        a: "Fees vary based on course structure and provided learning resources; complete pricing details are available upon inquiry or enrollment request.",
      },
      {
        q: "Can this certificate enhance professional growth and income potential?",
        a: "Yes, This focused expertise in diabetic foot care can boost your professional profile, expand clinical roles, and support better income opportunities in diabetes and wound care settings.",
      },
    ],
    meta: { duration: "3 months", lessons: "21", skill_level: "Certificate", certificate: "yes" },
  },
  {
    ...
    heroDescription:
      "Become a Specialist in Musculoskeletal Health: Fellowship in Orthopedics for Expertise in Surgery and Trauma Care.",
    lessons: 31,
    months: 12,
    level: "expert",
    priceINR: 155000,
    ...
    requirements: ["MBBS/ MD/ MS/ DGO/ DNB/ Equivalent", "No previous experience is needed."],
    ...
    faqs: [
      {
        q: "Who is the Fellowship in Orthopedics designed for?",
        a: "This course is open to MBBS, MD, MS, DGO, DNB, or equivalent-qualified professionals and offers advanced online training in orthopedic medicine with no prior experience required.",
      },
      {
        q: "What major areas of orthopedic care are covered in the fellowship at DMHCA?",
        a: "This fellowship from DMHCA explores musculoskeletal diagnosis, fracture management, joint disorders, evidence-based treatment planning, and clinical decision-making in orthopedics.",
      },
      {
        q: "How do learners access the Orthopedics fellowship content at DMHCA?",
        a: "The course is delivered through online lectures, expert-led modules, clinical case discussions, and comprehensive digital study resources that can be accessed flexibly from anywhere.",
      },
      {
        q: "How will this fellowship help improve my orthopedic practice?",
        a: "Completing this fellowship helps enhance diagnostic confidence, strengthen management skills for musculoskeletal conditions, and elevate your overall clinical competence in orthopedics.",
      },
      {
        q: "What is the fee for the Fellowship in Orthopedics at DMHCA?",
        a: "Fees vary based on course structure and included digital learning materials; detailed pricing information is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this Orthopedic fellowship from DMHCA boost my career opportunities and earning potential?",
        a: "Yes, this course in orthopedics can boost your professional credibility, broaden your clinical roles, and support higher earning prospects in musculoskeletal and surgical care.",
      },
    ],
  ...
  },
  {
    ...
    faqs: [
      {
        q: "Who can apply for the DMHCA Spine Surgery fellowship?",
        a: "The course welcomes MBBS/MD/MS or equivalent professionals aiming to build advanced spine surgery knowledge through structured online learning.",
      },
      {
        q: "What does the Fellowship in Spine Surgery cover?",
        a: "This fellowship focuses on spine anatomy, trauma care, degenerative disorders, spinal deformity principles, and advanced surgical decision-making.",
      },
      {
        q: "How is the Spine Surgery fellowship delivered?",
        a: "The course is delivered through online lectures, expert-led webinars, clinical case discussions, and digital study materials.",
      },
      {
        q: "What career advantages can I gain after completing this fellowship?",
        a: "It helps deepen clinical expertise, strengthen surgical reasoning, and enhance your professional profile in spine and orthopedic care.",
      },
      {
        q: "What is the fee for the Fellowship in Spine Surgery?",
        a: "Fees vary based on course structure and learning resources; detailed pricing is available upon inquiry or enrollment request.",
      },
      {
        q: "Can completing this fellowship increase my income and clinical stature?",
        a: "Yes, it can boost professional credibility, expand clinical opportunities, and support higher earning potential in surgical practice.",
      },
    ],
  ...
  },
  {
    ...
    categories: ["dermatology"],
    image: "/courses/fellowship_dermatology.webp",
    heroDescription:
      "Transform Skin Health: Fellowship in Dermatology for Expertise in Medical, Surgical, and Cosmetic Skin Care.",
    lessons: 78,
    months: 12,
    level: "expert",
    priceINR: 135000,
    ...
    requirements: ["MBBS and Above Qualification", "No previous experience is needed."],
    ...
    faqs: [
      {
        q: "Who can enroll in the online Fellowship in Dermatology?",
        a: "Designed for MBBS or higher qualification holders, this course provides advanced dermatology training through flexible online learning with no prior experience required.",
      },
      {
        q: "What topics are covered in this Fellowship in Dermatology?",
        a: "The program includes skin disease diagnosis, medical and cosmetic dermatology, dermatosurgery, laser applications, and case-based clinical learning.",
      },
      {
        q: "How is the online dermatology fellowship delivered?",
        a: "Training is delivered via live or recorded online lectures, digital study materials, interactive case discussions, and expert-led guidance accessible from anywhere.",
      },
      {
        q: "What career benefits can I expect after this fellowship?",
        a: "It enhances clinical confidence, expands dermatology practice scope, and improves career opportunities in skin clinics and aesthetic medicine settings.",
      },
      {
        q: "What is the fee for the Fellowship in Dermatology?",
        a: "Fees vary based on program structure and learning resources; exact details are shared during inquiry or enrollment.",
      },
      {
        q: "Can this fellowship increase earning potential in dermatology?",
        a: "Yes, advanced dermatology training can enhance professional credibility and help expand patient base and income opportunities.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Expertise in Hair Health: Fellowship in Trichology for Advanced Diagnosis and Treatment of Hair and Scalp Disorders.",
    lessons: 47,
    months: 12,
    level: "expert",
    priceINR: 110000,
    ...
    faqs: [
      {
        q: "Who can enroll in the Fellowship in Trichology?",
        a: "The course is suitable for candidates with an MBBS or higher qualification seeking to upskill in hair and scalp care through flexible online learning.",
      },
      {
        q: "What will I learn in the Fellowship in Trichology?",
        a: "This fellowship covers hair loss evaluation, scalp disorders, trichoscopy basics, treatment planning, and case-based learning.",
      },
      {
        q: "How is the Trichology fellowship delivered?",
        a: "The program is conducted through online sessions, digital study materials, and expert-led lectures, allowing learners to study from anywhere.",
      },
      {
        q: "What career benefits does a Trichology fellowship offer?",
        a: "It can help professionals expand service offerings, improve patient consultation skills, and strengthen career prospects in dermatology and cosmetic practice.",
      },
      {
        q: "What is the fee for the Fellowship in Trichology?",
        a: "Fees depend on the course structure and academic support provided; exact fee details are shared during the admission or inquiry process.",
      },
      {
        q: "Can a Trichology fellowship improve earning potential?",
        a: "Yes, specialized training in trichology can enhance professional credibility, helping practitioners attract more patients and increase income opportunities.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Transform Aesthetics: Fellowship in Cosmetology & Aesthetic Medicine for Expertise in Advanced Non-Surgical Cosmetic Treatments.",
    lessons: 75,
    months: 12,
    level: "expert",
    priceINR: 130000,
    ...
    faqs: [
      {
        q: "Who can enroll in this cosmetology and aesthetic medicine fellowship?",
        a: "This program is designed for MBBS or higher-qualified professionals seeking advanced training in aesthetic medicine with flexible online learning and no prior experience required.",
      },
      {
        q: "What does this fellowship cover?",
        a: "It covers injectables, lasers, chemical peels, skin rejuvenation, anti-aging treatments, dermatosurgery basics, and case-based aesthetic learning.",
      },
      {
        q: "How is the program structured?",
        a: "It is delivered through live and recorded online sessions, expert-led modules, interactive case discussions, and downloadable study resources.",
      },
      {
        q: "What career benefits does it offer?",
        a: "It helps expand clinical services, attract aesthetic patients, and improve career opportunities in cosmetic clinics and private practice.",
      },
      {
        q: "What is the fee for this fellowship?",
        a: "Fees vary based on course structure and training components; exact details are shared during inquiry or enrollment.",
      },
      {
        q: "Can it improve earning potential?",
        a: "Yes, advanced aesthetic training can increase professional credibility, patient trust, and income opportunities in cosmetic medicine.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription: "Comprehensive cosmetology training including advanced aesthetic procedures.",
    lessons: 15,
    months: 6,
    level: "intermediate",
    priceINR: 41300,
    ...
    program: "Certificate",
    overview:
      "Introduction to cosmetic procedures and aesthetic treatments for beauty professionals.",
    learn: [
      "Facial anatomy",
      "Facials",
      "Chemical peels",
  ...
  },
  {
    ...
    categories: ["general-surgery"],
    image: "/courses/fellowship_in_robotic_surgery.webp",
    heroDescription:
      "Master Precision in Surgery: Fellowship in Robotic Surgery for Expertise in Advanced Minimally Invasive Techniques.",
    lessons: 29,
    months: 12,
    level: "expert",
    priceINR: 190000,
    ...
    moduleDetails: [
      ["Overview", "Historical Evolution", "Robotic Surgical Systems", "Essential Skills"],
      [
    ...
    faqs: [
      {
        q: "Who is eligible for a Fellowship in Robotic Surgery?",
        a: "This online program is suitable for MD/DNB (Medicine), DM Cardiology, or DNB Cardiology-qualified professionals seeking theoretical knowledge in robotic surgery, with no prior experience needed.",
      },
      {
        q: "What key skills does the Fellowship in Robotic Surgery at DMHCA focus on?",
        a: "This online fellowship from DMHCA emphasizes robot-assisted surgical principles, system navigation, minimally invasive techniques, and surgical decision-making through structured expert modules.",
      },
      {
        q: "How is the Fellowship in Robotic Surgery delivered by DMHCA?",
        a: "The course is provided through online lectures, expert-led discussions, case-based sessions, and digital study resources, allowing learning flexibility from anywhere.",
      },
      {
        q: "What professional benefits can I expect after completing this fellowship at DMHCA?",
        a: "Completing this fellowship helps enhance surgical knowledge, strengthen clinical reasoning in robotic procedures, and elevate your professional profile in modern surgical care.",
      },
      {
        q: "What is the fee for the Robotic Surgery Fellowship at DMHCA?",
        a: "Course fees vary depending on structure and academic resources provided; complete pricing details are shared during the inquiry or enrollment process.",
      },
      {
        q: "Can this fellowship at DMHCA boost my clinical credibility and income potential?",
        a: "Yes, this course in robotic surgery can improve professional credibility, open up advanced clinical opportunities and support better earning potential in surgical specialties.",
      },
    ],
  ...
  },
  {
    ...
    image: "/courses/fellowship_pediatric_surgery_course.webp",
    heroDescription:
      "Enhance Diagnostic Skills in Pediatric Surgery with DMHCA’s Fellowship Program in Pediatric Surgery—Hands-On Training Included",
    lessons: 36,
    months: 12,
    level: "expert",
    priceINR: 180000,
  ...
  },
  {
    ...
    heroDescription:
      "Enhance your skills with a Fellowship in Pediatric Neurology. Diagnose and treat childhood disorders.",
    lessons: 44,
    months: 12,
    level: "expert",
    priceINR: 140000,
    ...
    program: "Fellowship",
    overview:
      "The Fellowship in Pediatric Neurology is a specialized program designed for healthcare professionals to gain expertise in diagnosing and managing neurological disorders in children. This comprehensive course covers neurodevelopmental disorders, epilepsy, neuromuscular diseases, neurogenetics, and pediatric stroke. Participants receive training in clinical evaluation, neuroimaging, and electrophysiology to develop advanced skills in pediatric neurology.",
    ...
    moduleDetails: [
      [
        ...
        "Pediatric neurological history & examination",
        "Developmental milestones and assessment tools",
        "Approach to hypotonia (floppy infant)",
        "Approach to developmental delay & regression",
        "Neuroimaging basics (MRI/CT in children)",
        "Pediatric neurological localization",
        "Basics of neurogenetics & counseling",
      ],
      [
        ...
        "Anti-seizure medications (indications & dosing)",
        "EEG basics and interpretation",
        "Video EEG monitoring (overview)",
        "Drug-resistant epilepsy (overview)",
      ],
      [
        ...
        "Early intervention & rehabilitation strategies",
        "Cerebral palsy (types, evaluation & management)",
        "Behavioral assessment tools in pediatrics",
      ],
      [
        ...
        "Inborn errors of metabolism (neurological presentation)",
        "Leukodystrophies & mitochondrial disorders",
      ],
      [
        "Meningitis, encephalitis & CNS tuberculosis",
        "Autoimmune encephalitis & ADEM",
        "Pediatric movement disorders (dystonia, chorea, ataxia, tics)",
        "Acute flaccid paralysis",
        "Guillain–Barré syndrome",
        "Raised intracranial pressure management",
        "Pediatric stroke & neurovascular disorders",
        "Neurological emergencies in PICU",
      ],
      [
        "Hypoxic ischemic encephalopathy (HIE)",
        "Neonatal tone abnormalities",
    ...
    faqs: [
      {
        q: "Who can enroll in this Fellowship in Pediatric Neurology?",
        a: "This online program is suitable for MD, DCH, or DNB Pediatrics qualified professionals seeking to enhance their expertise in pediatric neurology.",
      },
      {
        q: "What specialized topics are covered in the Pediatric Neurology fellowship at DMHCA?",
        a: "This fellowship covers neurological assessment in children, seizure management, developmental disorders, pediatric neurodiagnostics, and evidence-based clinical approaches.",
      },
      {
        q: "How do learners access the Pediatric Neurology fellowship program at DMHCA?",
        a: "The course is delivered via online lectures, expert-led discussions, pediatric case reviews, and comprehensive digital study materials, allowing flexible learning from anywhere.",
      },
      {
        q: "What improvements can this fellowship bring to my pediatric practice?",
        a: "Completing this fellowship helps strengthen pediatric neurological assessment skills, boost diagnostic confidence, and enhance professional credibility in child neurology care.",
      },
      {
        q: "How much does the Fellowship in Pediatric Neurology at DMHCA cost?",
        a: "Fees depend on course structure and included learning resources; complete pricing information is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this fellowship increase my career opportunities and earning potential?",
        a: "Yes, this advanced training in pediatric neurology can boost your professional profile, expand clinical roles, and support better income opportunities in child health and neurological care.",
      },
    ],
  ...
  },
  {
    ...
    requirements: ["MBBS MD/ MS/ DNB/ DCH (Paediatrics)", "No previous experience is needed."],
    ...
    moduleDetails: [
      ...
      ["Laboratory medicine", "Normal values", "X-rays, ultrasound, MRI, CT Scan etc"],
    ],

    faqs: [
      {
        q: "Who should enroll in the Fellowship in Neonatology?",
        a: "This program is designed for MBBS/MD/MS/DNB/DCH (Paediatrics) holders and offers advanced online education in neonatal and newborn care.",
      },
      {
        q: "What clinical topics are included in the Neonatology fellowship at DMHCA?",
        a: "This fellowship explores newborn physiology, neonatal resuscitation, prematurity care, neonatal infections, and evidence-based critical care strategies for neonates.",
      },
      {
        q: "How is the Neonatology fellowship delivered by DMHCA?",
        a: "The course is conducted through online lectures, expert-led discussions, neonatal case insights, and digital study materials accessible from anywhere.",
      },
      {
        q: "How can this fellowship improve my clinical practice in newborn care?",
        a: "It helps strengthen neonatal assessment skills, improve critical decision-making, and boost confidence in managing sick and preterm infants.",
      },
      {
        q: "What is the fee for the Neonatology fellowship at DMHCA?",
        a: "Fees vary depending on course structure and learning resources; detailed pricing information is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can completing this online fellowship from DMHCA enhance my career and earning potential?",
        a: "Yes, this program in neonatology can boost professional credibility, expand clinical opportunities, and support higher earning prospects in neonatal and pediatric care.",
      },
    ],
    meta: { duration: "12 months", lessons: "55", skill_level: "Fellowship", certificate: "yes" },
  },
  {
    ...
    heroDescription:
      "Become an Expert in Pediatric Heart Imaging: Fellowship in Pediatric Echocardiography for Advanced Diagnosis and Care.",
    lessons: 30,
    months: 12,
    level: "expert",
    priceINR: 110000,
    ...
    requirements: ["MD/ DNB/ Equivalent", "No previous experience is needed."],
    ...
    moduleDetails: [
      ...
      ["Quality Assurance in Echocardiography", "Patient Safety", "Error Management"],
      [
    ...
    faqs: [
      {
        q: "Who is eligible for the Fellowship in Pediatric Echocardiography?",
        a: "This program is designed for MD/DNB or equivalent qualified medical professionals who wish to develop advanced knowledge and skills in pediatric cardiac imaging and echocardiography.",
      },
      {
        q: "What topics are covered in the Fellowship in Pediatric Echocardiography at DMHCA?",
        a: "This fellowship covers congenital and acquired heart diseases, transthoracic and transesophageal echocardiography, fetal echocardiography, Doppler imaging, advanced cardiac imaging techniques, and clinical interpretation of pediatric echocardiographic findings.",
      },
      {
        q: "How is the Pediatric Echocardiography fellowship delivered by DMHCA?",
        a: "The course is delivered through online lectures, expert-led discussions, case-based learning modules, and comprehensive digital study materials that can be accessed from anywhere.",
      },
      {
        q: "How can this fellowship improve my clinical practice?",
        a: "Completing this fellowship helps strengthen your skills in pediatric cardiac assessment, improve diagnostic accuracy, enhance clinical decision-making, and build confidence in managing congenital and acquired heart diseases in children.",
      },
      {
        q: "What is the fee for the Fellowship in Pediatric Echocardiography at DMHCA?",
        a: "Fees vary based on the course structure and included learning resources; detailed pricing information is provided upon inquiry or enrollment request.",
      },
      {
        q: "Can completing this fellowship enhance my career opportunities and earning potential?",
        a: "Yes, this fellowship can strengthen your professional profile, expand opportunities in pediatric cardiology and cardiac imaging, and support increased earning potential in specialized healthcare settings.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Lead in Crisis: Fellowship in Emergency Medicine for Expertise in Acute, Trauma, and Life-Saving Care.",
    lessons: 79,
    months: 12,
    level: "expert",
    priceINR: 99000,
    ...
    faqs: [
      {
        q: "Who should enroll in the Emergency Medicine fellowship?",
        a: "This program is designed for candidates with an MBBS or higher qualification seeking advanced emergency care education through flexible online learning, with no prior experience required.",
      },
      {
        q: "What topics are included in the Fellowship in Emergency Medicine?",
        a: "This fellowship covers acute care protocols, trauma response, emergency diagnostics, life support strategies, critical care management, and evidence-based emergency medicine practices.",
      },
      {
        q: "How is the Emergency Medicine fellowship delivered?",
        a: "The course is delivered through online lectures, expert-led webinars, interactive discussions, case-based learning, and comprehensive digital study materials accessible from anywhere.",
      },
      {
        q: "How can this fellowship improve my clinical practice?",
        a: "Completing this fellowship helps strengthen emergency assessment skills, improve critical decision-making, and enhance confidence in managing medical and traumatic emergencies.",
      },
      {
        q: "What is the fee for the Fellowship in Emergency Medicine?",
        a: "Fees vary depending on the course structure and learning resources included; detailed pricing information is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this fellowship improve career opportunities and earning potential?",
        a: "Yes, advanced training in emergency medicine can enhance professional credibility, expand clinical opportunities, and support higher earning potential in emergency and critical care settings.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Postgraduate Diploma in Emergency Medicine: Advanced Skills for Expert Trauma Care, Critical Management, and Life-Saving Interventions",
    lessons: 29,
    months: 12,
    level: "expert",
    priceINR: 110000,
    ...
    modules: ["Modules-1", "Modules-2", "Modules- 3", "Modules-4"],
    ...
    faqs: [
      {
        q: "Who can enroll in the PG Diploma in Emergency Medicine?",
        a: "The program is ideal for physicians, emergency doctors, critical care practitioners, and healthcare professionals seeking advanced emergency medicine knowledge through online study.",
      },
      {
        q: "What topics are covered in the PG Diploma in Emergency Medicine?",
        a: "This PG diploma includes emergency care principles, acute response protocols, trauma management, resuscitation basics, and emergency decision-making through structured digital modules.",
      },
      {
        q: "How is the PG Diploma in Emergency Medicine delivered?",
        a: "The course is conducted via online lectures, expert-led sessions, interactive case discussions, and digital study materials, providing flexible learning access.",
      },
      {
        q: "What career benefits can this diploma provide?",
        a: "Completing this diploma can help strengthen emergency care knowledge, improve clinical decision-making, and enhance professional credentials in acute care settings.",
      },
      {
        q: "What is the fee for the PG Diploma in Emergency Medicine?",
        a: "Course fees vary based on program structure and learning resources provided; detailed pricing is available upon inquiry or enrollment request.",
      },
      {
        q: "Can this PG Diploma improve earning potential in emergency care?",
        a: "Yes, This advanced understanding in emergency medicine can boost professional credibility, expand clinical roles, and support higher income opportunities in emergency and hospital environments.",
      },
    ],
  ...
  },
  {
    ...
    faqs: [
      {
        q: "Who is eligible for a Fellowship in Critical Care?",
        a: "The program is open to MBBS and above qualified professionals including physicians, ICU practitioners, emergency doctors, and anesthesiologists, with no prior experience required.",
      },
      {
        q: "What knowledge is covered in this fellowship?",
        a: "It covers ICU management, ventilator strategies, shock and sepsis care, hemodynamic monitoring, organ support systems, and advanced critical care protocols.",
      },
      {
        q: "How is the fellowship delivered?",
        a: "The course is delivered through online lectures, expert webinars, case-based discussions, and structured digital modules accessible from anywhere.",
      },
      {
        q: "What career benefits does it provide?",
        a: "It enhances clinical decision-making, strengthens ICU management skills, and improves career opportunities in critical care and hospital settings.",
      },
      {
        q: "What is the fee for this fellowship?",
        a: "Fees vary based on program structure and resources; detailed information is shared upon inquiry or enrollment.",
      },
      {
        q: "Can this improve earning potential?",
        a: "Yes, advanced critical care training can improve professional credibility and open higher-paying clinical roles in ICU and emergency care.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Post Graduate Diploma in Critical Care: Advanced Training for Managing Life-Threatening Conditions in Intensive Care",
    lessons: 48,
    months: 12,
    level: "expert",
    priceINR: 120000,
    ...
    moduleDetails: [
      ...
      ["Acute coronary syndrome", "Cardiac arrhythmias", "Heart failure", "Shock management"],
      [
      ...
      ["Stroke management", "Head injury", "Seizures and status epilepticus", "Coma management"],
      [
      ...
      ["Acute kidney injury", "Electrolyte imbalance", "Acid–base disorders", "Dialysis basics"],
      [
        "Polytrauma management",
        "Burns management",
    ...
    faqs: [
      {
        q: "Who should pursue the PG Diploma in Critical Care?",
        a: "This program is suitable for physicians and healthcare professionals with an MBBS or equivalent qualification aiming to advance in critical care.",
      },
      {
        q: "What topics are covered in the PG Diploma in Critical Care?",
        a: "This diploma covers advanced critical care principles, shock and sepsis management, ventilator support, organ dysfunction monitoring, and acute care protocols through structured modules.",
      },
      {
        q: "How is the PG Diploma in Critical Care structured?",
        a: "The course is delivered via online lectures, expert-led sessions, interactive discussions, and evidence-based content that can be accessed flexibly from anywhere.",
      },
      {
        q: "What career benefits can I expect after completing this diploma?",
        a: "Candidates can enhance clinical decision-making, improve critical care understanding, and strengthen professional credentials, expanding opportunities in ICU and acute care environments.",
      },
      {
        q: "What is the fee for the PG Diploma in Critical Care?",
        a: "Fees vary depending on course structure and included learning resources; detailed pricing is provided upon inquiry or enrollment request.",
      },
      {
        q: "Can this PG Diploma improve my earning potential in critical care?",
        a: "Yes, This advanced training in critical care can boost professional credibility, career prospects, and potential income, especially in acute care and hospital settings.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "PG Diploma in HIV Medicine: Specialized Training in Diagnosis, Treatment, and Management of HIV/AIDS",
    lessons: 18,
    months: 12,
    level: "expert",
    priceINR: 120000,
    ...
    faqs: [
      {
        q: "What advanced topics are covered in the PG Diploma in HIV Medicine?",
        a: "This diploma from DMHCA includes in-depth study of HIV epidemiology, antiretroviral therapy, opportunistic infections, treatment guidelines, and patient counseling strategies.",
      },
      {
        q: "Who is the PG Diploma in HIV Medicine suitable for?",
        a: "The program is ideal for physicians, infectious disease specialists, public health practitioners, nurses, and healthcare professionals looking to boost expertise in HIV care through structured online learning.",
      },
      {
        q: "How will I receive the HIV Medicine diploma training at DMHCA?",
        a: "The course is delivered through online lectures, expert-led modules, case discussions, and downloadable study materials that can be accessed flexibly from anywhere.",
      },
      {
        q: "In what ways can this diploma enhance my professional practice?",
        a: "Completing this diploma helps strengthen HIV treatment knowledge, improve patient management skills, and enhance clinical confidence, making you more effective in care delivery.",
      },
      {
        q: "What is the fee for the PG Diploma in HIV Medicine at DMHCA?",
        a: "Fees vary based on course structure and provided learning resources; detailed pricing is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can completing this PG Diploma from DMHCA improve my career prospects and income potential?",
        a: "Yes — advanced online training in HIV medicine can boost your professional credibility, open up broader clinical roles, and support better earning opportunities in infectious disease and public health settings.",
      },
    ],
  ...
  },
  {
    ...
    image: "/courses/pg_diploma_hospital_administration.webp",
    heroDescription:
      "Get a PG Diploma in Hospital Administration and master healthcare management and operations.",
    lessons: 48,
    months: 12,
    level: "expert",
    priceINR: 110000,
    ...
    faqs: [
      {
        q: "Who is eligible for enrolling in the PG Diploma in Hospital Administration?",
        a: "The program is suitable for medical, healthcare, allied health, pharmacy, biotechnology, engineering, and hospital administration graduates seeking leadership roles in healthcare management.",
      },
      {
        q: "What key subjects are included in the PG Diploma in Hospital Administration?",
        a: "The curriculum covers healthcare management, hospital operations, quality systems, finance, human resources, healthcare laws, logistics, and health information management.",
      },
      {
        q: "What professional advantages can this diploma offer?",
        a: "This diploma enhances managerial, leadership, and administrative skills required for successful careers in hospitals and healthcare organizations.",
      },
      {
        q: "What is the fee for the PG Diploma in Hospital Administration at DMHCA?",
        a: "Fees vary depending on the course structure and included learning resources; detailed pricing is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this hospital administration diploma from DMHCA enhance my career and earning potential?",
        a: "Yes, it can strengthen professional credibility, expand healthcare leadership opportunities, and support long-term career growth in hospital administration.",
      },
    ],
    meta: { duration: "12 months", lessons: "48", skill_level: "PG Diploma", certificate: "yes" },
  },
  {
    ...
    heroDescription:
      "Advance Your Career with a PG Diploma in Hospital Management: Lead Healthcare Excellence",
    lessons: 126,
    months: 12,
    level: "expert",
    priceINR: 120000,
    ...
    faqs: [
      {
        q: "Who is eligible for enrolling in the PG Diploma in Hospital Management?",
        a: "The program is suitable for medical, healthcare, allied health, pharmacy, biotechnology, engineering, and hospital administration graduates seeking management careers in healthcare.",
      },
      {
        q: "What key subjects are included in the PG Diploma in Hospital Management?",
        a: "The curriculum covers hospital administration, healthcare management, finance, human resources, healthcare laws, quality management, and hospital operations.",
      },
      {
        q: "What professional advantages can this diploma offer?",
        a: "This diploma develops leadership, operational, and administrative skills required for successful careers in hospitals and healthcare organizations.",
      },
      {
        q: "What is the fee for the PG Diploma in Hospital Management at DMHCA?",
        a: "Fees vary depending on the course structure and included learning resources; detailed pricing is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this hospital management diploma from DMHCA enhance my career and earning potential?",
        a: "Yes, it can strengthen professional credibility, expand healthcare leadership opportunities, and support long-term career growth in hospital management.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Advance Your Expertise in Family Medicine with Comprehensive, Patient-Centered Care through Our Fellowship Program",
    lessons: 73,
    months: 12,
    level: "expert",
    priceINR: 100000,
    ...
    moduleDetails: [
      [
        "Concept and scope of Family Medicine",
        "Continuity of care & comprehensive care model",
      ...
      [
        "Management of fever and acute infections",
        "Respiratory emergencies",
        "Acute coronary syndrome recognition",
        "Shock management",
        "Anaphylaxis",
        "Trauma basics and first aid",
        "BLS & ACLS overview",
      ],
      [
        "Hypertension",
      ...
      [
        "Clinic setup and infrastructure",
    ...
    faqs: [
      {
        q: "Who is eligible for a Fellowship in Family Medicine?",
        a: "MBBS and above qualified physicians and healthcare professionals seeking advanced primary care expertise.",
      },
      {
        q: "What topics are included in the Fellowship in Family Medicine at DMHCA?",
        a: "Primary care, chronic disease management, preventive medicine, community health, and evidence-based patient care.",
      },
      {
        q: "How will the Family Medicine fellowship be delivered to learners?",
        a: "Through online lectures, expert-led discussions, case studies, and digital learning resources.",
      },
      {
        q: "How can this fellowship enhance my clinical practice?",
        a: "It strengthens primary care skills, clinical decision-making, and confidence in managing diverse health conditions.",
      },
      {
        q: "What is the fee for the DMHCA Fellowship in Family Medicine?",
        a: "Fees vary by course structure and resources; details are shared upon inquiry or enrollment.",
      },
      {
        q: "Can this fellowship from DMHCA boost my career and income potential?",
        a: "Yes, it can enhance professional credibility, expand clinical roles, and support higher earning opportunities.",
      },
    ],
  ...
  },
  {
    ...
    moduleDetails: [
      ...
      ["Post-operative pain and post-trauma pain", "Pharmacological, Interventional"],
      [
        "Headache",
    ...
    faqs: [
      {
        q: "Who is the Fellowship in Pain Management designed for?",
        a: "This online program is suitable for MBBS, MD, MS, DGO, DNB, or equivalent-qualified professionals seeking deeper expertise in pain management.",
      },
      {
        q: "What key subjects are included in the Pain Management fellowship at DMHCA?",
        a: "This fellowship from DMHCA covers multimodal pain assessment, pharmacologic and non-pharmacologic strategies, interventional pain techniques, chronic pain syndromes, and evidence-based clinical care concepts.",
      },
      {
        q: "How is the Pain Management fellowship delivered by DMHCA?",
        a: "The course is delivered through online lectures, expert-led discussions, clinical case reviews, and comprehensive digital study materials that learners can access flexibly from anywhere.",
      },
      {
        q: "What improvements can this fellowship bring to my clinical practice?",
        a: "Completing this fellowship helps enhance your pain assessment skills, improve treatment planning confidence, and deepen understanding of complex pain conditions in diverse clinical settings.",
      },
      {
        q: "What is the fee for the Pain Management fellowship at DMHCA?",
        a: "Fees vary depending on course structure and included digital learning materials; detailed pricing information is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can completing this fellowship from DMHCA enhance my career opportunities and earning potential?",
        a: "Yes, this program in pain management can boost your professional credibility, expand clinical roles, and support higher earning prospects in pain care and related specialties.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Lead the Fight Against Cancer: Fellowship in Medical Oncology for Advanced Cancer Treatment and Care.",
    lessons: 72,
    months: 12,
    level: "expert",
    priceINR: 130000,
    ...
    faqs: [
      {
        q: "Who is the Fellowship in Medical Oncology designed for?",
        a: "The course welcomes MBBS/MD/MS/DGO/DNB or equivalent professionals aiming to build advanced expertise in medical oncology through flexible online learning, without prior experience.",
      },
      {
        q: "What core oncology topics are included in the Medical Oncology fellowship at DMHCA?",
        a: "This fellowship covers cancer biology, chemotherapeutic regimens, targeted therapies, immunotherapy principles, and evidence-based patient management strategies.",
      },
      {
        q: "How is the Medical Oncology fellowship delivered by DMHCA?",
        a: "The course is provided through online lectures, expert-led sessions, case-based discussions, and comprehensive digital resources accessible from anywhere.",
      },
      {
        q: "How can completing this fellowship improve my oncology practice?",
        a: "Completing this fellowship helps deepen cancer care knowledge, enhance therapeutic decision-making, and strengthen clinical confidence in oncology.",
      },
      {
        q: "What is the fee for the Medical Oncology fellowship at DMHCA?",
        a: "Fees vary based on course design and included digital study materials; full pricing information is provided upon inquiry or enrollment request.",
      },
      {
        q: "Can advanced training in medical oncology from DMHCA boost my career and earning potential?",
        a: "Yes, this program in medical oncology can boost professional credibility, expand clinical opportunities, and support higher earning prospects in oncology and related specialties.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Fellowship in Head and Neck Oncology: Advanced Surgical and Oncological Training for Comprehensive Patient Care",
    lessons: 24,
    months: 12,
    level: "expert",
    priceINR: 120000,
    ...
    moduleDetails: [
      ...
      ["Anatomical and Pathological Considerations in Neck Surgery", "Principles of Neck Surgery"],
      [
      ...
      ["Anatomy and Pathology of Surgery", "Total Laryngectomy", "Pharynx-Skin Fistula"],
      [
  ...
  },
  {
    ...
    heroDescription:
      "Become an Expert in Cancer Care: Fellowship in Gynecologic Oncology for Specialized Surgical and Oncologic Training.",
    lessons: 64,
    months: 12,
    level: "expert",
    priceINR: 170000,
    ...
    faqs: [
      {
        q: "Who can enroll in this fellowship?",
        a: "MBBS, MD, MS, or equivalent qualified professionals can apply with no prior experience required.",
      },
      {
        q: "What subjects are covered in this program?",
        a: "It includes gynecologic cancers, chemotherapy, radiation therapy, surgical oncology, targeted therapy, and immunotherapy.",
      },
      {
        q: "How is the course delivered?",
        a: "It is delivered through online lectures, expert sessions, case-based learning, and digital study materials.",
      },
      {
        q: "What skills will I gain?",
        a: "You will gain expertise in cancer diagnosis, treatment planning, surgical oncology, and multidisciplinary cancer care.",
      },
      {
        q: "What is the fee for this fellowship?",
        a: "Fees vary based on structure and resources; exact details are provided during inquiry.",
      },
      {
        q: "Can this fellowship improve career growth?",
        a: "Yes, it enhances clinical expertise, professional credibility, and career opportunities in oncology.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Specialize in GI Diagnostics and Treatment: Fellowship in GI Endoscopy for Advanced Endoscopic Skills.",
    lessons: 12,
    months: 12,
    level: "expert",
    priceINR: 135000,
    ...
    moduleDetails: [
      ...
      ["Endoscopic types and systems", "Optical systems", "Equipment handling and maintenance"],
      [
    ...
    faqs: [
      {
        q: "Who can enroll in the GI Endoscopy fellowship?",
        a: "MBBS, MD, MS, or equivalent qualified professionals can apply; no prior experience is required.",
      },
      {
        q: "What topics are covered in this fellowship?",
        a: "It covers diagnostic and therapeutic endoscopy including EGD, colonoscopy, ERCP, EUS, and GI disease management.",
      },
      {
        q: "How is the course delivered?",
        a: "It is delivered through online lectures, expert sessions, case discussions, and digital learning resources.",
      },
      {
        q: "What skills will I gain?",
        a: "You will gain expertise in diagnostic GI endoscopy, therapeutic procedures, and advanced endoscopic techniques.",
      },
      {
        q: "What is the fee for this program?",
        a: "Fees vary based on structure and resources; exact details are shared during inquiry or enrollment.",
      },
      {
        q: "Can this fellowship improve career growth?",
        a: "Yes, it enhances clinical skills, professional credibility, and career opportunities in gastroenterology.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Comprehensive Fellowship in Urology: Advanced Training in Diagnosis, Treatment, and Management of Urological Conditions",
    lessons: 35,
    months: 50,
    level: "expert",
    priceINR: 140000,
    ...
    requirements: ["MD/MS/DNB / Equivalent"],
    ...
    moduleDetails: [
      ...
      ["The renal parenchyma cancer", "Wilms' tumor"],
    ],

    faqs: [
      {
        q: "Who should consider enrolling in the DMHCA Fellowship in Urology?",
        a: "MD/MS/DNB or equivalent professionals seeking advanced knowledge in urological care through online learning.",
      },
      {
        q: "What advanced urology topics are included in the fellowship curriculum at DMHCA?",
        a: "Urinary tract disorders, prostate and kidney diseases, surgical urology principles, and evidence-based management.",
      },
      {
        q: "How will I access the Urology fellowship training delivered by DMHCA?",
        a: "Through online lectures, expert-led discussions, clinical case reviews, and digital study materials.",
      },
      {
        q: "What improvements can this fellowship bring to my clinical practice?",
        a: "Enhances clinical reasoning, diagnostic skills, and confidence in managing urological conditions.",
      },
      {
        q: "What is the fee for the Fellowship in Urology at DMHCA?",
        a: "Fees vary by course structure and resources; details are shared upon inquiry or enrollment.",
      },
      {
        q: "Can completing this online urology fellowship from DMHCA enhance my career and earnings?",
        a: "Yes, it can improve professional credibility, expand clinical opportunities, and support higher earning potential.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Advance Your Expertise in Blood Disorders: Fellowship in Clinical Hematology for Specialized Care and Research.",
    lessons: 56,
    months: 12,
    level: "expert",
    priceINR: 150000,
    ...
    faqs: [
      {
        q: "Who can enroll in this fellowship?",
        a: "MBBS or equivalent qualified professionals can apply; no prior experience is required.",
      },
      {
        q: "What topics are covered in this program?",
        a: "It includes anemia, leukemia, lymphoma, coagulation disorders, transfusion medicine, and bone marrow evaluation.",
      },
      {
        q: "How is the course delivered?",
        a: "It is delivered through online lectures, case discussions, expert sessions, and digital study materials.",
      },
      {
        q: "What skills will I gain?",
        a: "You will gain expertise in diagnosing and managing blood disorders and hematologic emergencies.",
      },
      {
        q: "What is the fee for this fellowship?",
        a: "Fees vary based on structure and resources; exact details are shared during inquiry.",
      ...
      {
        q: "Can this fellowship improve career growth?",
        a: "Yes, it enhances clinical expertise, professional credibility, and career opportunities in hematology.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Master advanced techniques with a Fellowship in Oral Implantology and Laser Dentistry.",
    lessons: 67,
    months: 12,
    level: "expert",
    priceINR: 130000,
    ...
    requirements: ["BDS/MDS in DCI recognized institutions"],
    ...
    moduleDetails: [
      [
        "Applied oral and maxillofacial anatomy",
        "Bone physiology and healing",
        "Osseointegration principles",
        "Implant biomaterials and surface science",
        "Sterilization and infection control in implant surgery",
      ],
      [
      ...
      [
        ...
        "Laser safety protocols and regulations",
        "Laser-tissue absorption principles",
        "Clinical indications and contraindications",
      ],
      [
        "Surgical armamentarium and setup",
        "Aseptic surgical protocols",
        "Flap design and incision techniques",
        "Osteotomy preparation sequence",
        "Implant placement in posterior region",
        "Suturing techniques and post-operative care",
      ],
      [
        "Healing abutments and soft tissue management",
        "Impression techniques",
        "Temporary prosthesis fabrication",
        "Abutment selection and customization",
        "Screw-retained vs cement-retained prosthesis",
        "Occlusal considerations in implant prosthesis",
      ],
      [
        "Laser gingivectomy and gingivoplasty",
        "Frenectomy and fibrotomy",
        "Depigmentation procedures",
        "Laser crown lengthening",
        "Soft tissue contouring around implants",
        "Post-laser healing protocols",
      ],
      [
      ...
      [
        ...
        "Bone graft materials (autograft, allograft, xenograft, alloplast)",
        "PRF and growth factors in implantology",
        "Ridge preservation and ridge split techniques",
        "Sinus lift (direct and indirect) – theory & observation",
      ],
      [
        "Laser-assisted periodontal therapy",
        "Pocket disinfection and bacterial reduction",
        "Peri-implant mucositis and peri-implantitis laser management",
        "Laser use in endodontic disinfection",
        "Laser bleaching and aesthetic applications",
      ],
      [
        "CBCT-based implant planning",
        "Guided implant surgery workflow",
        "CAD/CAM prosthetic concepts",
        "Intraoral scanning basics",
        "3D printing of surgical guides",
        "Digital smile design integration",
      ],
      [
        "Implant in aesthetic zone management",
        "Soft tissue aesthetics (pink aesthetics)",
        "Implant with orthodontic considerations",
        "Implant-supported overdentures",
        "Geriatric and medically compromised patients",
      ],
      [
        "Implant failure analysis and management",
        "Peri-implant diseases",
        "Nerve injury and surgical complications",
        "Case documentation and portfolio preparation",
        "Practice management and implant clinic setup",
        "Ethics and medico-legal considerations in implantology and laser dentistry",
      ],
    ],

    faqs: [
      {
        q: "Who should enroll in this dental fellowship program?",
        a: "This program is designed for BDS and MDS holders from DCI-recognized institutions.",
      },
      {
        q: "What advanced skills are covered in this oral implantology and laser dentistry fellowship?",
        a: "This fellowship teaches dental implant placement, laser applications in soft and hard tissue, surgical protocols, and esthetic rehabilitation, enhancing clinical expertise in modern dentistry.",
      },
      {
        q: "How long does the fellowship in oral implantology and laser dentistry last?",
        a: "The fellowship is structured to provide comprehensive clinical exposure over a 50-week period.",
      },
      {
        q: "What career opportunities are available after completing this fellowship?",
        a: "Candidates can work as implant specialists, laser dentists, clinical consultants, or practice owners, offering advanced dental care in private clinics and specialty centers.",
      },
      {
        q: "What is the fee for the fellowship in Oral Implantology and Laser Dentistry?",
        a: "Course fees vary based on clinical exposure and training components; detailed pricing is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this fellowship improve my dental practice and earning potential?",
        a: "Yes — specialized expertise in implantology and laser dentistry enhances your professional profile, attracts more patients, and can significantly boost earning potential.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Enhance your expertise with a Fellowship in Maxillofacial and Oral Surgery. Master advanced techniques.",
    lessons: 46,
    months: 12,
    level: "expert",
    priceINR: 110000,
    ...
    moduleDetails: [
      ...
      [
        ...
        "Comprehensive Implant Site Preparation",
      ...
      [
        ...
        "Soft Tissue Injuries",
        "Management of Alveolar and Dental Fractures",
        ...
        "Management of Frontal Sinus and Nasal Fractures",
      ],
      [
        "Principles of Management of Maxillofacial Infections",
      ...
      [
        ...
        "Adjunctive Facial Aesthetic Procedures",
      ],
    ],

    faqs: [
      {
        q: "Who is eligible for the Fellowship in Maxillofacial and Oral Surgery?",
        a: "This fellowship is designed for MDS graduates from DCI-recognized institutions seeking advanced training in oral and maxillofacial surgery.",
      },
      {
        q: "What advanced surgical expertise does this fellowship provide?",
        a: "The program covers facial trauma, orthognathic surgery, implantology, maxillofacial pathology, reconstruction, and facial aesthetic surgery.",
      },
      {
        q: "How long is the Fellowship in Maxillofacial and Oral Surgery?",
        a: "The fellowship is structured over 50 weeks and includes comprehensive theoretical and clinical training.",
      },
      {
        q: "What career opportunities are available after completing this fellowship?",
        a: "Graduates can work as oral and maxillofacial surgeons, implant specialists, surgical consultants, or specialists in hospitals and advanced dental centers.",
      },
      {
        q: "What is the fee for the Fellowship in Maxillofacial and Oral Surgery?",
        a: "Fees vary based on course structure and training components; detailed pricing is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this fellowship improve my career and earning potential?",
        a: "Yes, advanced training in maxillofacial and oral surgery can enhance professional credibility, expand clinical opportunities, and support higher earning potential.",
      },
    ],
    meta: { duration: "12 months", lessons: "46", skill_level: "Fellowship", certificate: "yes" },
  },
  {
    ...
    categories: ["pediatrics"],
    image: "/courses/fellowship_pediatrics_course.webp",
    lessons: 80,
    months: 12,
    level: "expert",
    priceINR: 120000,
    ...
    requirements: ["MBBS"],
    heroDescription:
      "Develop advanced expertise in child health, neonatal care, pediatric diseases, growth monitoring, and evidence-based management across all stages of childhood.",
    overview:
    ...
    faqs: [
      {
        q: "Who should enroll in the Fellowship in Paediatrics?",
        a: "This course welcomes MBBS/MD/MS/DCH/DNB or equivalent healthcare professionals seeking advanced knowledge and clinical skills in child health, neonatal care, and pediatric medicine through structured learning.",
      },
      {
        q: "What advanced topics are included in the Fellowship in Paediatrics?",
        a: "This fellowship covers growth and development, neonatology, pediatric infectious diseases, respiratory disorders, gastroenterology, cardiology, neurology, nephrology, hematology, endocrinology, emergency care, and adolescent medicine.",
      },
      {
        q: "How is the Paediatrics fellowship delivered?",
        a: "The course is provided through online lectures, expert-led discussions, case-based modules, clinical learning activities, and comprehensive digital study materials.",
      },
      {
        q: "How will this fellowship help improve my clinical practice?",
        a: "It helps strengthen pediatric assessment and diagnostic skills, improve management of neonatal and childhood disorders, enhance emergency care capabilities, and increase confidence in delivering evidence-based pediatric care.",
      },
      {
        q: "What is the fee for the Paediatrics fellowship?",
        a: "Fees vary based on course structure and included learning resources; detailed pricing is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this fellowship enhance my career prospects and earnings?",
        a: "Yes, it can boost your professional profile, expand opportunities in pediatric clinics, hospitals, neonatal units, and child healthcare services, while supporting higher earning potential in pediatric practice.",
      },
    ],
  ...
  },
  {
    ...
    categories: ["pediatrics"],
    image: "/courses/fellowship_pediatric_nephrology_course.webp",
    lessons: 40,
    months: 12,
    level: "expert",
    priceINR: 150000,
  ...
  },
  {
    ...
    categories: ["pediatrics"],
    image: "/courses/fellowship_pediatric_endocrinology_course.webp",
    lessons: 53,
    months: 12,
    level: "expert",
    priceINR: 140000,
    ...
    faqs: [
      {
        q: "Who should enroll in the Fellowship in Pediatric Endocrinology?",
        a: "This course welcomes MBBS/MD/MS/DCH/DNB or equivalent healthcare professionals seeking advanced knowledge in pediatric endocrinology, growth disorders, diabetes, and hormonal diseases through structured learning.",
      },
      {
        q: "What advanced topics are included in the Fellowship in Pediatric Endocrinology?",
        a: "This fellowship covers growth disorders, pituitary and hypothalamic diseases, thyroid disorders, pubertal abnormalities, adrenal disorders, pediatric diabetes, metabolic endocrinology, calcium and bone disorders, and endocrine emergencies using evidence-based clinical approaches.",
      },
      {
        q: "How is the Pediatric Endocrinology fellowship delivered?",
        a: "The course is provided through online lectures, expert-led discussions, case-based modules, clinical learning activities, and comprehensive digital study materials.",
      },
      {
        q: "How will this fellowship help improve my clinical practice?",
        a: "It helps strengthen diagnostic skills in pediatric endocrine disorders, improve interpretation of hormonal investigations, enhance long-term disease management capabilities, and increase confidence in managing complex endocrine conditions in children.",
      },
      {
        q: "What is the fee for the Pediatric Endocrinology fellowship?",
        a: "Fees vary based on course structure and included learning resources; detailed pricing is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this fellowship enhance my career prospects and earnings?",
        a: "Yes, it can boost your professional profile, expand opportunities in pediatric endocrinology, children's hospitals, specialty clinics, and academic practice, while supporting higher earning potential in advanced pediatric healthcare.",
      },
    ],
  ...
  },
  {
    ...
    categories: ["radiology"],
    image: "/courses/fellowship_radiology_course.webp",
    lessons: 75,
    months: 12,
    level: "expert",
    priceINR: 150000,
    ...
    heroDescription:
      "Develop advanced expertise in diagnostic imaging, radiological interpretation, ultrasound, CT, MRI, and interventional radiology across multiple clinical specialties.",
    ...
    faqs: [
      {
        q: "Who should enroll in the Fellowship in Radiology?",
        a: "This course welcomes MBBS/MD/MS/DNB or equivalent healthcare professionals seeking advanced knowledge in diagnostic imaging, radiological interpretation, and image-guided procedures through structured learning.",
      },
      {
        q: "What advanced topics are included in the Fellowship in Radiology?",
        a: "This fellowship covers radiological physics, musculoskeletal imaging, neuroradiology, chest imaging, abdominal radiology, obstetric and gynecological imaging, ultrasound, Doppler studies, interventional radiology, breast imaging, pediatric radiology, and emergency radiology.",
      },
      {
        q: "How is the Radiology fellowship delivered?",
        a: "The course is provided through online lectures, expert-led discussions, case-based modules, imaging reviews, and comprehensive digital study materials.",
      },
      {
        q: "How will this fellowship help improve my clinical practice?",
        a: "It helps strengthen diagnostic accuracy, improve image interpretation skills, enhance clinical decision-making, and increase confidence in utilizing imaging modalities for patient diagnosis and management.",
      },
      {
        q: "What is the fee for the Radiology fellowship?",
        a: "Fees vary based on course structure and included learning resources; detailed pricing is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this fellowship enhance my career prospects and earnings?",
        a: "Yes, it can boost your professional profile, expand opportunities in diagnostic imaging centers, hospitals, specialty clinics, and radiology departments, while supporting higher earning potential in imaging-based healthcare practice.",
      },
    ],
    meta: { duration: "12 months", lessons: "75", skill_level: "Fellowship", certificate: "yes" },
  },
  {
    ...
    categories: ["radiology"],
    image: "/courses/fellowship_neuroradiology_course.webp",
    lessons: 44,
    months: 12,
    level: "expert",
    priceINR: 199000,
  ...
  },
  {
    ...
    categories: ["radiology"],
    image: "/courses/fellowship_interventional_radiology_course.webp",
    lessons: 40,
    months: 12,
    level: "expert",
    priceINR: 180000,
  ...
  },
  {
    ...
    categories: ["radiology"],
    image: "/courses/fellowship_musculoskeletal_ultrasound_course.webp",
    lessons: 32,
    months: 6,
    level: "expert",
    priceINR: 140000,
  ...
  },
  {
    ...
    categories: ["radiology"],
    image: "/courses/fellowship_vascular_ultrasound_course.webp",
    lessons: 30,
    months: 6,
    level: "expert",
    priceINR: 130000,
  ...
  },
  {
    ...
    categories: ["orthopedics"],
    image: "/courses/fellowship_arthroscopy_arthroplasty_course.webp",
    lessons: 48,
    months: 12,
    level: "expert",
    priceINR: 170000,
  ...
  },
  {
    ...
    categories: ["orthopedics"],
    image: "/courses/fellowship_arthroscopy_sports_medicine_course.webp",
    lessons: 48,
    months: 12,
    level: "expert",
    priceINR: 170000,
  ...
  },
  {
    ...
    categories: ["medicine"],
    image: "/courses/fellowship_internal_medicine_course.webp",
    lessons: 84,
    months: 12,
    level: "expert",
    priceINR: 130000,
    ...
    faqs: [
      {
        q: "Who should enroll in the Internal Medicine Fellowship program?",
        a: "This online program is suitable for MBBS and above qualified professionals seeking to strengthen their expertise in internal medicine, with no previous experience needed.",
      },
      {
        q: "What clinical areas are included in the Fellowship in Internal Medicine at DMHCA?",
        a: "This fellowship from DMHCA covers diagnosis and management of chronic diseases, acute clinical reasoning, preventive medicine, patient assessment strategies, and evidence-based therapeutic care.",
      },
      {
        q: "How will I access the Internal Medicine fellowship training content?",
        a: "The course is provided through online lectures, expert-led discussions, case studies, and comprehensive digital resources, allowing learners to study flexibly from anywhere.",
      },
      {
        q: "In what ways can this fellowship improve my clinical practice?",
        a: "Completing this fellowship helps enhance diagnostic accuracy, refine management strategies, and strengthen your clinical confidence in treating a wide range of internal medicine conditions.",
      },
      {
        q: "What is the fee for the Fellowship in Internal Medicine at DMHCA?",
        a: "Fees vary based on course structure and included digital learning materials; detailed pricing information is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can advanced online training from DMHCA help boost my career opportunities and income?",
        a: "Yes, completing this fellowship can boost your professional credibility, open doors to advanced clinical roles, and support better earning potential in internal medicine and related healthcare fields.",
      },
    ],
...

  {
    ...
    categories: ["neurology"],
    image: "/courses/fellowship_sleep_medicine_course.webp",
    lessons: 40,
    months: 12,
    level: "expert",
    priceINR: 120000,
  ...
  },
  {
    ...
    categories: ["medicine"],
    image: "/courses/fellowship_addiction_psychology_course.webp",
    heroDescription:
      "Comprehensive training in addiction assessment, treatment, and rehabilitation programs.",
    lessons: 36,
    months: 12,
    level: "expert",
    priceINR: 100000,
    ...
    program: "Fellowship",
    overview:
      "Advanced training in substance abuse disorders, behavioral addictions, and evidence-based treatment strategies for addiction psychology.",
    learn: [
  ...
  },
  {
    ...
    categories: ["urology"],
    image: "/courses/fellowship_andrology_course.webp",
    heroDescription:
      "Specialized training in male infertility, erectile dysfunction, and sexual medicine.",
    lessons: 32,
    months: 6,
    level: "expert",
    priceINR: 99000,
    ...
    program: "Fellowship",
    overview:
      "Advanced training in male reproductive disorders, infertility diagnosis and treatment, and sexual dysfunction management.",
    learn: [
    ...
    meta: { duration: "6 months", lessons: "32", skill_level: "Fellowship", certificate: "yes" },
  },
  {
    slug: "fellowship-in-neurosurgery",
    title: "Fellowship in Neurosurgery",
    categories: ["neurology"],
    image: "/courses/fellowship_neurosurgery_course.webp",
    heroDescription:
      "Advanced training in neurosurgical procedures, brain and spinal cord surgery.",
    lessons: 78,
    months: 12,
    level: "expert",
    priceINR: 199000,
    ...
    program: "Fellowship",
    overview:
      "Comprehensive neurosurgical training including cranial surgery, spinal surgery, and minimally invasive procedures.",
    learn: [
      "Cranial surgery",
      "Spinal surgery",
      "Tumor management",
  ...
  },
  {
    ...
    heroDescription:
      "Specialized training in diabetic foot ulcers, wound management, and amputation prevention.",
    lessons: 24,
    months: 6,
    level: "expert",
    priceINR: 90000,
    ...
    program: "Fellowship",
    overview:
      "Advanced training in prevention, diagnosis, and management of diabetic foot complications including ulcers and infections.",
    learn: [
      "Foot examination",
    ...
    meta: { duration: "6 months", lessons: "24", skill_level: "Fellowship", certificate: "yes" },
  },
  {
    ...
    heroDescription:
      "Master Minimally Invasive Gynecology: Fellowship in Minimal Access Surgery for Advanced Laparoscopic and Hysteroscopic Techniques.",
    lessons: 47,
    months: 12,
    level: "expert",
    priceINR: 170000,
    ...
    modules: ["Syallabus", "Theory", "Endoscopic Surgical Procedures"],
    ...
    faqs: [
      {
        q: "Who is eligible for a Fellowship in Minimal Access Surgery?",
        a: "This online program is suitable for MBBS or equivalent-qualified professionals seeking to build theoretical expertise in minimally invasive surgery, with no previous experience needed.",
      },
      {
        q: "What will I learn in the Minimal Access Surgery fellowship at DMHCA?",
        a: "This fellowship from DMHCA covers laparoscopy principles, minimally invasive techniques, key instrumentation, patient evaluation, and surgical planning through structured digital modules.",
      },
      {
        q: "How is the Fellowship in Minimal Access Surgery delivered by DMHCA?",
        a: "The course is delivered through online lectures, expert-led discussions, case-based learning, and comprehensive digital study resources that can be accessed flexibly from anywhere.",
      },
      {
        q: "What is the fee for the Fellowship in Minimal Access Surgery at DMHCA?",
        a: "Fees vary depending on course structure and included learning resources; detailed pricing information is shared upon inquiry or enrollment request.",
      },
      {
        q: "How does this fellowship help my surgical career?",
        a: "Completing this fellowship helps strengthen surgical decision-making, deepen understanding of minimally invasive procedures, and enhance your professional profile in advanced surgical practice.",
      },
      {
        q: "Can this fellowship at DMHCA increase my clinical credibility and income potential?",
        a: "Yes, this program in minimal access surgery can boost your professional credibility, open up advanced clinical roles, and support higher earning opportunities in surgical specialties.",
      },
    ],
  ...
  },
  {
    ...
    categories: ["endocrinology"],
    image: "/courses/pg_diploma_diabetology.webp",
    heroDescription:
      "Elevate your career with a PG Diploma in Diabetology—specialize in diabetes care and make an impact!",
    lessons: 44,
    months: 12,
    level: "expert",
    priceINR: 115000,
    ...
    moduleDetails: [
      ...
      ["Insulin resistance", "Beta-cell dysfunction", "Genetic and environmental factors"],
      [
        "Blood glucose tests",
        "HbA1c testing",
      ...
      ["Diabetic ketoacidosis (DKA)", "Hyperosmolar hyperglycemic state", "Hypoglycemia"],
      [
        "Diabetic neuropathy",
    ...
    faqs: [
      {
        q: "Who should pursue the PG Diploma in Diabetology?",
        a: "The program is ideal for physicians, endocrinologists, general practitioners, diabetologists, and healthcare professionals seeking deeper expertise in diabetes management through online learning.",
      },
      {
        q: "What topics are included in the PG Diploma in Diabetology?",
        a: "This diploma covers advanced diabetes pathophysiology, glucose control strategies, complication prevention, therapeutic approaches, and evidence-based diabetes care through structured modules.",
      },
      {
        q: "How is the PG Diploma in Diabetology delivered?",
        a: "The course is delivered via online lectures, expert-led discussions, case studies, and comprehensive digital resources, enabling flexible and accessible learning from anywhere.",
      },
      {
        q: "What career benefits can I expect after completing this diploma?",
        a: "Completing this diploma helps enhance clinical decision-making, strengthen diabetes care expertise, and improve professional credentials in endocrinology and diabetes practice.",
      },
      {
        q: "What is the fee for the PG Diploma in Diabetology?",
        a: "Fees vary based on course structure and included learning resources; detailed pricing is available upon inquiry or enrollment request.",
      },
      {
        q: "Can this PG Diploma improve professional credibility and earning potential?",
        a: "Yes, This advanced expertise in diabetology can elevate your professional profile, open up advanced clinical roles, and support higher income opportunities in diabetes and metabolic care.",
      },
    ],
  ...
  },
  {
    ...
    categories: ["medicine"],
    image: "/courses/pg_diploma_family_medicine.webp",
    lessons: 47,
    months: 12,
    level: "expert",
    priceINR: 110000,
    ...
    faqs: [
      {
        q: "Who should pursue the PG Diploma in Family Medicine?",
        a: "The program is ideal for physicians, general practitioners, family physicians, primary care doctors, and healthcare professionals seeking advanced expertise in comprehensive family and community-based healthcare.",
      },
      {
        q: "What topics are included in the PG Diploma in Family Medicine?",
        a: "This diploma covers primary care medicine, preventive healthcare, maternal and child health, chronic disease management, geriatric care, mental health, emergency medicine, nutrition, diagnostics, practice management, and community health through structured modules.",
      },
      {
        q: "How is the PG Diploma in Family Medicine delivered?",
        a: "The course is delivered through structured academic modules, clinical training, case-based learning, practical exposure, and comprehensive study resources to support professional development in family medicine.",
      },
      {
        q: "What career benefits can I expect after completing this diploma?",
        a: "Completing this diploma enhances clinical decision-making, strengthens primary care expertise, improves patient-centered healthcare delivery, and supports career advancement in family and community medicine.",
      },
      {
        q: "What is the fee for the PG Diploma in Family Medicine?",
        a: "Fees vary based on course structure and included learning resources; detailed pricing is available upon inquiry or enrollment request.",
      },
      {
        q: "Can this PG Diploma improve professional credibility and earning potential?",
        a: "Yes, this advanced expertise in family medicine can elevate your professional profile, expand clinical practice opportunities, and support higher income potential in primary care, community health, and family practice settings.",
      },
    ],
  ...
  },
  {
    ...
    heroDescription:
      "Boost your medical career with a PG Diploma in Infertility Management, master fertility diagnosis, IVF basics, and advanced patient care.",
    categories: ["obs-gynae"],
    image: "/courses/pg_diploma_infertility_management.webp",
    lessons: 46,
    months: 12,
    level: "expert",
    priceINR: 115000,
    ...
    moduleDetails: [
      ...
      ["PCOS and ovulatory disorders", "Endometriosis", "Tubal factors", "Uterine abnormalities"],
      [
    ...
    faqs: [
      {
        q: "Who is eligible for enrolling in the PG Diploma in Infertility Management?",
        a: "The program is suitable for MBBS, BDS, BAMS, BHMS, BNYS, BUMS, and equivalent healthcare professionals seeking specialized knowledge in infertility management.",
      },
      {
        q: "What key subjects are included in the PG Diploma in Infertility Management?",
        a: "The curriculum covers reproductive medicine, infertility diagnosis, hormonal assessment, assisted reproductive techniques, embryology, and patient counselling.",
      },
      {
        q: "What professional advantages can this diploma offer?",
        a: "This diploma enhances expertise in fertility care, reproductive medicine, and assisted reproductive technologies, supporting career advancement in fertility clinics and IVF centers.",
      },
      {
        q: "What is the fee for the PG Diploma in Infertility Management at DMHCA?",
        a: "Fees vary depending on the course structure and included learning resources; detailed pricing is shared upon inquiry or enrollment request.",
      },
      {
        q: "Can this infertility management diploma from DMHCA enhance my career and earning potential?",
        a: "Yes, it can strengthen professional credibility, expand opportunities in reproductive healthcare, and support long-term career growth in fertility medicine.",
      },
    ],
  ...
  },
  {
    ...
    categories: ["dermatology"],
    image: "/courses/pg_diploma_dermatology.webp",
    lessons: 38,
    months: 12,
    level: "expert",
    priceINR: 130000,
    ...
    requirements: ["MBBS", "BDS", "BAMS", "BHMS", "BNYS", "BUMS", "equivalent"],
    heroDescription:
      "Gain practical expertise in diagnosing and managing skin, hair, nail, and sexually transmitted disorders through comprehensive dermatology training.",
    ...
    moduleDetails: [
      ...
      ["Dermatophytosis (tinea)", "Candidiasis", "Scabies, pediculosis", "Deep fungal infections"],
      [
      ...
      ["Psoriasis", "Lichen planus", "Pityriasis rosea", "Scaling disorders"],
      [
        "Vitiligo",
    ...
    faqs: [
      {
        q: "Who should pursue the PG Diploma in Dermatology?",
        a: "The program is ideal for physicians, dermatologists, general practitioners, medical graduates, and healthcare professionals seeking advanced expertise in the diagnosis and management of skin, hair, nail, and sexually transmitted disorders.",
      },
      {
        q: "What topics are included in the PG Diploma in Dermatology?",
        a: "This diploma covers clinical dermatology, dermatological diagnostics, bacterial, viral, fungal and parasitic infections, inflammatory skin disorders, pigmentary diseases, STIs, leprosy, therapeutic dermatology, and cosmetic dermatology through structured modules.",
      },
      {
        q: "How is the PG Diploma in Dermatology delivered?",
        a: "The course is delivered through comprehensive academic modules, case-based learning, clinical discussions, practical training, and evidence-based study resources, enabling in-depth learning in dermatology.",
      },
      {
        q: "What career benefits can I expect after completing this diploma?",
        a: "Completing this diploma enhances dermatological diagnostic skills, strengthens clinical decision-making, improves patient management capabilities, and supports career growth in dermatology and aesthetic medicine.",
      },
      {
        q: "What is the fee for the PG Diploma in Dermatology?",
        a: "Fees vary based on course structure and included learning resources; detailed pricing is available upon inquiry or enrollment request.",
      },
      {
        q: "Can this PG Diploma improve professional credibility and earning potential?",
        a: "Yes, this advanced expertise in dermatology can elevate your professional profile, expand opportunities in clinical and cosmetic dermatology practice, and support higher income potential in specialized healthcare settings.",
      },
    ],
    meta: { duration: "12 months", lessons: "38", skill_level: "PG Diploma", certificate: "yes" },
  },
  {
    ...
    categories: ["obs-gynae"],
    image: "/courses/pg_diploma_obstetrics_gynaecology.webp",
    lessons: 42,
    months: 12,
    level: "expert",
    priceINR: 150000,
    ...
    program: "PG Diploma",
    overview:
      "Advanced training in obstetrics and gynecology covering pregnancy, delivery, and reproductive health.",
    learn: [
      "Antenatal care",
      "Labor management",
  ...
  },
  {
    ...
    categories: ["orthopedics"],
    image: "/courses/pg_diploma_orthopedics.webp",
    lessons: 28,
    months: 12,
    level: "expert",
    priceINR: 120000,
    ...
    requirements: ["MBBS"],
    heroDescription:
      "Develop advanced skills in diagnosing, treating, and rehabilitating musculoskeletal disorders, fractures, trauma, and orthopaedic conditions.",
    ...
    faqs: [
      {
        q: "Who should pursue the PG Diploma in Orthopaedics?",
        a: "The program is ideal for physicians, orthopaedic practitioners, general practitioners, medical graduates, and healthcare professionals seeking advanced expertise in musculoskeletal disorders, trauma care, fracture management, and rehabilitation.",
      },
      {
        q: "What topics are included in the PG Diploma in Orthopaedics?",
        a: "This diploma covers musculoskeletal anatomy and biomechanics, orthopaedic trauma, fracture management, upper and lower limb disorders, spine and paediatric orthopaedics, bone diseases, sports injuries, rehabilitation, prosthetics, and orthotics through structured modules.",
      },
      {
        q: "How is the PG Diploma in Orthopaedics delivered?",
        a: "The course is delivered through clinically focused modules, case-based learning, practical training, clinical discussions, and comprehensive study resources, enabling in-depth learning in orthopaedic medicine.",
      },
      {
        q: "What career benefits can I expect after completing this diploma?",
        a: "Completing this diploma enhances orthopaedic diagnostic and treatment skills, strengthens trauma management expertise, improves clinical decision-making, and supports career advancement in orthopaedic and musculoskeletal healthcare.",
      },
      {
        q: "What is the fee for the PG Diploma in Orthopaedics?",
        a: "Fees vary based on course structure and included learning resources; detailed pricing is available upon inquiry or enrollment request.",
      },
      {
        q: "Can this PG Diploma improve professional credibility and earning potential?",
        a: "Yes, this advanced expertise in orthopaedics can elevate your professional profile, expand opportunities in trauma centers, orthopaedic units, and rehabilitation services, and support higher income potential in specialized musculoskeletal care.",
      },
    ],
  ...
  },
  {
    ...
    categories: ["medicine"],
    image: "/courses/pg_diploma_rheumatology.webp",
    lessons: 38,
    months: 12,
    level: "expert",
    priceINR: 130000,
    ...
    requirements: ["MBBS", "MD Medicine preferred"],
    heroDescription:
      "Develop advanced expertise in diagnosing, treating, and managing autoimmune, inflammatory, and degenerative rheumatic disorders through evidence-based clinical practice.",
    overview:
    ...
    moduleDetails: [
      ...
      ["Osteoarthritis", "Osteoporosis", "Gout and crystal arthropathies", "Fibromyalgia"],
      [
    ...
    faqs: [
      {
        q: "Who should pursue the PG Diploma in Rheumatology?",
        a: "The program is ideal for physicians, rheumatologists, general practitioners, internal medicine specialists, and healthcare professionals seeking advanced expertise in autoimmune, inflammatory, and musculoskeletal disorders.",
      },
      {
        q: "What topics are included in the PG Diploma in Rheumatology?",
        a: "This diploma covers rheumatic disease classification, immunology, diagnostic investigations, rheumatoid arthritis, seronegative arthritides, connective tissue disorders, metabolic bone diseases, pharmacological therapies, rehabilitation, and long-term patient management through structured modules.",
      },
      {
        q: "How is the PG Diploma in Rheumatology delivered?",
        a: "The course is delivered through comprehensive academic modules, case-based discussions, clinical learning, practical exposure, and evidence-based study resources to strengthen expertise in rheumatological care.",
      },
      {
        q: "What career benefits can I expect after completing this diploma?",
        a: "Completing this diploma enhances diagnostic accuracy, strengthens clinical decision-making, improves management of complex rheumatic diseases, and supports career advancement in rheumatology and related specialties.",
      },
      {
        q: "What is the fee for the PG Diploma in Rheumatology?",
        a: "Fees vary based on course structure and included learning resources; detailed pricing is available upon inquiry or enrollment request.",
      },
      {
        q: "Can this PG Diploma improve professional credibility and earning potential?",
        a: "Yes, this advanced expertise in rheumatology can elevate your professional profile, expand opportunities in specialty clinics and hospitals, and support higher income potential in autoimmune and musculoskeletal healthcare practice.",
      },
    ],
    meta: { duration: "12 months", lessons: "38", skill_level: "PG Diploma", certificate: "yes" },
  },
  {
    ...
    categories: ["pulmonary"],
    image: "/courses/certificate_respiratory_care.webp",
    lessons: 19,
    months: 3,
    level: "intermediate",
    priceINR: 16000,
    ...
    faqs: [
      {
        q: "Who is eligible for the Certificate in Respiratory Care?",
        a: "MBBS, MD, MS, DNB holders, nursing professionals, allied healthcare practitioners, and other healthcare professionals with a clinical background are eligible for the Certificate in Respiratory Care.",
      },
      {
        q: "What is the duration of the Certificate in Respiratory Care?",
        a: "The Certificate in Respiratory Care is a short-term training program designed to provide focused education in respiratory assessment, oxygen therapy, and pulmonary disease management.",
      },
      {
        q: "What will I learn in this respiratory care certification course?",
        a: "You will learn respiratory anatomy and physiology, clinical evaluation of respiratory symptoms, interpretation of respiratory investigations, oxygen therapy, respiratory support techniques, management of common respiratory diseases, and emergency respiratory care.",
      },
      {
        q: "What are the career opportunities after completing this course?",
        a: "Graduates can work in hospitals, pulmonary clinics, critical care units, emergency departments, respiratory therapy services, and other healthcare settings involved in respiratory disease management.",
      },
      {
        q: "What is the fee for the Certificate in Respiratory Care?",
        a: "Fees vary by program structure and training scope; exact details are available on inquiry or enrollment request with the academy.",
      },
      {
        q: "What is the salary expectation after completing the respiratory care certificate?",
        a: "Salary depends on role, experience, and location; qualified professionals with expertise in respiratory care and pulmonary disease management typically earn competitive packages in healthcare settings.",
      },
    ],
  ...
  },
  {
    ...
    categories: ["orthopedics"],
    image: "/courses/certificate_orthopedic_trauma.webp",
    lessons: 23,
    months: 6,
    level: "intermediate",
    priceINR: 25000,
    ...
    faqs: [
      {
        q: "Who is eligible for the Certificate in Orthopedic and Trauma Medicine?",
        a: "MBBS, MD, MS, DNB holders and other healthcare professionals with a clinical background are eligible for the Certificate in Orthopedic and Trauma Medicine.",
      },
      {
        q: "What is the duration of the Certificate in Orthopedic and Trauma Medicine?",
        a: "The course provides comprehensive training in orthopedic assessment, trauma management, fracture care, and rehabilitation through a structured certificate program.",
      },
      {
        q: "What will I learn in this orthopedic and trauma medicine certification course?",
        a: "You will learn musculoskeletal anatomy and biomechanics, orthopedic examination techniques, fracture and dislocation management, orthopedic imaging interpretation, trauma care, immobilization techniques, surgical referral indications, and rehabilitation principles.",
      },
      {
        q: "What are the career opportunities after completing this course?",
        a: "Graduates can work in hospitals, orthopedic clinics, trauma centers, emergency departments, rehabilitation facilities, sports medicine settings, and musculoskeletal care services.",
      },
      {
        q: "What is the fee for the Certificate in Orthopedic and Trauma Medicine?",
        a: "Fees vary by program structure and training scope; exact details are available on inquiry or enrollment request with the academy.",
      },
      {
        q: "What is the salary expectation after completing the orthopedic and trauma medicine certificate?",
        a: "Salary depends on role, experience, and location; skilled professionals in orthopedic care, trauma management, and rehabilitation typically earn competitive packages in clinical and emergency healthcare settings.",
      },
    ],
  ...
  },
  {
    ...
    categories: ["pediatrics"],
    image: "/courses/certificate_neonatal_care.webp",
    lessons: 18,
    months: 3,
    level: "intermediate",
    priceINR: 11500,
    ...
    faqs: [
      {
        q: "Who is eligible for the Certificate in Neonatal Care?",
        a: "MBBS, MD, MS, DNB holders, nursing professionals, pediatric healthcare providers, and other healthcare professionals with a clinical background are eligible for the Certificate in Neonatal Care.",
      },
      {
        q: "What is the duration of the Certificate in Neonatal Care?",
        a: "The course provides structured training in neonatal assessment, newborn care, neonatal emergencies, and management of common neonatal disorders through a comprehensive certificate program.",
      },
      {
        q: "What will I learn in this neonatal care certification course?",
        a: "You will learn newborn physiology, neonatal assessment, routine newborn care, breastfeeding support, neonatal resuscitation, management of neonatal disorders, infection prevention, and neonatal emergency care.",
      },
      {
        q: "What are the career opportunities after completing this course?",
        a: "Graduates can work in neonatal units, maternity hospitals, pediatric departments, newborn care centers, community healthcare settings, and other facilities involved in neonatal and infant healthcare.",
      },
      {
        q: "What is the fee for the Certificate in Neonatal Care?",
        a: "Fees vary by program structure and training scope; exact details are available on inquiry or enrollment request with the academy.",
      },
      {
        q: "What is the salary expectation after completing the neonatal care certificate?",
        a: "Salary depends on role, experience, and location; professionals with expertise in neonatal care and newborn health management typically earn competitive packages in pediatric and neonatal healthcare settings.",
      },
    ],
  ...
  },
  {
    ...
    categories: ["obs-gynae"],
    image: "/courses/certificate_family_planning.webp",
    lessons: 18,
    months: 3,
    level: "intermediate",
    priceINR: 11500,
    ...
    requirements: ["Graduate: Nursing / Medical/ Healthcare/ Equivalent"],
    heroDescription:
      "Gain practical expertise in contraceptive counseling, family planning methods, and reproductive health services to support informed reproductive choices.",
    overview:
    ...
    faqs: [
      {
        q: "Who is eligible for the Certificate in Family Planning?",
        a: "MBBS, MD, MS, DGO, DNB holders, nursing professionals, allied healthcare practitioners, and other healthcare professionals with a clinical background are eligible for the Certificate in Family Planning.",
      },
      {
        q: "What is the duration of the Certificate in Family Planning?",
        a: "The course is a short-term certification program designed to provide comprehensive training in family planning services, contraceptive counseling, and reproductive healthcare.",
      },
      {
        q: "What will I learn in this family planning certification course?",
        a: "You will learn reproductive physiology, fertility and contraception, contraceptive counseling, temporary and long-acting contraceptive methods, management of side effects, family planning practices, and ethical aspects of reproductive healthcare.",
      },
      {
        q: "What are the career opportunities after completing this course?",
        a: "Graduates can work in hospitals, reproductive health clinics, maternal and child health programs, community healthcare services, family welfare centers, and public health initiatives focused on reproductive healthcare.",
      },
      {
        q: "What is the fee for the Certificate in Family Planning?",
        a: "Fees vary by program structure and training scope; exact details are available on inquiry or enrollment request with the academy.",
      },
      {
        q: "What is the salary expectation after completing the family planning certificate?",
        a: "Salary depends on role, experience, and location; professionals with expertise in reproductive health and family planning services typically earn competitive packages in clinical and public healthcare settings.",
      },
    ],
    meta: { duration: "3 month", lessons: "18", skill_level: "Certificate", certificate: "yes" },
  },
  {
    ...
    categories: ["endocrinology"],
    image: "/courses/certificate_diabetes_management.webp",
    lessons: 36,
    months: 6,
    level: "intermediate",
    priceINR: 30000,
    ...
    requirements: ["Graduate: Nursing / Medical/ Healthcare/ Equivalent"],
    heroDescription:
      "Develop practical expertise in diabetes diagnosis, treatment, monitoring, and complication prevention for comprehensive diabetes care.",
    overview:
    ...
    faqs: [
      {
        q: "Who is eligible for the Certificate in Diabetes Management?",
        a: "MBBS, MD, MS, DNB holders and other healthcare professionals with a clinical background are eligible for the Certificate in Diabetes Management.",
      },
      {
        q: "What is the duration of the Certificate in Diabetes Management?",
        a: "The course provides comprehensive training in diabetes diagnosis, treatment, monitoring, and complication management through a structured certificate program.",
      },
      {
        q: "What will I learn in this diabetes management certification course?",
        a: "You will learn diabetes pathophysiology, diagnosis, pharmacological management, glycemic monitoring, diabetes technologies, complication management, lifestyle counseling, and evidence-based diabetes care practices.",
      },
      {
        q: "What are the career opportunities after completing this course?",
        a: "Graduates can work in hospitals, diabetes clinics, primary care centers, endocrinology practices, community healthcare programs, and chronic disease management services.",
      },
      {
        q: "What is the fee for the Certificate in Diabetes Management?",
        a: "Fees vary by program structure and training scope; exact details are available on inquiry or enrollment request with the academy.",
      },
      {
        q: "What is the salary expectation after completing the diabetes management certificate?",
        a: "Salary depends on role, experience, and location; professionals with expertise in diabetes care and chronic disease management typically earn competitive packages in clinical and preventive healthcare settings.",
      },
    ],
  ...
  },
  {
    ...
    categories: ["pediatrics"],
    image: "courses/certificate_in_child_health_380x230(1).webp",
    lessons: 18,
    months: 3,
    level: "intermediate",
    priceINR: 17500,
    ...
    requirements: ["Graduate: Nursing / Medical/ Healthcare/ Equivalent"],
    heroDescription:
      "Build essential skills in pediatric assessment, childhood disease management, growth monitoring, immunization, and preventive child healthcare.",
    ...
    faqs: [
      {
        q: "Who is eligible for the Certificate in Child Health?",
        a: "MBBS, MD, MS, DNB holders, nursing professionals, allied healthcare practitioners, and other healthcare professionals with a clinical background are eligible for the Certificate in Child Health.",
      },
      {
        q: "What is the duration of the Certificate in Child Health?",
        a: "The course provides structured training in pediatric assessment, childhood disease management, preventive care, and growth monitoring through a comprehensive certificate program.",
      },
      {
        q: "What will I learn in this child health certification course?",
        a: "You will learn child growth and development, pediatric examination techniques, management of common childhood illnesses, nutritional assessment, immunization practices, preventive pediatric care, and pediatric emergency management.",
      },
      {
        q: "What are the career opportunities after completing this course?",
        a: "Graduates can work in pediatric clinics, hospitals, community health centers, maternal and child health programs, school health services, and preventive healthcare settings focused on child wellbeing.",
      },
      {
        q: "What is the fee for the Certificate in Child Health?",
        a: "Fees vary by program structure and training scope; exact details are available on inquiry or enrollment request with the academy.",
      },
      {
        q: "What is the salary expectation after completing the child health certificate?",
        a: "Salary depends on role, experience, and location; professionals with expertise in pediatric care and child health management typically earn competitive packages in healthcare settings.",
      },
    ],
    meta: { duration: "3 month", lessons: "18", skill_level: "Certificate", certificate: "yes" },
  },
  {
    ...
    categories: ["obs-gynae"],
    image: "courses/certificate_antenatal_care.webp",
    lessons: 21,
    months: 3,
    level: "intermediate",
    priceINR: 11500,
    ...
    requirements: ["Graduate: Nursing / Medical/ Healthcare/ Equivalent"],
    heroDescription:
      "Develop expertise in antenatal assessment, fetal monitoring, pregnancy screening, and management of common antenatal conditions for improved maternal and fetal outcomes.",
    overview:
      "Antenatal care is an essential component of maternal healthcare that focuses on monitoring the health of the mother and fetus throughout pregnancy. Regular antenatal care helps in early detection of complications, management of high-risk conditions, and preparation for safe delivery. Proper counseling on nutrition, lifestyle, and birth preparedness plays a key role in improving maternal and neonatal outcomes. This certificate course provides healthcare professionals with structured training in antenatal assessment, screening investigations, fetal monitoring, and management of common pregnancy-related conditions.",
    learn: [
    ...
    faqs: [
      {
        q: "Who is eligible for the Certificate in Antenatal Care?",
        a: "MBBS, MD, MS, DGO, DNB holders, nursing professionals, midwives, allied healthcare practitioners, and other healthcare professionals with a clinical background are eligible for the Certificate in Antenatal Care.",
      },
      {
        q: "What is the duration of the Certificate in Antenatal Care?",
        a: "The course provides structured training in antenatal assessment, fetal monitoring, pregnancy screening, and management of common antenatal conditions through a comprehensive certificate program.",
      },
      {
        q: "What will I learn in this antenatal care certification course?",
        a: "You will learn physiological changes during pregnancy, antenatal assessment techniques, interpretation of antenatal investigations, identification of high-risk pregnancies, fetal monitoring, and counseling on nutrition, immunization, and birth preparedness.",
      },
      {
        q: "What are the career opportunities after completing this course?",
        a: "Graduates can work in maternity hospitals, obstetric clinics, antenatal care centers, community health programs, maternal healthcare services, and other settings focused on pregnancy care and maternal wellbeing.",
      },
      {
        q: "What is the fee for the Certificate in Antenatal Care?",
        a: "Fees vary by program structure and training scope; exact details are available on inquiry or enrollment request with the academy.",
      },
      {
        q: "What is the salary expectation after completing the antenatal care certificate?",
        a: "Salary depends on role, experience, and location; professionals with expertise in maternal health and antenatal care typically earn competitive packages in healthcare settings.",
      },
    ],
  ...
  },
  {
    ...
    categories: ["medicine"],
    image: "courses/addiction_psychology.webp",
    lessons: 18,
    months: 3,
    level: "intermediate",
    priceINR: 11500,
    ...
    requirements: ["Graduate: Nursing / Medical/ Healthcare/ Equivalent"],
    heroDescription:
      "Build essential skills in addiction assessment, counseling, rehabilitation, and relapse prevention to support individuals affected by substance use and behavioral addictions.",

    overview:
      "Addiction psychology focuses on understanding the psychological, behavioral, and social factors associated with substance use and addictive behaviors. Substance use disorders and behavioral addictions are significant public health challenges that require comprehensive psychological assessment, counseling, and rehabilitation strategies. This certificate course provides foundational knowledge in the psychological aspects of addiction, early identification of substance use disorders, counseling techniques, and basic rehabilitation approaches for individuals affected by addiction.",
    ...
    faqs: [
      {
        q: "Who is eligible for the Certificate in Addiction Psychology?",
        a: "Psychologists, counselors, MBBS, MD, MS, DNB holders, social workers, nursing professionals, allied healthcare practitioners, and other healthcare professionals with an interest in mental health and addiction care are eligible for the Certificate in Addiction Psychology.",
      },
      {
        q: "What is the duration of the Certificate in Addiction Psychology?",
        a: "The course provides structured training in addiction assessment, counseling techniques, rehabilitation approaches, and relapse prevention through a comprehensive certificate program.",
      },
      {
        q: "What will I learn in this addiction psychology certification course?",
        a: "You will learn the psychological and neurobiological basis of addiction, addiction assessment methods, counseling techniques, motivational interviewing, CBT principles, rehabilitation strategies, and substance abuse prevention approaches.",
      },
      {
        q: "What are the career opportunities after completing this course?",
        a: "Graduates can work in rehabilitation centers, de-addiction clinics, mental health facilities, counseling services, community outreach programs, NGOs, and healthcare settings focused on addiction recovery and prevention.",
      },
      {
        q: "What is the fee for the Certificate in Addiction Psychology?",
        a: "Fees vary by program structure and training scope; exact details are available on inquiry or enrollment request with the academy.",
      },
      {
        q: "What is the salary expectation after completing the addiction psychology certificate?",
        a: "Salary depends on role, experience, and location; professionals with expertise in addiction counseling, rehabilitation, and mental health support typically earn competitive packages in healthcare and behavioral health settings.",
      },
    ],
    meta: { duration: "3 month", lessons: "18", skill_level: "Certificate", certificate: "yes" },
  },
  {
    ...
    categories: ["cardiology"],
    image: "courses/advanced_certificate_cath_lab_technology_course.webp",
    lessons: 24,
    months: 6,
    level: "intermediate",
    priceINR: 35000,
    ...
    requirements: ["Graduate: Nursing / Medical/ Healthcare/ Equivalent"],
    heroDescription:
      "Gain advanced expertise in cath lab operations, cardiac procedures, patient monitoring, radiation safety, and interventional cardiology support.",
    overview:
      "Cardiac Catheterization Laboratory (Cath Lab) technology plays a critical role in the diagnosis and treatment of cardiovascular diseases. Cath lab technologists assist cardiologists during interventional procedures such as coronary angiography, angioplasty, pacemaker implantation, and other minimally invasive cardiac procedures. This advanced certificate program is designed to train healthcare professionals in cath lab operations, patient preparation, equipment handling, radiation safety, and assisting during diagnostic and interventional cardiac procedures.",
    learn: [
    ...
    faqs: [
      {
        q: "Who is eligible for the Advanced Certificate in Cath Lab Technology?",
        a: "MBBS, MD, DNB holders, nursing professionals, cardiovascular technologists, allied healthcare practitioners, and healthcare professionals interested in interventional cardiology support are eligible for the Advanced Certificate in Cath Lab Technology.",
      },
      {
        q: "What is the duration of the Advanced Certificate in Cath Lab Technology?",
        a: "The course is a 6-month advanced certificate program that provides comprehensive training in cath lab procedures, equipment handling, patient monitoring, and radiation safety.",
      },
      {
        q: "What will I learn in this cath lab technology certification course?",
        a: "You will learn cardiovascular anatomy and physiology, cath lab setup and equipment operation, coronary angiography, cardiac catheterization, interventional cardiology procedures, patient monitoring, radiation safety, and cath lab documentation practices.",
      },
      {
        q: "What are the career opportunities after completing this course?",
        a: "Graduates can work in cath labs, cardiac centers, multispecialty hospitals, interventional cardiology units, cardiac diagnostic facilities, and healthcare institutions supporting cardiovascular procedures.",
      },
      {
        q: "What is the fee for the Advanced Certificate in Cath Lab Technology?",
        a: "Fees vary by program structure and training scope; exact details are available on inquiry or enrollment request with the academy.",
      },
      {
        q: "What is the salary expectation after completing the cath lab technology certificate?",
        a: "Salary depends on role, experience, and location; skilled cath lab technologists and cardiovascular healthcare professionals typically earn competitive packages in cardiac care and interventional cardiology settings.",
      },
    ],
  ...
  },
  {
    ...
    categories: ["medicine"],
    image: "courses/sexual_health_wellness_course.webp",
    lessons: 16,
    months: 3,
    level: "intermediate",
    priceINR: 16000,
    ...
    requirements: ["Graduate: Nursing / Medical/ Healthcare/ Equivalent"],
    heroDescription:
      "Develop essential knowledge in sexual health education, counseling, reproductive health, STI prevention, and sexual wellness promotion.",

    overview:
      "Sexual health is an important component of overall physical, emotional, and social well-being. It involves a positive and respectful approach to sexuality, relationships, and reproductive health. Increasing awareness about sexual health, prevention of sexually transmitted infections (STIs), and addressing sexual dysfunction are essential aspects of modern healthcare. This certificate course provides healthcare professionals with foundational knowledge in sexual health education, counseling, reproductive health, and management of common sexual health concerns in a confidential and ethical manner.",
    ...
    faqs: [
      {
        q: "Who is eligible for the Certificate in Sexual Health & Wellness?",
        a: "MBBS, MD, MS, DGO, DNB holders, psychologists, counselors, nursing professionals, allied healthcare practitioners, and other healthcare professionals with a clinical background are eligible for the Certificate in Sexual Health & Wellness.",
      },
      {
        q: "What is the duration of the Certificate in Sexual Health & Wellness?",
        a: "The course provides structured training in sexual health education, counseling, reproductive health, and sexual wellness through a comprehensive certificate program.",
      },
      {
        q: "What will I learn in this sexual health and wellness certification course?",
        a: "You will learn human sexuality, sexual health counseling, management of sexual health concerns, STI prevention, reproductive health education, family planning, and ethical approaches to sexual health practice.",
      },
      {
        q: "What are the career opportunities after completing this course?",
        a: "Graduates can work in hospitals, reproductive health clinics, counseling centers, sexual wellness programs, community health initiatives, and healthcare settings focused on sexual and reproductive health services.",
      },
      {
        q: "What is the fee for the Certificate in Sexual Health & Wellness?",
        a: "Fees vary by program structure and training scope; exact details are available on inquiry or enrollment request with the academy.",
      },
      {
        q: "What is the salary expectation after completing the sexual health and wellness certificate?",
        a: "Salary depends on role, experience, and location; professionals with expertise in sexual health counseling, reproductive health, and wellness education typically earn competitive packages in healthcare and counseling settings.",
      },
    ],
  ...
  },
  {
    ...
    categories: ["cardiology"],
    image: "courses/preventive_cardiology_course.webp",
    lessons: 18,
    months: 3,
    level: "intermediate",
    priceINR: 17500,
    ...
    faqs: [
      {
        q: "Who is eligible for the Certificate in Preventive Cardiology?",
        a: "MBBS, MD, MS, DNB holders and other healthcare professionals with a clinical background are eligible for the Certificate in Preventive Cardiology.",
      },
      {
        q: "What is the duration of the Certificate in Preventive Cardiology?",
        a: "The course provides comprehensive training in cardiovascular risk assessment, prevention strategies, and risk factor management through a structured certificate program.",
      },
      {
        q: "What will I learn in this preventive cardiology certification course?",
        a: "You will learn cardiovascular risk assessment, screening strategies, management of hypertension, diabetes, obesity, and dyslipidemia, lifestyle counseling, preventive interventions, and evidence-based cardiology practices.",
      },
      {
        q: "What are the career opportunities after completing this course?",
        a: "Graduates can work in hospitals, cardiology clinics, preventive healthcare centers, wellness programs, primary care settings, and cardiovascular risk management services focused on disease prevention.",
      },
      {
        q: "What is the fee for the Certificate in Preventive Cardiology?",
        a: "Fees vary by program structure and training scope; exact details are available on inquiry or enrollment request with the academy.",
      },
      {
        q: "What is the salary expectation after completing the preventive cardiology certificate?",
        a: "Salary depends on role, experience, and location; professionals with expertise in cardiovascular prevention, risk assessment, and chronic disease management typically earn competitive packages in clinical and preventive healthcare settings.",
      },
    ],
    meta: { duration: "3 month", lessons: "18", skill_level: "Certificate", certificate: "yes" },
  },
  {
    slug: "certificate-in-fetal-monitoring",
    title: "Certificate in Fetal Monitoring",
    categories: ["obs-gynae"],
    image: "courses/fetal_monitoring_course.webp",
    lessons: 14,
    months: 2,
    level: "intermediate",
    priceINR: 9500,
    ...
    modules: ["Foundations of Fetal Monitoring", "Advanced Interpretation & Clinical Application"],
    ...
    faqs: [
      {
        q: "Who is eligible for the Certification in Fetal Monitoring?",
        a: "MBBS, MD, MS, DGO, DNB holders, nursing professionals, midwives, allied healthcare practitioners, and other healthcare professionals involved in maternal and fetal care are eligible for the Certification in Fetal Monitoring.",
      },
      {
        q: "What is the duration of the Certification in Fetal Monitoring?",
        a: "This is a short-term certification program designed to provide focused training in fetal surveillance, monitoring techniques, and fetal well-being assessment.",
      },
      {
        q: "What will I learn in this fetal monitoring certification course?",
        a: "You will learn fetal physiology, fetal heart rate regulation, CTG interpretation, NST and CST techniques, Doppler assessment, recognition of fetal distress, and clinical decision-making during pregnancy and labor.",
      },
      {
        q: "What are the career opportunities after completing this course?",
        a: "Graduates can enhance their practice in obstetrics departments, maternity hospitals, fetal medicine units, antenatal clinics, labor wards, and maternal healthcare services.",
      },
      {
        q: "What is the fee for the Certification in Fetal Monitoring?",
        a: "Fees vary by program structure and training scope; exact details are available on inquiry or enrollment request with the academy.",
      },
      {
        q: "What is the salary expectation after completing the fetal monitoring certification?",
        a: "Salary depends on role, experience, and location; professionals with expertise in fetal surveillance and maternal-fetal care typically earn competitive packages in obstetric and maternal healthcare settings.",
      },
    ],
...
export const certificates: Course[] = _courses.filter(
  (c) => (c.program || "Certificate") === "Certificate",
);
...
export const coursesByCategory = (slug: string) =>
  courses.filter((c) => c.categories.includes(slug));
export const relatedCourses = (slug: string, n = 3) => {
  const c = getCourse(slug);
  if (!c) return [];
  const sameCat = courses.filter(
    (o) => o.slug !== slug && o.categories.some((cat) => c.categories.includes(cat)),
  );
...
export const courseStats = {
  ...
  byCategory: Object.fromEntries(
    categories.map((cat) => [cat.slug, coursesByCategory(cat.slug).length]),
  ),
  byProgram: {
