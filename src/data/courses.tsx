...
export type Course = {
  ...
  trainers?: { name: string; title?: string; bio?: string }[];
  trainers?: { name: string; title?: string; bio?: string; image?: string }[];
...
export const _courses: Course[] = [
  {
    ...
    faqs: [
      { q: "Who is eligible?", a: "MBBS, MD/DNB (Medicine), DM Cardiology, or relevant clinical backgrounds" },
      { q: "Duration?", a: "10-12 months depending on training structure" },
      { q: "Career opportunities?", a: "Echo Specialists, Cardiac Imaging Consultants in hospitals and diagnostic centers" }
    ],
    meta: {
      duration: "52 week",
      lessons: "41",
  ...
  },
  {
    ...
    faqs: [
      { q: "Who is eligible for the Certificate in Hypertension?", a: "MBBS, MD, MS, DGO, DNB holders and other healthcare professionals with a clinical background are eligible" },
      { q: "What is the duration?", a: "50 weeks" },
      { q: "What are the career opportunities?", a: "Hospitals, clinics, preventive care settings, and cardiovascular centers" }
    ],
    meta: {
      duration: "50 week",
      lessons: "35",
  ...
  },
  {
    ...
    faqs: [
      { q: "Who is eligible?", a: "Candidates with MD/MS/DM/DNB in Cardiology with 5+ years experience are eligible" },
      { q: "Duration?", a: "50 weeks" },
      { q: "Career opportunities?", a: "Interventional cardiologist positions in top hospitals and cardiac centers worldwide" }
    ],
    meta: {
      duration: "50 week",
      lessons: "37",
  ...
  },
  {
    ...
    faqs: [
      { q: "Who is eligible?", a: "MBBS and Above Qualification or relevant clinical experience" },
      { q: "Duration?", a: "52 weeks" },
      { q: "Career opportunities?", a: "Cardiologist positions in top hospitals, diagnostic centers, and academic institutions" }
    ],
    meta: {
      duration: "52 week",
      lessons: "70",
  ...
  },
  {
    ...
    faqs: [
      { q: "Who is eligible?", a: "MBBS, MD, MS, or equivalent qualifications with no previous experience required" },
      { q: "Duration?", a: "50 weeks" },
      { q: "Career opportunities?", a: "Cardiothoracic surgeon positions in leading hospitals and academic medical centers" }
    ],
    meta: {
      duration: "50 week",
      lessons: "18",
  ...
  },
  {
    ...
    faqs: [
      { q: "Who is eligible?", a: "MBBS, MD, MS, or equivalent qualifications with no previous experience required" },
      { q: "Duration?", a: "50 weeks" },
      { q: "Career opportunities?", a: "Cardio-oncology specialist positions in cancer centers and tertiary care hospitals" }
    ],
    meta: {
      duration: "50 week",
      lessons: "17",
  ...
  },
  {
    ...
    faqs: [
      { q: "Eligibility?", a: "MBBS, MD, MS, DGO, DNB holders" },
      { q: "Duration?", a: "12-24 months depending on program" },
      { q: "Opportunities?", a: "Cardiology consultant, hospital specialist, private practice" }
    ],
    meta: {
      duration: "52 week",
      lessons: "70",
  ...
  },
  {
    ...
    faqs: [
      { q: "Prerequisites?", a: "MS General Surgery with surgical experience" },
      { q: "Duration?", a: "12 months" },
      { q: "Career?", a: "Cardiothoracic Surgeon in super-specialty hospitals" }
    ],
    meta: {
      duration: "50 week",
      lessons: "18",
  ...
  },
  {
    ...
    faqs: [
      { q: "Who should apply?", a: "Cardiologists interested in cancer-related cardiac care" },
      { q: "Duration?", a: "10-12 months" },
      { q: "Career?", a: "Cardio-oncology specialist in comprehensive cancer centers" }
    ],
    meta: {
      duration: "50 week",
      lessons: "17",
  ...
  // Radiology (5 courses)
  {
    ...
    faqs: [
      { q: "Eligibility?", a: "Radiology PG, MBBS sonologists, experienced residents" },
      { q: "Focus?", a: "Multimodality imaging and diagnostic expertise" },
      { q: "Career?", a: "Radiologist in imaging centers and hospitals" }
    ],
    meta: {
      duration: "25 week",
      lessons: "28",
  ...
  },
  {
    ...
    faqs: [
      { q: "Duration?", a: "6 months intensive" },
      { q: "Certification?", a: "Yes, DMHCA certification" },
      { q: "Career?", a: "Breast imaging specialist" }
    ],
    meta: {
      duration: "25 week",
      lessons: "23",
  ...
  },
  {
    ...
    faqs: [
      { q: "Focus?", a: "Complete women's imaging specialization" },
      { q: "Duration?", a: "12 months" },
      { q: "Skills gained?", a: "Comprehensive women's health imaging expertise" }
    ],
    meta: {
      duration: "50 week",
      lessons: "27",
  ...
  },
  {
    ...
    faqs: [
      { q: "Prerequisites?", a: "Basic medical knowledge" },
      { q: "Hands-on?", a: "Yes, practical training included" },
      { q: "Certification?", a: "DMHCA certified" }
    ],
    meta: {
      duration: "25 week",
      lessons: "15",
  ...
  },
  {
    ...
    faqs: [
      { q: "Duration?", a: "12 months" },
      { q: "Hands-on training?", a: "Extensive practical sessions" },
      { q: "Career?", a: "Aesthetic physician, cosmetic dermatologist" }
    ],
    meta: {
      duration: "50 week",
      lessons: "46",
  ...
  // Medicine (8 courses)
  {
    ...
    faqs: [
      { q: "Eligibility?", a: "MBBS with medical background" },
      { q: "Duration?", a: "12 months" },
      { q: "Career?", a: "Infectious disease specialist" }
    ],
    meta: {
      duration: "50 week",
      lessons: "29",
  ...
  },
  {
    ...
    faqs: [
      { q: "Background required?", a: "Basic education, psychology interest" },
      { q: "Practical training?", a: "Yes, included" },
      { q: "Career?", a: "Clinical psychology assistant, counselor" }
    ],
    meta: {
      duration: "25 week",
      lessons: "25",
  ...
  },
  {
    ...
    faqs: [
      { q: "Duration?", a: "6 weeks intensive" },
      { q: "Focus?", a: "HIV/AIDS comprehensive management" },
      { q: "Certificate?", a: "Yes, internationally recognized" }
    ],
    meta: {
      duration: "25 week",
      lessons: "42",
  ...
  },
  {
    ...
    faqs: [
      { q: "Duration?", a: "12 weeks" },
      { q: "Cost?", a: "Very affordable" },
      { q: "Who should take?", a: "Doctors, healthcare workers" }
    ],
    meta: {
      duration: "50 week",
      lessons: "27",
  ...
  },
  {
    ...
    faqs: [
      { q: "Career?", a: "Nephrologist in hospitals and dialysis centers" },
      { q: "Duration?", a: "12 months" },
      { q: "Salary prospects?", a: "Very good in dialysis and transplant units" }
    ],
    meta: {
      duration: "50 week",
      lessons: "48",
  ...
  },
  {
    ...
    faqs: [
      { q: "Most intensive course?", a: "Yes, highest level training" },
      { q: "Salary?", a: "Among highest in medicine" },
      { q: "Duration?", a: "12 months" }
    ],
    meta: {
      duration: "52 week",
  ...
  },
  {
    ...
    faqs: [
      { q: "Specialty focus?", a: "Rheumatic and autoimmune diseases" },
      { q: "Career?", a: "Rheumatologist in hospitals and private practice" },
      { q: "Duration?", a: "12 months" }
    ],
    meta: {
      duration: "50 week",
  ...
  },
  {
    ...
    faqs: [
      { q: "Focus?", a: "Comprehensive psychiatry management" },
      { q: "Career?", a: "Psychiatrist in hospitals and clinics" },
      { q: "Skills?", a: "Clinical expertise in mental health" }
    ],
    meta: {
      duration: "52 week",
      lessons: "72",
  ...
  // Obstetrics & Gynecology (8 courses)
  {
    ...
    faqs: [
      { q: "Who is this for?", a: "Nurses seeking specialization in obstetrics and gynecology nursing." },
      { q: "Duration?", a: "25 weeks with clinical postings." },
      { q: "Practical training?", a: "Includes antenatal clinic, labor room and postnatal ward postings." }
    ],
    meta: {
      duration: "25 week",
      lessons: "36",
  ...
  },
  {
    ...
    faqs: [
      { q: "Focus?", a: "Maternal and child health improvement" },
      { q: "Duration?", a: "12 months" },
      { q: "Career?", a: "Public health specialist, MCH coordinator" }
    ],
    meta: {
      duration: "50 week",
      lessons: "48",
  ...
  },
  {
    ...
    faqs: [
      { q: "Specialization?", a: "Complicated pregnancy management" },
      { q: "Career?", a: "Maternal-fetal medicine specialist" },
      { q: "Duration?", a: "12 months" }
    ],
    meta: {
      duration: "50 week",
  ...
  },
  {
    ...
    faqs: [
      { q: "Specialization?", a: "Maternal-fetal medicine, ultrasound" },
      { q: "Career?", a: "Fetal medicine specialist" },
      { q: "Salary?", a: "Very good in diagnostic centers" }
    ],
    meta: {
      duration: "50 week",
      lessons: "28",
  ...
  },
  {
    ...
    faqs: [
      { q: "Duration?", a: "6 weeks intensive" },
      { q: "Hands-on?", a: "100% practical scanning" },
      { q: "Career?", a: "Obstetric ultrasound specialist" }
    ],
    meta: {
      duration: "25 week",
      lessons: "24",
  ...
  },
  {
    ...
    faqs: [
      { q: "Skill level?", a: "Advanced surgical training" },
      { q: "Hands-on?", a: "Extensive surgical experience" },
      { q: "Career?", a: "Gynecological surgeon in hospitals" }
    ],
    meta: {
      duration: "50 week",
      lessons: "35",
  ...
  },
  {
    ...
    faqs: [
      { q: "Niche specialization?", a: "Yes, cosmetic gynecology" },
      { q: "Career?", a: "Cosmetic gynecologist" },
      { q: "Salary?", a: "High earnings potential" }
    ],
    meta: {
      duration: "50 week",
      lessons: "23",
  ...
  },
  {
    ...
    faqs: [
      { q: "Comprehensive training?", a: "Yes, complete OBG specialization" },
      { q: "Duration?", a: "12 months" },
      { q: "Career?", a: "OBG specialist in hospitals" }
    ],
    meta: {
      duration: "50 week",
      lessons: "68",
  ...
  // Additional 27 courses (shortened for brevity - Neurology, Pediatrics, Reproductive, etc.)
  {
    ...
    learn: ["Neurological disorders", "EEG interpretation", "Imaging analysis", "Stroke management", "Movement disorders", "Seizure management"],
    requirements: ["MD Neurology", "2+ years experience"],
    modules: ["Neurology Basics", "Stroke", "Epilepsy", "Movement Disorders", "Dementia", "Advanced Neurology"],
    faqs: [
      { q: "Specialization?", a: "Neurology comprehensive" },
      { q: "Career?", a: "Neurologist in hospitals" },
      { q: "Salary?", a: "Very competitive" }
    ],
    meta: { duration: "50 week", lessons: "0", skill_level: "Fellowship", certificate: "yes" }
  },
  {
    ...
    learn: ["JIA", "SLE in children", "Vasculitis", "Biologics", "Immunosuppression", "Long-term management"],
    requirements: ["MD Pediatrics", "1+ years experience"],
    modules: ["Pediatric Autoimmunity", "JIA", "SLE", "Vasculitis", "Biologics", "Clinical Management"],
    faqs: [
      { q: "Target group?", a: "Pediatricians interested in rheumatology" },
      { q: "Career?", a: "Pediatric rheumatology specialist" }
    ],
  ...
  },
  {
    ...
    learn: ["Nutritional assessment", "Diet planning", "Disease nutrition", "Sports nutrition", "Public health nutrition", "Food safety"],
    requirements: ["Bachelors in Nutrition/Home Science", "Interest in dietetics"],
    modules: ["Nutrition Basics", "Clinical Nutrition", "Diet Planning", "Public Health Nutrition", "Advanced Nutrition", "Practice"],
    faqs: [
      { q: "Duration?", a: "12 months" },
      { q: "Career?", a: "Nutritionist, dietitian" },
      { q: "Salary?", a: "Growing field with good opportunities" }
    ],
  ...
  },
  {
    ...
    learn: ["Embryo biology", "Culture techniques", "Embryo selection", "Quality control", "ICSI", "Embryo transfer"],
    requirements: ["BSc Life Sciences", "Lab experience preferred"],
    modules: ["Embryology Basics", "Culture Techniques", "ART Lab", "Embryo Assessment", "Quality", "Ethics"],
    faqs: [
      { q: "For lab technicians?", a: "Yes, specialized training" },
      { q: "Career?", a: "Embryologist in ART centers" }
    ],
  ...
  },
  {
    ...
    learn: ["Advanced embryo culture", "Genetic screening", "Preimplantation testing", "Lab management", "Quality assurance", "IVF protocols"],
    requirements: ["BSc/MSc", "Lab embryology experience"],
    modules: ["Advanced Embryology", "ART Techniques", "Genetic Screening", "Lab Management", "Troubleshooting", "Advanced Cases"],
    faqs: [
      { q: "Advanced training?", a: "Yes, comprehensive embryology" },
      { q: "Career?", a: "Senior embryologist" }
    ],
  ...
  },
  {
    ...
    learn: ["Infertility evaluation", "Ovarian stimulation", "Oocyte retrieval", "Embryo transfer", "ICSI", "Freezing techniques"],
    requirements: ["MD OBG", "2+ years experience"],
    modules: ["Infertility Basics", "Ovulation Induction", "IVF Cycle", "Embryo Transfer", "Cryopreservation", "Advanced Cases"],
    faqs: [
      { q: "Highest level?", a: "Yes, fellowship training" },
      { q: "Career?", a: "Reproductive endocrinologist" },
      { q: "Salary?", a: "Excellent earnings potential" }
    ],
  ...
  },
  {
    ...
    learn: ["Reproductive physiology", "Hormone assessment", "Stimulation protocols", "Embryo transfer", "Pregnancy support", "PCOS management"],
    requirements: ["MD OBG", "Endocrinology background helpful"],
    modules: ["Reproductive Endocrinology", "Hormone Testing", "Stimulation", "IVF", "PCOS", "Ovarian Reserve"],
    faqs: [
      { q: "Focus?", a: "Hormonal aspects of reproduction" },
      { q: "Career?", a: "Reproductive endocrinologist" }
    ],
    meta: { duration: "50 week", lessons: "27", skill_level: "Fellowship", certificate: "yes" }
  },
  {
    ...
    learn: ["Infertility evaluation", "Semen analysis", "Ovulation tracking", "IUI basics", "ART overview", "Counseling"],
    requirements: ["MBBS", "Basic medical knowledge"],
    modules: ["Infertility Basics", "Diagnosis", "Treatment Options", "IUI", "ART Introduction", "Patient Care"],
    faqs: [
      { q: "Beginner course?", a: "Yes, introductory level" },
      { q: "Career?", a: "Infertility specialist assistant" }
    ],
    meta: { duration: "25 week", lessons: "28", skill_level: "PG Diploma", certificate: "yes" }
    ,
    trainers: [
      { name: "Dr. Prabhdeep Kaur", title: "Obs & Gynea Specialist", bio: "Specialist in reproductive health and infertility management.", image: "/Faculty_images/dr-prabhdeep-kaur.jpg" }
    ]
  },
  {
    ...
    learn: ["Embryo development", "Selection criteria", "Vitrification", "Thawing protocols", "Blastocyst culture", "Lab QC"],
    requirements: ["Masters Embryology", "Lab experience"],
    modules: ["Advanced Embryology", "Culture Systems", "Embryo Assessment", "Cryopreservation", "Lab Management", "Research"],
    faqs: [
      { q: "Highest embryology training?", a: "Yes, fellowship level" },
      { q: "Career?", a: "Senior embryologist, lab director" }
    ],
  ...
  },
  {
    ...
    learn: ["Diabetes management", "Thyroid disorders", "Adrenal disease", "Pituitary disorders", "Hormone testing", "Hormone replacement"],
    requirements: ["MD Medicine", "2+ years experience"],
    modules: ["Endocrinology Basics", "Diabetes", "Thyroid", "Adrenal", "Pituitary", "Advanced Cases"],
    faqs: [
      { q: "Specialization?", a: "Comprehensive endocrinology" },
      { q: "Career?", a: "Endocrinologist" }
    ],
  ...
  },
  {
    ...
    learn: ["Diabetes pathophysiology", "Blood glucose monitoring", "Insulin therapy", "GLP-1 agonists", "Complications", "Patient education"],
    requirements: ["MD Medicine", "Endocrinology interest"],
    modules: ["Diabetes Basics", "Type 1", "Type 2", "Insulin Therapy", "GLP-1 Agents", "Complications"],
    faqs: [
      { q: "Specialization?", a: "Diabetes focused" },
      { q: "Career?", a: "Diabetologist" }
    ],
  ...
  },
  {
    ...
    learn: ["Foot anatomy", "Neuropathy assessment", "Vascular assessment", "Ulcer care", "Infection management", "Prevention"],
    requirements: ["Medical/paramedical background"],
    modules: ["Diabetes & Foot", "Assessment", "Ulcer Management", "Infection Control", "Prevention", "Patient Education"],
    faqs: [
      { q: "Short duration?", a: "Yes, only 12 weeks" },
      { q: "Career?", a: "Diabetes foot care specialist" }
    ],
  ...
  },
  {
    ...
    learn: ["Fracture management", "Arthroscopy", "Joint replacement", "Sports medicine", "Trauma protocols", "Advanced techniques"],
    requirements: ["MS Orthopedics", "3+ years experience"],
    modules: ["Orthopedics Basics", "Fractures", "Arthroscopy", "Joint Replacement", "Sports Medicine", "Advanced Surgery"],
    faqs: [
  ...
  },
  {
    ...
    learn: ["Spinal anatomy", "Discectomy", "Fusion surgery", "MIS techniques", "Tumor surgery", "Trauma"],
    requirements: ["MS Orthopedics", "3+ years experience"],
    modules: ["Spine Anatomy", "Discectomy", "Fusion", "MIS", "Tumors", "Trauma"],
    faqs: [
      { q: "Advanced specialty?", a: "Yes, highly specialized" },
      { q: "Career?", a: "Spine surgeon" },
      { q: "Salary?", a: "Highest in orthopedics" }
    ],
  ...
  },
  {
    ...
    learn: ["Skin diseases", "Laser therapy", "Surgical techniques", "Cosmetic procedures", "Pathology", "Advanced treatments"],
    requirements: ["MD Dermatology", "2+ years experience"],
    modules: ["Dermatology Basics", "Clinical", "Surgical", "Cosmetic", "Laser", "Advanced Topics"],
    faqs: [
      { q: "Comprehensive?", a: "Yes, all areas of dermatology" },
  ...
  },
  {
    ...
    learn: ["Hair physiology", "Alopecia types", "Scalp diseases", "Hair transplantation", "Medications", "Procedures"],
    requirements: ["MD Dermatology", "1+ years experience"],
    modules: ["Hair Biology", "Alopecia", "Scalp Diseases", "Transplantation", "Medical Therapy", "Advanced Cases"],
    faqs: [
      { q: "Niche specialization?", a: "Yes, hair and scalp focused" },
      { q: "Career?", a: "Trichologist" }
    ],
  ...
  },
  {
    ...
    learn: ["Cosmetic assessment", "Laser procedures", "Botox/fillers", "Chemical peels", "Radiofrequency", "Business"],
    requirements: ["MBBS", "MD Dermatology preferred"],
    modules: ["Cosmetic Basics", "Lasers", "Injectables", "Peels", "RF Therapy", "Business Management"],
    faqs: [
      { q: "Career earnings?", a: "Very high in cosmetic practice" },
      { q: "Business aspect?", a: "Yes, practice management included" }
    ],
  ...
  },
  {
    ...
    learn: ["Laparoscopic surgery", "Endoscopy", "Advanced techniques", "Complication management", "Equipment", "Ergonomics"],
    requirements: ["MS Surgery", "3+ years experience"],
    modules: ["MAS Basics", "Laparoscopy", "Endoscopy", "Advanced Cases", "Troubleshooting", "Equipment"],
    faqs: [
      { q: "Specialization?", a: "Minimal access surgery" },
      { q: "Career?", a: "MAS surgeon" },
      { q: "Salary?", a: "Very competitive" }
    ],
    meta: { duration: "50 week", lessons: "47", skill_level: "Fellowship", certificate: "yes" }
  },
  {
    ...
    learn: ["Robotic system", "Console operation", "Robotic procedures", "Advanced techniques", "Troubleshooting", "Clinical outcomes"],
    requirements: ["MS Surgery", "3+ years experience"],
    modules: ["Robotic Basics", "Console Training", "Procedures", "Advanced Cases", "Maintenance", "Research"],
    faqs: [
      { q: "Most advanced?", a: "Yes, robotic surgery" },
      { q: "Career?", a: "Robotic surgeon" },
      { q: "Salary?", a: "Highest in surgery" }
    ],
  ...
  },
  {
    ...
    learn: ["Congenital anomalies", "Neonatal surgery", "Pediatric trauma", "Minimally invasive", "Pediatric anesthesia", "Long-term outcomes"],
    requirements: ["MS Surgery", "3+ years experience"],
    modules: ["Pediatric Surgery Basics", "Congenital", "Neonatal", "Trauma", "MAS", "Advanced Cases"],
    faqs: [
      { q: "Specialization?", a: "Pediatric surgery" },
      { q: "Career?", a: "Pediatric surgeon" }
    ],
    meta: { duration: "52 week", lessons: "36", skill_level: "Fellowship", certificate: "yes" }
  },
  {
    ...
    learn: ["Seizure management", "Developmental assessment", "Neuroimaging", "EEG interpretation", "Medications", "Long-term care"],
    requirements: ["MD Pediatrics", "1+ years experience"],
    modules: ["Pediatric Neurology", "Seizures", "Development", "Imaging", "Medications", "Advanced Cases"],
    faqs: [
      { q: "Focus?", a: "Child neurology" },
      { q: "Career?", a: "Pediatric neurologist" }
    ],
  ...
  },
  {
    ...
    learn: ["Preterm care", "Resuscitation", "Ventilation", "Sepsis management", "Nutrition", "Complications"],
    requirements: ["MD Pediatrics", "1+ years experience"],
    modules: ["Neonatal Basics", "Preterm", "Resuscitation", "ICU", "Nutrition", "Chronic Complications"],
    faqs: [
      { q: "Career?", a: "Neonatologist in NICU" },
      { q: "Salary?", a: "Good earning potential" }
    ],
    meta: { duration: "50 week", lessons: "55", skill_level: "Fellowship", certificate: "yes" }
  },
  {
    ...
    learn: ["Pediatric echo", "Congenital heart disease", "Normal variants", "Doppler assessment", "Fetal echo", "Advanced imaging"],
    requirements: ["MD Pediatrics", "Cardiology background"],
    modules: ["Pediatric Echo Basics", "Congenital", "Doppler", "Fetal Echo", "Advanced Cases", "Research"],
    faqs: [
      { q: "Specialization?", a: "Pediatric cardiac imaging" },
      { q: "Career?", a: "Pediatric echocardiographer" }
    ],
  ...
  },
  {
    ...
    learn: ["Trauma management", "ACLS", "Resuscitation", "Acute syndromes", "Toxicology", "Critical procedures"],
    requirements: ["MBBS", "MD Medicine preferred"],
    modules: ["EM Basics", "Trauma", "ACLS", "Acute Syndromes", "Procedures", "Toxicology"],
    faqs: [
      { q: "Career?", a: "Emergency physician" },
      { q: "Shifts?", a: "Variable shift work" }
    ],
  ...
  },
  {
    ...
    learn: ["Emergency assessment", "Resuscitation", "Common emergencies", "Toxicology", "Procedures", "Documentation"],
    requirements: ["MBBS", "1+ years experience"],
    modules: ["EM Basics", "Assessment", "Resuscitation", "Common EM", "Procedures", "Documentation"],
    faqs: [
      { q: "Duration?", a: "12 months" },
      { q: "Career?", a: "Emergency medicine specialist" }
    ],
  ...
  },
  {
    ...
    learn: ["Mechanical ventilation", "Hemodynamics", "Sepsis", "ARDS", "Multi-organ failure", "Procedures"],
    requirements: ["MD Medicine", "2+ years experience"],
    modules: ["ICU Basics", "Ventilation", "Hemodynamics", "Sepsis", "Organ Failure", "Advanced Procedures"],
    faqs: [
      { q: "Career?", a: "Critical care specialist" },
      { q: "Salary?", a: "Excellent prospects" }
    ],
  ...
  },
  {
    ...
    learn: ["ICU basics", "Ventilation", "Hemodynamics", "Common ICU scenarios", "Procedures", "Communication"],
    requirements: ["MBBS", "1+ years experience"],
    modules: ["ICU Basics", "Ventilation", "Hemodynamics", "Common Cases", "Procedures", "Management"],
    faqs: [
      { q: "Duration?", a: "12 months" },
      { q: "Career?", a: "ICU physician" }
    ],
  ...
  },
  {
    ...
    learn: ["HIV epidemiology", "CD4 assessment", "ART regimens", "OI management", "Adherence", "Prevention"],
    requirements: ["MBBS", "MD Medicine"],
    modules: ["HIV Basics", "Assessment", "ART", "OI", "Complications", "Prevention"],
    faqs: [
      { q: "Career?", a: "HIV medicine specialist" },
      { q: "Duration?", a: "12 months" }
    ],
  ...
  },
  {
    ...
    learn: ["Hospital operations", "Finance management", "Quality assurance", "HR management", "Compliance", "Leadership"],
    requirements: ["Bachelor's degree", "Healthcare interest"],
    modules: ["Hospital Basics", "Management", "Finance", "Quality", "HR", "Compliance"],
    faqs: [
      { q: "Career?", a: "Hospital administrator" },
      { q: "Duration?", a: "12 months" }
    ],
  ...
  },
  {
    ...
    learn: ["Strategic management", "Operations", "Healthcare IT", "Finance", "Quality", "Innovation", "Leadership"],
    requirements: ["Bachelor's degree", "Business/healthcare interest"],
    modules: ["Management Basics", "Strategy", "Operations", "IT", "Finance", "Quality", "Leadership"],
    faqs: [
      { q: "Comprehensive?", a: "Yes, 126 lessons" },
      { q: "Duration?", a: "12 months" },
      { q: "Career?", a: "Hospital CEO, healthcare manager" }
    ],
  ...
  },
  {
    ...
    learn: ["Family assessment", "Chronic disease management", "Preventive care", "Mental health", "Geriatric care", "Community medicine"],
    requirements: ["MD Medicine", "1+ years family medicine"],
    modules: ["Family Medicine Basics", "Chronic Diseases", "Prevention", "Mental Health", "Geriatrics", "Community Health"],
    faqs: [
      { q: "Career?", a: "Family medicine specialist" },
      { q: "Work type?", a: "Usually in clinics and community health" }
    ],
  ...
  },
  {
    ...
    learn: ["Pain physiology", "Assessment techniques", "Medications", "Interventional procedures", "Counseling", "Multidisciplinary approach"],
    requirements: ["MD Anesthesiology", "2+ years experience"],
    modules: ["Pain Basics", "Assessment", "Pharmacotherapy", "Interventional", "Multidisciplinary", "Advanced Cases"],
    faqs: [
      { q: "Specialization?", a: "Pain medicine" },
      { q: "Career?", a: "Pain management specialist" }
    ],
  ...
  },
  {
    ...
    learn: ["Cancer biology", "Chemotherapy", "Targeted therapy", "Immunotherapy", "Supportive care", "Clinical trials"],
    requirements: ["MD Medicine", "2+ years experience"],
    modules: ["Oncology Basics", "Chemotherapy", "Targeted Therapy", "Immunotherapy", "Supportive Care", "Advanced Cases"],
    faqs: [
      { q: "Career?", a: "Medical oncologist" },
      { q: "Salary?", a: "Very competitive" }
    ],
  ...
  },
  {
    ...
    learn: ["HNC anatomy", "Surgery techniques", "Radiation", "Chemotherapy", "Multidisciplinary approach", "Reconstruction"],
    requirements: ["MD Oncology/Surgery", "2+ years experience"],
    modules: ["HNC Basics", "Surgery", "Radiation", "Chemotherapy", "Multidisciplinary", "Advanced Cases"],
    faqs: [
      { q: "Specialization?", a: "Head and neck cancers" },
      { q: "Career?", a: "Head and neck oncologist" }
    ],
  ...
  },
  {
    ...
    learn: ["GYN cancer surgery", "Chemotherapy", "Radiation", "Targeted therapy", "Multidisciplinary", "Palliative care"],
    requirements: ["MD/DNB OBG", "2+ years experience"],
    modules: ["GYN Oncology Basics", "Surgery", "Chemotherapy", "Radiation", "Multidisciplinary", "Palliative Care"],
    faqs: [
      { q: "Specialization?", a: "Gynecologic cancers" },
      { q: "Career?", a: "Gynecologic oncologist" }
    ],
  ...
  },
  {
    ...
    learn: ["GI physiology", "Endoscopy", "Colonoscopy", "ERCP", "Ultrasound", "Motility disorders"],
    requirements: ["MD Medicine", "2+ years experience"],
    modules: ["GI Basics", "Upper Endoscopy", "Colonoscopy", "ERCP", "Ultrasound", "Advanced Cases"],
    faqs: [
      { q: "Career?", a: "Gastroenterologist" },
      { q: "Salary?", a: "Very good" }
    ],
  ...
  },
  {
    ...
    learn: ["Upper endoscopy", "Colonoscopy", "ERCP", "Therapeutic procedures", "Complications", "Quality"],
    requirements: ["MD/DNB Medicine", "Gastroenterology background"],
    modules: ["Endoscopy Basics", "Upper GI", "Lower GI", "ERCP", "Therapeutic", "Advanced Cases"],
    faqs: [
      { q: "Hands-on?", a: "100% procedural training" },
      { q: "Career?", a: "Endoscopist" }
    ],
  ...
  },
  {
    ...
    learn: ["Urological diseases", "Prostate cancer", "Kidney cancer", "Endourology", "Stones", "Reconstruction"],
    requirements: ["MS/MCh Urology", "2+ years experience"],
    modules: ["Urology Basics", "Oncology", "Endourology", "Stones", "Reconstruction", "Advanced Cases"],
    faqs: [
      { q: "Career?", a: "Urologist" },
      { q: "Salary?", a: "Very competitive" }
    ],
  ...
  },
  {
    ...
    learn: ["Anemia", "Leukemia", "Lymphoma", "Bleeding disorders", "Transfusion", "Bone marrow", "Stem cell"],
    requirements: ["MD Medicine", "2+ years experience"],
    modules: ["Hematology Basics", "Anemias", "Leukemias", "Lymphomas", "Bleeding Disorders", "Advanced Cases"],
    faqs: [
      { q: "Career?", a: "Hematologist" },
      { q: "Subspecialties?", a: "Hemato-oncology, BMT" }
    ],
  ...
  },
  {
    ...
    learn: ["Implant anatomy", "Placement techniques", "Prosthodontics", "Laser therapy", "Soft tissue", "Advanced procedures"],
    requirements: ["BDS", "Dental background"],
    modules: ["Implant Basics", "Placement", "Prosthodontics", "Laser", "Soft Tissue", "Advanced Cases"],
    faqs: [
      { q: "Specialization?", a: "Implants and laser dentistry" },
      { q: "Career?", a: "Implant dentist" }
    ],
  ...
  },
  {
    ...
    learn: ["Oral surgery", "Facial trauma", "Reconstruction", "Pathology", "Implants", "Advanced procedures"],
    requirements: ["BDS", "Oral Surgery background"],
    modules: ["OMFS Basics", "Trauma", "Reconstruction", "Pathology", "Implants", "Advanced Cases"],
    faqs: [
      { q: "Career?", a: "Oral and maxillofacial surgeon" },
      { q: "Specialization?", a: "Trauma and reconstruction" }
    ],
    meta: { duration: "50 week", lessons: "46", skill_level: "Fellowship", certificate: "yes" }
  },
  {
    ...
    learn: ["Nutrition basics", "Assessment", "Diet planning", "Therapeutic diets", "Counseling", "Documentation"],
    requirements: ["Medical or Allied Health background"],
    modules: ["Nutrition Basics", "Assessment", "Therapeutic Diets", "Clinical Cases", "Counseling", "Documentation"],
    faqs: [
      { q: "For healthcare workers?", a: "Yes, clinical nutrition focus" },
      { q: "Career?", a: "Clinical nutritionist assistant" }
    ],
    meta: { duration: "25 week", lessons: "36", skill_level: "Certificate", certificate: "yes" }
  },
  {
    ...
    learn: ["Obesity physiology", "Diet planning", "Behavior modification", "Exercise", "Medications", "Support programs"],
    requirements: ["Medical or nutrition background"],
    modules: ["Obesity Basics", "Assessment", "Dietary Management", "Behavior", "Exercise", "Medications"],
    faqs: [
      { q: "Duration?", a: "Very short - 6 weeks" },
      { q: "Career?", a: "Obesity management counselor" }
    ],
    meta: { duration: "24 week", lessons: "50", skill_level: "Certificate", certificate: "yes" }
  },
  {
    ...
    learn: ["Diabetes types", "Blood glucose monitoring", "Insulin therapy", "Complications", "Patient education", "Prevention"],
    requirements: ["MBBS", "MD Medicine"],
    modules: ["Diabetes Basics", "Type 1", "Type 2", "Monitoring", "Insulin", "Complications"],
    faqs: [
      { q: "Duration?", a: "12 months" },
      { q: "Career?", a: "Diabetologist" }
    ],
