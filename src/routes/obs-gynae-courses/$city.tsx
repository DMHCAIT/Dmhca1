        ...
        <div className="w-full">
          ...
          <div className="mb-12">
            <p className="text-lg text-slate-700 leading-relaxed mb-4">
              ...
              for pursuing obstetrics and gynaecology specialization. Our comprehensive obstetrics and gynaecology programs provide world-class education and practical
          ...
          <div className="mt-16 bg-gradient-to-r from-slate-900 to-slate-800 rounded-2xl p-12 text-center text-white">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto">
              Enroll in our obstetrics and gynaecology program in {city.charAt(0).toUpperCase() + city.slice(1)} today and advance your medical career
            </p>
