...
export const Route = createFileRoute("/obstetrics-and-gynecology-courses/")({
  head: () => ({
    meta: [
      { title: "Obstetrics and Gynecology Courses — DMHCA" },
      {
        name: "description",
        content: "Browse all obstetrics and gynecology courses, fellowships, and certifications at DMHCA.",
      },
    ],
  }),
...
function SpecialtyCourses() {
  const categorySlug = "obs-gynae";
  const displayName = "Obstetrics and Gynecology";
