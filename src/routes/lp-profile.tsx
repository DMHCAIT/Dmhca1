          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
            <aside className="md:col-span-4 bg-white rounded-2xl p-6 shadow-sm flex flex-col gap-4">
              ...
              <p className="text-sm text-muted-foreground">
                Quick access to login or create your DMHCA account.
              </p>
              <nav className="mt-4 flex flex-col gap-2">
                <button
                  onClick={() => setTab("login")}
                  className={`text-left px-3 py-2 rounded-lg ${tab === "login" ? "bg-navy-deep text-white" : "text-slate-700 hover:bg-slate-100"}`}
                >
                  Log in
                </button>
                <button
                  onClick={() => setTab("signup")}
                  className={`text-left px-3 py-2 rounded-lg ${tab === "signup" ? "bg-navy-deep text-white" : "text-slate-700 hover:bg-slate-100"}`}
                >
                  Sign up
                </button>
              </nav>
              <div className="mt-auto text-sm text-muted-foreground">
                ...
                <div className="mt-2">
                  Call admissions:{" "}
                  <a href="tel:+919899711530" className="text-navy-deep font-medium">
                    +91 9899711530
                  </a>
                </div>
              </div>
              ...
              {tab === "login" ? (
                <div>
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <a href="#" className="text-sm text-navy-deep hover:underline">
                      Forgot password?
                    </a>
                  </div>

                  <button className="w-full px-4 py-3 bg-gradient-to-br from-navy-deep to-navy text-primary-foreground rounded-full">
                    Log in
                  </button>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-6">
                    Start your learning journey with DMHCA.
                  </p>
