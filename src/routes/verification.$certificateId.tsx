  ...
  head: ({ loaderData }) => ({
    meta: loaderData
      ? [
          ...
          {
            name: "description",
            content: `Certificate verification for ${loaderData.certificate.full_name}`,
          },
        ]
      : [],
  }),
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-green-700">
                This credential is authentic and independently verified by DMHCA
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="px-8 py-6 bg-white h-3/4 flex flex-col justify-between">
                ...
                <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-3 flex items-center gap-4">
                  <div className="flex-1">
                    ...
                    <p className="text-gray-900 font-bold text-sm font-mono break-all">
                      {certificate.certificate_id}
                    </p>
                  </div>
        ...
        <div className="mt-12 p-6 bg-amber-50 border-l-4 border-amber-500 rounded-r-lg">
          ...
          <p className="text-amber-800 text-sm">
            This certificate verifies that the above individual has successfully completed the
            credential program according to DMHCA standards. While DMHCA maintains accurate records,
            this service should not be the sole basis for critical decisions. For official
            verification, please contact DMHCA directly or request original documentation.
          </p>
        </div>
      </div>
