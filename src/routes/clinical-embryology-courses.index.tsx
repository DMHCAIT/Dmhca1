...
export const Route = createFileRoute("/clinical-embryology-courses/")({
  head: () => ({
    meta: [
      { title: "Clinical Embryology Courses — DMHCA" },
      {
        name: "description",
        content: "Browse all clinical embryology courses, fellowships, and certifications at DMHCA.",
      },
    ],
  }),
...
function SpecialtyCourses() {
  const categorySlug = "reproductive";
  const displayName = "Clinical Embryology";
