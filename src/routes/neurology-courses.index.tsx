...
export const Route = createFileRoute("/neurology-courses/")({
  head: () => ({
    meta: [
      { title: "Neurology Courses — DMHCA" },
      {
        name: "description",
        content: "Browse all neurology courses, fellowships, and certifications at DMHCA.",
      },
    ],
  }),
...
function SpecialtyCourses() {
  const categorySlug = "neurology";
  const displayName = "Neurology";
