...
export const Route = createFileRoute("/endocrinology-courses/")({
  head: () => ({
    meta: [
      { title: "Endocrinology Courses — DMHCA" },
      {
        name: "description",
        content: "Browse all endocrinology courses, fellowships, and certifications at DMHCA.",
      },
    ],
  }),
...
function SpecialtyCourses() {
  const categorySlug = "endocrinology";
  const displayName = "Endocrinology";
