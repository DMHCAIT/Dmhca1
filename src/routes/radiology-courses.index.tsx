...
export const Route = createFileRoute("/radiology-courses/")({
  head: () => ({
    meta: [
      { title: "Radiology Courses — DMHCA" },
      {
        name: "description",
        content: "Browse all radiology courses, fellowships, and certifications at DMHCA.",
      },
    ],
  }),
...
function SpecialtyCourses() {
  const categorySlug = "radiology";
  const displayName = "Radiology";
