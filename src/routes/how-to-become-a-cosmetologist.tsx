      ...
      <section className="py-2 sm:py-3 md:py-4 bg-white dark:bg-slate-800 px-4 sm:px-0">
        <div className="container-x flex justify-center">
          <div className="relative overflow-hidden rounded-lg sm:rounded-xl md:rounded-2xl shadow-lg sm:shadow-xl md:shadow-2xl w-full max-w-[992px]">
            <img src="/blog-images/How-to-Become-a-Cosmetologist.webp" alt="How to Become a Cosmetologist" className="w-full h-auto aspect-[992/496] object-cover" />
        ...
        <div className="container-x max-w-4xl">
          <div className="prose prose-lg prose-slate dark:prose-invert max-w-none">
            <div className="mb-12 not-prose">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 dark:text-slate-50 mb-6">Path to Cosmetologist</h2>
              <p className="text-slate-700 dark:text-slate-300 mb-8 text-sm sm:text-base">Becoming a cosmetologist in India requires a systematic approach combining academic excellence, competitive entrance exams, and clinical experience. This guide outlines the complete pathway to help you navigate your journey into this rewarding medical specialty.</p>
              
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-gradient-to-br from-amber-600/95 to-orange-600/95 dark:from-amber-700 dark:to-orange-700 text-white font-bold">1</div>
                  </div>
                ...
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-gradient-to-br from-amber-600/95 to-orange-600/95 dark:from-amber-700 dark:to-orange-700 text-white font-bold">2</div>
                  </div>
                  <div className="flex-1">
                ...
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-gradient-to-br from-amber-600/95 to-orange-600/95 dark:from-amber-700 dark:to-orange-700 text-white font-bold">3</div>
                  </div>
                  <div className="flex-1">
                ...
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-gradient-to-br from-amber-600/95 to-orange-600/95 dark:from-amber-700 dark:to-orange-700 text-white font-bold">4</div>
                  </div>
                  <div className="flex-1">
                ...
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-gradient-to-br from-amber-600/95 to-orange-600/95 dark:from-amber-700 dark:to-orange-700 text-white font-bold">5</div>
                  </div>
                  <div className="flex-1">
                ...
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-gradient-to-br from-amber-600/95 to-orange-600/95 dark:from-amber-700 dark:to-orange-700 text-white font-bold">6</div>
                  </div>
                  <div className="flex-1">
                ...
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-gradient-to-br from-amber-600/95 to-orange-600/95 dark:from-amber-700 dark:to-orange-700 text-white font-bold">7</div>
                  </div>
                  <div className="flex-1">
            ...
            <div className="mb-12 not-prose">
              ...
              <div className="bg-gradient-to-r from-amber-600/95 to-orange-600/95 dark:from-amber-700 dark:to-orange-700 rounded-lg p-6 text-white">
                <p className="text-sm sm:text-base">Total Duration: <span className="font-bold text-lg">8.5-9.5 years</span></p>
                ...
                <div className="p-4 sm:p-6 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-700/50 dark:to-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg sm:rounded-xl hover:shadow-md transition">
                  <details className="group">
                    <summary className="flex items-start justify-between cursor-pointer font-semibold text-slate-900 dark:text-slate-100 text-sm sm:text-base">
                      <span className="flex-1 text-left pr-4">What is the total time required to become a cosmetologist?</span>
                    ...
                    <p className="text-slate-700 dark:text-slate-300 mt-3 text-xs sm:text-sm leading-relaxed">Total duration is approximately 8.5-9.5 years. This includes 12th completion, 5.5-year MBBS program, 1-year internship, NEET-PG preparation, and 3-year postgraduate specialization training.</p>
                  </details>
                </div>
                <div className="p-4 sm:p-6 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-700/50 dark:to-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg sm:rounded-xl hover:shadow-md transition">
                  <details className="group">
            ...
            <div className="mt-20 p-10 bg-gradient-to-r from-amber-600/95 to-orange-600/95 dark:from-amber-700 dark:to-orange-700 rounded-2xl border border-white/20 dark:border-white/30 shadow-lg not-prose">
              <div className="flex items-start gap-6">
                <BookOpen className="w-10 h-10 text-white flex-shrink-0 mt-1" />
                <div>
                  <h3 className="text-2xl font-bold text-white dark:text-slate-50 mb-3">Explore Cosmetologist Programs</h3>
