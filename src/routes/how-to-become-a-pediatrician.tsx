            ...
            <div className="mt-20 p-10 bg-gradient-to-r from-sky-600/95 to-blue-600/95 dark:from-sky-700 dark:to-blue-700 rounded-2xl border border-sky-400/20 dark:border-sky-500/30 shadow-lg not-prose">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-100 dark:text-slate-300 mb-6 leading-relaxed text-lg">Don't hesitate to reach out to our expert counselors who can provide personalized guidance for your pediatrics specialization career journey.</p>
