...
export const Route = createFileRoute("/cardiology-courses/$city")({
  component: CardiologyCityPage,
});

function CardiologyCityPage() {
  const { city } = useParams({
    from: "/cardiology-courses/$city",
  });
        ...
        <div className="w-full">
          ...
          <div className="space-y-4">
            <CollapsibleFAQ
              ...
              longAnswer={`DMHCA Institute offers premium ${specialty} programs with expert faculty and practical training.`}
            />
          ...
          {/* Removed duplicate 'Courses in this City' section per request */}
