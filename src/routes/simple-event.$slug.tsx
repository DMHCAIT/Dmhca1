      ...
      <div className="bg-background border-b border-border/30">
        <div className="container-x py-3 text-sm">
          <div className="flex items-center gap-2 text-muted-foreground">
            <Link to="/" className="hover:text-navy-deep transition font-medium">
              Home
            </Link>
            <span className="text-border">/</span>
            <Link to="/simple-event" className="hover:text-navy-deep transition font-medium">
              Events
            </Link>
            <span className="text-border">/</span>
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            {event.description && (
              <section>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-4xl font-display font-black text-foreground">About Event</h2>
                </div>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {event.whatYouLearn.map((item, index) => (
                    <div
                      key={index}
                      className="group p-5 bg-gradient-to-br from-blue-50 to-white border-2 border-blue-100 rounded-2xl hover:border-navy-deep hover:shadow-lg transition-all duration-300"
                    >
              ...
              <section>
                ...
                <div className="space-y-4">
                  {event.objectives.map((item, index) => (
                    <div
                      key={index}
                      className="group relative overflow-hidden p-6 bg-white border-2 border-border/50 rounded-2xl hover:border-navy-deep hover:shadow-lg transition-all duration-300"
                    >
            ...
            {event.eventContent && event.eventContent.length > 0 && (
              <section>
                <div className="flex items-center gap-3 mb-8">
                  <div className="w-1.5 h-8 bg-gradient-to-b from-navy-deep to-blue-600 rounded-full"></div>
                  <h2 className="text-4xl font-display font-black text-foreground">Agenda</h2>
                </div>
                <div className="space-y-4">
                  {event.eventContent.map((item, index) => (
                    <div
                      key={index}
                      className="group relative flex gap-5 p-5 bg-white/60 border-l-4 border-navy-deep rounded-xl hover:shadow-sm transition-all duration-200"
                    >
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {event.speakers.map((speaker, index) => (
                    <div
                      key={index}
                      className="group relative overflow-hidden p-6 bg-gradient-to-br from-white to-blue-50 border-2 border-border/50 rounded-2xl hover:border-navy-deep hover:shadow-xl transition-all duration-300"
                    >
                ...
                <div className="relative p-8">
                  <div className="mb-6">
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-yellow-400/20 border border-yellow-400/50 rounded-full mb-4">
                      ...
                      <span className="text-xs font-bold uppercase text-yellow-300">
                        Limited Slots
                      </span>
                    </div>
