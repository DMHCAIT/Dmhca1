  ...
  head: () => ({
    meta: [
      { title: "Fellowship Programs — DMHCA" },
      {
        name: "description",
        content:
          "Advanced clinical fellowships at DMHCA across radiology, cardiology, pulmonology, surgery, and more.",
      },
    ],
  }),
      ...
      <section className="bg-navy-deep text-primary-foreground">
        <div className="container-x py-16">
          ...
          <h1 className="font-display text-4xl md:text-5xl mt-3 max-w-3xl">
            Advanced clinical fellowships for sub-specialty expertise.
          </h1>
          <p className="mt-4 max-w-2xl text-primary-foreground/75">
            A year of structured, case-based mentorship from senior consultants — designed for
            postgraduates ready to deepen their practice.
          </p>
        </div>
      </section>
      <section className="container-x py-14">
        <div className="text-xs text-muted-foreground mb-5">
          {fellowships.length} fellowship programs
        </div>
