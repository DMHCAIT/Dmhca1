...
const blogPosts: Record<string, any> = {
  "how-to-crack-neet-pg": {
    ...
    description:
      "Complete guide to preparing for and cracking NEET PG examination with proven strategies.",
    sections: [
      "What is NEET PG?",
  ...
  "courses-after-mbbs-in-india": {
    ...
    description:
      "Explore all postgraduate and specialization courses available for MBBS graduates in India.",
    sections: [
  ...
  "scope-of-radiology": {
    ...
    description:
      "Comprehensive guide to radiology career, specializations, courses, and opportunities in India.",
    sections: [
      "What is Radiology?",
      "Types of Radiology",
  ...
  "scope-of-cardiology": {
    ...
    description:
      "Detailed exploration of cardiology as a career, courses, specializations, and opportunities in India.",
    sections: [
      "What is Cardiology?",
      "Types of Cardiology",
  ...
  "scope-of-obstetrics-and-gynecology": {
    ...
    description:
      "Complete guide to OB-GYN specialization, career paths, courses, and opportunities in India.",
    sections: [
  ...
  "scope-of-cosmetology": {
    ...
    description:
      "Explore cosmetology as a career, courses, specializations, and opportunities in India.",
    sections: [
      "What is Cosmetology?",
  ...
  "scope-of-paediatrics": {
    ...
    description:
      "Comprehensive guide to pediatrics career, specializations, courses, and opportunities in India.",
    sections: [
      "What is Paediatrics?",
  ...
  "scope-of-oncology": {
    ...
    description:
      "Detailed guide to oncology career, specializations, courses, and opportunities in India.",
    sections: [
      "What is Oncology?",
  ...
  "scope-of-neurology": {
    ...
    description:
      "Comprehensive guide to neurology career, specializations, courses, and opportunities in India.",
    sections: [
      "What is Neurology?",
  ...
  "scope-of-echocardiography": {
    ...
    description:
      "Complete guide to echocardiography career, specializations, and opportunities in India.",
    sections: [
  ...
  "how-to-become-a-radiologist": {
    ...
    description:
      "Step-by-step guide to becoming a radiologist in India with courses and career path.",
    sections: [
  ...
  "how-to-become-a-cardiologist": {
    ...
    description:
      "Complete roadmap to becoming a cardiologist in India with courses and requirements.",
    sections: [
  ...
  "how-to-become-a-cosmetologist": {
    ...
    description:
      "Guide to becoming a cosmetologist in India with courses and career opportunities.",
    sections: [
      "Educational Requirements",
      "MBBS Foundation",
      "MD in Dermatology",
  ...
  "how-to-become-a-neurologist": {
    ...
    description:
      "Complete roadmap to becoming a neurologist in India with courses and requirements.",
    sections: [
  ...
  "how-to-become-a-diabetologist": {
    ...
    description:
      "Guide to becoming a diabetologist in India with courses and career opportunities.",
    sections: [
      "Educational Requirements",
      "MBBS Foundation",
  ...
  "how-to-become-an-embryologist": {
    ...
    description:
      "Guide to becoming an embryologist with courses and career opportunities in India.",
    sections: [
      "Educational Requirements",
      "Bachelor's Degree",
  ...
  "how-to-become-a-pediatrician": {
    ...
    description:
      "Step-by-step guide to becoming a pediatrician in India with courses and requirements.",
    sections: [
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-slate-100 to-slate-50 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900">
      ...
      <section className="site-hero relative overflow-hidden">
        ...
        <div className="container-x relative z-10">
          ...
          <div className="text-xs uppercase tracking-[0.25em] text-navy-deep dark:text-slate-400 gold-rule">
            Medical Blog
          </div>
          <h1 className="font-display text-4xl md:text-5xl text-navy-deep dark:text-slate-100 mt-3">
            {blog.title}
          </h1>
        ...
        <div className="container-x max-w-3xl">
          <div className="prose prose-lg prose-slate dark:prose-invert max-w-none">
            <div className="mb-12 p-8 bg-gradient-to-br from-blue-50 to-slate-50 dark:from-slate-800 dark:to-slate-900 rounded-xl border border-blue-200 dark:border-slate-700 shadow-sm">
              <h2 className="text-2xl font-semibold text-navy-deep dark:text-slate-100 mb-6 not-prose">
                Table of Contents
              </h2>
              <ul className="space-y-3 not-prose">
                {blog.sections.map((section: string, idx: number) => (
                  <li
                    key={idx}
                    className="text-slate-700 dark:text-slate-200 flex items-start gap-3 group hover:bg-white/50 dark:hover:bg-slate-700/50 -mx-2 px-2 py-1 rounded transition"
                  >
                    <span className="text-navy-deep dark:text-gold font-bold flex-shrink-0 w-6">
                      {idx + 1}.
                    </span>
                    <span className="group-hover:text-navy-deep dark:group-hover:text-slate-100 transition">
                      {section}
                    </span>
                  </li>
                ))}
            ...
            <div className="space-y-10 not-prose">
              {blog.sections.map((section: string, idx: number) => (
                <div
                  key={idx}
                  className="pb-8 border-b border-slate-200 dark:border-slate-700 last:border-b-0 last:pb-0"
                >
                  <div className="flex items-start gap-4 mb-4">
                    <div className="flex-shrink-0 w-10 h-10 flex items-center justify-center bg-gradient-to-br from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 rounded-full text-white font-bold text-sm">
                      {idx + 1}
                    </div>
                    <h2 className="text-2xl font-bold text-navy-deep dark:text-slate-100 leading-tight">
                      {section}
                    </h2>
                  </div>
                  <p className="text-slate-600 dark:text-slate-300 leading-relaxed ml-14 text-lg">
                    This section covers important information about {section.toLowerCase()}. To get
                    comprehensive details and start your journey in this field, explore our
                    dedicated courses and resources below.
                  </p>
                </div>
              ))}
            </div>
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-100 dark:text-slate-300 mb-6 leading-relaxed text-lg">
                    Explore our specialized courses and programs designed to help you succeed in
