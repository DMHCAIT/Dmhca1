...
export const Route = createFileRoute("/internal-medicine-courses/")({
  head: () => ({
    meta: [
      { title: "Internal Medicine Courses — DMHCA" },
      {
        name: "description",
        content: "Browse all internal medicine courses, fellowships, and certifications at DMHCA.",
      },
    ],
  }),
...
function SpecialtyCourses() {
  const categorySlug = "medicine";
  const displayName = "Internal Medicine";
