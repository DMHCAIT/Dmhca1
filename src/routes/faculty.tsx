    ...
    <div>
      <section className="border-b border-border bg-secondary/40">
        <div className="container-x py-14">
          ...
          <h1 className="font-display text-4xl md:text-5xl text-navy-deep mt-3 max-w-3xl">
            Taught by practising consultants.
          </h1>
        </div>
      </section>
      <section className="container-x py-14 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {faculty.map((f) => (
          <div key={f.name} className="bg-card border border-border rounded-md p-6">
            <div className="w-14 h-14 rounded-full bg-navy-deep text-primary-foreground font-display text-xl grid place-items-center">
