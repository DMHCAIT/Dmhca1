      ...
      <section className="py-2 sm:py-3 md:py-4 bg-white dark:bg-slate-800 px-4 sm:px-0">
        <div className="container-x flex justify-center">
          <div className="relative overflow-hidden rounded-lg sm:rounded-xl md:rounded-2xl shadow-lg sm:shadow-xl md:shadow-2xl w-full max-w-[992px]">
            <img src="/blog-images/How-to-Become-a-Radiologist.webp" alt="How to Become a Radiologist" className="w-full h-auto aspect-[992/496] object-cover" />
        ...
        <div className="container-x max-w-4xl">
          <div className="prose prose-lg prose-slate dark:prose-invert max-w-none">
            <div className="mb-12 not-prose">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 dark:text-slate-50 mb-6">Path to Radiologist</h2>
              <p className="text-slate-700 dark:text-slate-300 mb-8 text-sm sm:text-base">Becoming a radiologist in India requires a systematic approach combining academic excellence, competitive entrance exams, and clinical experience. This guide outlines the complete pathway to help you navigate your journey into this rewarding medical specialty.</p>
            ...
            <div className="mb-12 not-prose">
              ...
              <div className="bg-gradient-to-r from-indigo-600/95 to-purple-600/95 dark:from-indigo-700 dark:to-purple-700 rounded-lg p-6 text-white">
                <p className="text-sm sm:text-base">Total Duration: <span className="font-bold text-lg">9.5-10.5 years</span></p>
                ...
                <div className="p-4 sm:p-6 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-700/50 dark:to-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg sm:rounded-xl hover:shadow-md transition">
                  <details className="group">
                    <summary className="flex items-start justify-between cursor-pointer font-semibold text-slate-900 dark:text-slate-100 text-sm sm:text-base">
                      <span className="flex-1 text-left pr-4">What is the total time required to become a radiologist?</span>
                    ...
                    <p className="text-slate-700 dark:text-slate-300 mt-3 text-xs sm:text-sm leading-relaxed">Total duration is approximately 9.5-10.5 years. This includes 12th completion, 5.5-year MBBS program, 1-year internship, NEET-PG preparation, and 3-year postgraduate specialization training.</p>
                  </details>
                </div>
                <div className="p-4 sm:p-6 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-700/50 dark:to-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg sm:rounded-xl hover:shadow-md transition">
                  <details className="group">
            ...
            <div className="mt-20 p-10 bg-gradient-to-r from-indigo-600/95 to-purple-600/95 dark:from-indigo-700 dark:to-purple-700 rounded-2xl border border-indigo-400/20 dark:border-indigo-500/30 shadow-lg not-prose">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-100 dark:text-slate-300 mb-6 leading-relaxed text-lg">Don't hesitate to reach out to our expert counselors who can provide personalized guidance for your radiology specialization career journey.</p>
