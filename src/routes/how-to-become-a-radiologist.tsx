...
function BlogPost() {
  ...
  const faqs = [
    {
      question: "What are the eligibility criteria to become a radiologist?",
      answer: "Complete 12th with Physics, Chemistry, Biology, qualify NEET-UG for MBBS, complete 5.5 years of MBBS, one year of internship, then qualify NEET-PG for MD in Radiology."
    },
    {
      question: "How long does it take to become a radiologist?",
      answer: "Total time is 9.5-10.5 years: 5.5 years for MBBS, one year of internship, and 3-4 years for MD in Radiology. Radiology is typically a 3-year specialization without requiring a super-specialty."
    },
    {
      question: "What exams do I need to clear for radiology?",
      answer: "NEET-UG for MBBS admission and NEET-PG after internship for MD in Radiology. Scoring well in these competitive exams with good ranks is essential for radiology seats."
    },
    {
      question: "Is radiology competitive?",
      answer: "Radiology is moderately competitive. You need to score in the top 3-5% in NEET-PG to secure a radiology seat in top institutes. Consistent preparation is important."
    },
    {
      question: "What skills are essential for radiology?",
      answer: "Strong fundamentals in anatomy, understanding of X-ray physics, proficiency with imaging equipment (CT, MRI, Ultrasound), attention to detail, and excellent communication skills for reporting."
    },
    {
      question: "What career options exist after becoming a radiologist?",
      answer: "Work in hospitals, diagnostic centers, private practice, pursue subspecialties like neuroradiology or interventional radiology, teach in medical colleges, or explore international opportunities."
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50">
      ...
      <section className="site-hero relative overflow-hidden">
        ...
        <div className="container-home max-w-5xl relative z-10">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">How to Become a Radiologist</h1>
          <p className="text-white/90 text-xl mb-6 max-w-2xl">Step-by-step guide to becoming a radiologist in India</p>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          ...
          <p className="text-center text-gray-600 text-sm mt-4">Comprehensive guide to pursuing radiology as a medical specialty in India</p>
        </div>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="bg-blue-50 rounded-xl p-6 mb-12 border border-blue-200">
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#step-6" className="text-blue-600 hover:text-blue-700 text-sm">Step 6: Complete MD Radiology</a></li>
                <li><a href="#step-7" className="text-blue-600 hover:text-blue-700 text-sm">Step 7: Specialization (Optional)</a></li>
              </ul>
            </div>
            ...
            <article className="space-y-8">
              <section>
                <h2 className="text-4xl font-bold text-gray-900 mb-6">Path to Becoming a Radiologist</h2>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-green-600 flex-shrink-0 mt-1" />
                        <span>Study from standard radiology textbooks and resources</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-green-600 flex-shrink-0 mt-1" />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-green-600 flex-shrink-0 mt-1" />
                        <span>Secure good rank for radiology seat allocation</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-green-600 flex-shrink-0 mt-1" />
                        <span>Radiology is a moderately competitive specialty</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div id="step-6" className="bg-white rounded-xl p-8 border-l-4 border-blue-600 shadow-md hover:shadow-lg transition">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-gray-900 mb-3">Complete MD Radiology (3 years)</h3>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-green-600 flex-shrink-0 mt-1" />
                      ...
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-green-600 flex-shrink-0 mt-1" />
                        <span>Undergo 3-year intensive training in diagnostic radiology</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-green-600 flex-shrink-0 mt-1" />
                        <span>Gain hands-on experience with imaging equipment</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-green-600 flex-shrink-0 mt-1" />
              ...
              <div id="step-7" className="bg-white rounded-xl p-8 border-l-4 border-blue-600 shadow-md hover:shadow-lg transition">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-gray-900 mb-3">Specialization (Optional)</h3>
                    <p className="text-gray-700 mb-4">After MD, you can pursue super-specialty courses to further advance your career:</p>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-purple-600 flex-shrink-0 mt-1" />
                        <span><strong>DM in Neuroradiology</strong> - Specialize in neuroimaging</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-purple-600 flex-shrink-0 mt-1" />
                        <span><strong>DM in Cardiothoracic Imaging</strong> - Focus on cardiac and thoracic imaging</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle2 size={20} className="text-purple-600 flex-shrink-0 mt-1" />
                        <span><strong>Fellowship in Interventional Radiology</strong> - Pursue minimally invasive procedures</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <section className="bg-white rounded-xl p-8 border border-green-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-gray-700">Start NEET-PG preparation early during MBBS</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="bg-green-100 rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 mt-1">
                      <CheckCircle2 size={16} className="text-green-600" />
                    </div>
                    <p className="text-gray-700">Take interest in radiology during MBBS rotation</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="bg-green-100 rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 mt-1">
                      <CheckCircle2 size={16} className="text-green-600" />
                    </div>
                    <p className="text-gray-700">Develop strong anatomy knowledge</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="bg-green-100 rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 mt-1">
                      <CheckCircle2 size={16} className="text-green-600" />
                    </div>
                    <p className="text-gray-700">Join reputable coaching institutes</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="bg-green-100 rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 mt-1">
                      <CheckCircle2 size={16} className="text-green-600" />
                    </div>
                    <p className="text-gray-700">Practice image interpretation regularly</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="bg-green-100 rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 mt-1">
                      <CheckCircle2 size={16} className="text-green-600" />
                    </div>
                    <p className="text-gray-700">Stay updated with latest imaging technologies</p>
                  </div>
                </div>
              </section>
            </article>
            ...
            <section className="mt-12 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 md:p-12 text-white">
              ...
              <p className="text-white/90 mb-6 text-lg">Need personalized guidance on pursuing radiology? Our experts can help you plan your career path.</p>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              ...
              <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                ...
                <p className="text-sm text-gray-700">Start building your foundation early. Strong fundamentals in science subjects during school will make medical studies easier.</p>
              </div>
            </div>
          </div>
        </div>
