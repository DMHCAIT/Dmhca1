          ...
          <div className="lg:col-span-3">
            ...
            <section className="mt-12">
              <div className="border-t-2 border-gray-200 pt-12">
                ...
                <div className="space-y-4">
                  {faqs.map((faq, index) => (
                    <div key={index} className="bg-white dark:bg-slate-800 rounded-xl overflow-hidden border border-gray-200 dark:border-slate-700 hover:border-green-300 dark:hover:border-slate-500 transition">
                      <button
            ...
            <section className="mt-12">
              <div className="border-t-2 border-gray-200 pt-12">
                ...
                {/* Comment Form */}
                <form onSubmit={handleCommentSubmit} className="mb-10 bg-gradient-to-r from-green-50 to-blue-50 dark:from-slate-800 dark:to-slate-800 p-8 rounded-xl border border-green-200 dark:border-slate-700">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <input
                      ...
                      className="px-4 py-3 border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100 dark:placeholder-slate-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600 dark:focus:ring-green-500 focus:border-transparent"
                      required
                    />
                    <input
                      type="email"
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100 dark:placeholder-slate-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600 dark:focus:ring-green-500 focus:border-transparent mb-4"
                    rows={4}
                    required
                  ></textarea>
                  <button
