...
export const Route = createFileRoute("/scope-of-paediatrics")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Career opportunities and scope in pediatrics and child health specialization.",
      },
    ],
  }),
        ...
        <div className="relative container-x py-4 sm:py-6 md:py-8">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-sm sm:text-base text-white/90 max-w-2xl mb-4 leading-relaxed">
              Explore rewarding careers in child health. Master pediatric care, develop
              subspecialties, and build a fulfilling practice with excellent opportunities in India
              and globally.
            </p>
          </div>
          ...
          <div className="prose prose-lg prose-slate dark:prose-invert max-w-none">
            ...
            <div className="mb-8 sm:mb-10 md:mb-12 p-4 sm:p-6 md:p-8 bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50 dark:from-blue-900/30 dark:via-cyan-900/30 dark:to-teal-900/30 rounded-lg sm:rounded-xl md:rounded-2xl border-2 border-blue-200 dark:border-blue-800/50 not-prose">
              ...
              <p className="text-sm sm:text-base text-blue-800 dark:text-blue-300 mb-6 leading-relaxed">
                Pediatrics is one of the most rewarding medical specialties focusing on child health
                and development. In India, pediatrics offers tremendous scope with expanding
                healthcare infrastructure, government health programs, and excellent private sector
                opportunities.
              </p>
            ...
            <div
              id="section-1"
              className="mb-12 sm:mb-14 md:mb-16 scroll-mt-24 p-4 sm:p-6 md:p-8 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-lg sm:rounded-xl md:rounded-2xl border border-blue-200 dark:border-blue-800 not-prose"
            >
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-900 dark:text-blue-100 mb-3 sm:mb-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-blue-800 dark:text-blue-300">
                      Immunization programs and health screening for children
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-blue-800 dark:text-blue-300">
                      Diagnosis and treatment of childhood acute and chronic diseases
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-blue-800 dark:text-blue-300">
                      Child growth and development assessment and monitoring
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-blue-800 dark:text-blue-300">
                      Parent education and nutritional counseling services
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div
              id="section-2"
              className="mb-12 sm:mb-14 md:mb-16 scroll-mt-24 p-4 sm:p-6 md:p-8 bg-gradient-to-br from-cyan-50 to-teal-50 dark:from-cyan-900/20 dark:to-teal-900/20 rounded-lg sm:rounded-xl md:rounded-2xl border border-cyan-200 dark:border-cyan-800 not-prose"
            >
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-cyan-900 dark:text-cyan-100 mb-3 sm:mb-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-cyan-800 dark:text-cyan-300">
                      Work in government hospitals and medical colleges
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-cyan-800 dark:text-cyan-300">
                      Corporate hospital positions with modern facilities
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-cyan-800 dark:text-cyan-300">
                      Neonatal intensive care unit management and expertise
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-cyan-800 dark:text-cyan-300">
                      Pediatric emergency department and critical care roles
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div
              id="section-3"
              className="mb-12 sm:mb-14 md:mb-16 scroll-mt-24 p-4 sm:p-6 md:p-8 bg-gradient-to-br from-teal-50 to-blue-50 dark:from-teal-900/20 dark:to-blue-900/20 rounded-lg sm:rounded-xl md:rounded-2xl border border-teal-200 dark:border-teal-800 not-prose"
            >
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-teal-900 dark:text-teal-100 mb-3 sm:mb-4">
              ...
              <div className="space-y-3 text-teal-900 dark:text-teal-100 text-sm sm:text-base">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-teal-800 dark:text-teal-300">
                      Establish private pediatric clinics and practice centers
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-teal-800 dark:text-teal-300">
                      Pediatric consultations and specialized care services
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-teal-800 dark:text-teal-300">
                      Flexible practice schedule and regular work hours
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
            ...
            <div
              id="section-4"
              className="mb-12 sm:mb-14 md:mb-16 scroll-mt-24 p-4 sm:p-6 md:p-8 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg sm:rounded-xl md:rounded-2xl border border-blue-200 dark:border-blue-800 not-prose"
            >
              <div className="inline-block px-3 sm:px-4 py-1 bg-blue-100 dark:bg-blue-900/30 border border-blue-300 dark:border-blue-700 rounded-full text-blue-700 dark:text-blue-300 text-xs sm:text-sm font-semibold mb-3 sm:mb-4">
                SECTION 4
              </div>
              ...
              <div className="space-y-3 text-blue-900 dark:text-blue-100 text-sm sm:text-base">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-blue-800 dark:text-blue-300">
                      Neonatal care and intensive neonatal management
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-blue-800 dark:text-blue-300">
                      Cardiac care and congenital heart disease management
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-blue-800 dark:text-blue-300">
                      Kidney and urinary system disease specialization
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-blue-800 dark:text-blue-300">
                      Gastroenterology, neurology, oncology and other specialties
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div
              id="section-5"
              className="mb-12 sm:mb-14 md:mb-16 scroll-mt-24 p-4 sm:p-6 md:p-8 bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-900/20 dark:to-blue-900/20 rounded-lg sm:rounded-xl md:rounded-2xl border border-cyan-200 dark:border-cyan-800 not-prose"
            >
              <div className="inline-block px-3 sm:px-4 py-1 bg-cyan-100 dark:bg-cyan-900/30 border border-cyan-300 dark:border-cyan-700 rounded-full text-cyan-700 dark:text-cyan-300 text-xs sm:text-sm font-semibold mb-3 sm:mb-4">
                SECTION 5
              </div>
              ...
              <div className="space-y-3 text-cyan-900 dark:text-cyan-100 text-sm sm:text-base">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-cyan-800 dark:text-cyan-300">
                      Child health promotion and community health initiatives
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-cyan-800 dark:text-cyan-300">
                      Public health expertise and child health policy work
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-cyan-800 dark:text-cyan-300">
                      International organizations and global health NGOs
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-cyan-800 dark:text-cyan-300">
                      Child health education and health awareness programs
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div
              id="section-6"
              className="mb-12 sm:mb-14 md:mb-16 scroll-mt-24 p-4 sm:p-6 md:p-8 bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-900/20 dark:to-cyan-900/20 rounded-lg sm:rounded-xl md:rounded-2xl border border-teal-200 dark:border-teal-800 not-prose"
            >
              <div className="inline-block px-3 sm:px-4 py-1 bg-teal-100 dark:bg-teal-900/30 border border-teal-300 dark:border-teal-700 rounded-full text-teal-700 dark:text-teal-300 text-xs sm:text-sm font-semibold mb-3 sm:mb-4">
                SECTION 6
              </div>
              ...
              <div className="space-y-3 text-teal-900 dark:text-teal-100 text-sm sm:text-base">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-teal-800 dark:text-teal-300">
                      Clinical research and pediatric medical studies
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-teal-800 dark:text-teal-300">
                      Department leadership and academic positions
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-teal-800 dark:text-teal-300">
                      Publication in medical journals and research advancement
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div
              id="section-7"
              className="mb-12 sm:mb-14 md:mb-16 scroll-mt-24 p-4 sm:p-6 md:p-8 bg-gradient-to-br from-indigo-50 to-teal-50 dark:from-indigo-900/20 dark:to-teal-900/20 rounded-lg sm:rounded-xl md:rounded-2xl border border-indigo-200 dark:border-indigo-800 not-prose"
            >
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-indigo-900 dark:text-indigo-100 mb-3 sm:mb-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-indigo-800 dark:text-indigo-300">
                      High demand for pediatricians in developed countries
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-indigo-800 dark:text-indigo-300">
                      Practice opportunities in USA, UK, Canada, Australia
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-indigo-800 dark:text-indigo-300">
                      International fellowship and advanced training opportunities
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-indigo-800 dark:text-indigo-300">
                      Build international pediatric professional networks
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mb-12 sm:mb-14 md:mb-16 not-prose">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                <div className="p-4 bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-blue-900/30 dark:to-cyan-900/30 border border-blue-200 dark:border-blue-700 rounded-lg">
                  <p className="text-xs sm:text-sm text-blue-700 dark:text-blue-300 font-semibold mb-1">
                    12 to MBBS
                  </p>
                ...
                <div className="p-4 bg-gradient-to-br from-cyan-100 to-teal-100 dark:from-cyan-900/30 dark:to-teal-900/30 border border-cyan-200 dark:border-cyan-700 rounded-lg">
                  <p className="text-xs sm:text-sm text-cyan-700 dark:text-cyan-300 font-semibold mb-1">
                    MBBS to MD Pediatrics
                  </p>
                  <p className="text-2xl sm:text-3xl font-bold text-cyan-900 dark:text-cyan-100">
                    3-4 years
                  </p>
                </div>
                <div className="p-4 bg-gradient-to-br from-teal-100 to-blue-100 dark:from-teal-900/30 dark:to-blue-900/30 border border-teal-200 dark:border-teal-700 rounded-lg">
                  <p className="text-xs sm:text-sm text-teal-700 dark:text-teal-300 font-semibold mb-1">
                    Total Duration
                  </p>
                  <p className="text-2xl sm:text-3xl font-bold text-teal-900 dark:text-teal-100">
                    8.5-9.5 years
                  </p>
                </div>
              </div>
            ...
            <div className="mb-12 sm:mb-14 md:mb-16 not-prose">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                {[
                  {
                    title: "Develop Patience",
                    desc: "Develop patience and understanding with children and their families",
                  },
                  {
                    title: "Stay Updated",
                    desc: "Stay current with pediatric advances and vaccine schedules",
                  },
                  {
                    title: "Clinical Exposure",
                    desc: "Gain diverse clinical exposure in different pediatric settings",
                  },
                  {
                    title: "Learn Programs",
                    desc: "Learn government health programs and public health initiatives",
                  },
                  {
                    title: "Child Health Advocacy",
                    desc: "Advocate for child health and welfare in your practice",
                  },
                  {
                    title: "Specialization",
                    desc: "Consider subspecialization for enhanced career prospects",
                  },
                ].map((tip, i) => (
                  <div
                    key={i}
              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white dark:text-slate-50 mb-3">
                    Ready to Pursue Pediatrics?
                  </h3>
                  <p className="text-slate-100 dark:text-slate-300 mb-6 leading-relaxed text-lg">
                    Explore comprehensive pediatrics programs and build a rewarding career in child
                    health medicine.
                  </p>
                  <Link
                    to="/top-medical-courses"
                    className="inline-flex items-center justify-center px-8 py-3 bg-white hover:bg-gray-100 text-blue-600 font-bold rounded-lg transition shadow-md hover:shadow-lg transform hover:scale-105"
                  >
                    Explore Programs →
                  </Link>
                </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-white dark:bg-slate-800 px-4 sm:px-0">
        <div className="container-x max-w-4xl">
          ...
          <p className="text-slate-600 dark:text-slate-400 mb-8 text-sm sm:text-base">
            Get answers to common questions about pediatrics career opportunities.
          </p>

          <div className="space-y-4 sm:space-y-6">
            {[
              {
                q: "What is the scope of pediatrics in India?",
                a: "Pediatrics has excellent scope in India with expanding healthcare infrastructure, government programs, and private sector growth. Large pediatric population ensures steady demand. Subspecialization opportunities are abundant with increasing parent expectations for specialized care.",
              },
              {
                q: "What are the major pediatric subspecialties?",
                a: "Major subspecialties include Neonatology, Pediatric Cardiology, Nephrology, Gastroenterology, Neurology, and Oncology. Each offers distinct career prospects and specialized practice opportunities with higher earning potential.",
              },
              {
                q: "Is government employment available?",
                a: "Yes, government employment is available in medical colleges, government hospitals, and public health centers. Competitive exams like NEET qualify candidates. Government positions offer job security and pension benefits.",
              },
              {
                q: "What is the earning potential?",
                a: "Government positions: ₹10-15 lakhs/year. Private consultants: ₹20-40 lakhs/year. Private practice: ₹30-50+ lakhs/year. Subspecialists earn significantly more, especially with established practice.",
              },
              {
                q: "Is there private practice scope?",
                a: "Yes, strong private practice scope with growing number of dedicated pediatric clinics. Good work-life balance with scheduled hours. Regular hours suit family-oriented practitioners.",
              },
              {
                q: "Are international opportunities available?",
                a: "Yes, high demand in USA, UK, Canada, and Australia. Indian pediatricians are sought after for their training. International practice offers higher income and advanced infrastructure.",
              },
            ].map((faq, idx) => (
              <div
                key={idx}
          ...
          <div className="mt-10 sm:mt-12 p-4 sm:p-6 md:p-8 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 border-2 border-blue-200 dark:border-blue-800 rounded-lg sm:rounded-xl">
            ...
            <p className="text-sm sm:text-base text-blue-800 dark:text-blue-300 mb-4">
              ...
              guidance for your pediatrics specialization career journey.
            </p>
            <Link
              to="/contact-us"
              className="inline-flex items-center gap-2 px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition text-sm sm:text-base"
            >
              Contact Our Experts →
            </Link>
          </div>
