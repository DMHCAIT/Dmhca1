...
export const Route = createFileRoute("/paediatrics-courses/")({
  head: () => ({
    meta: [
      { title: "Paediatrics Courses — DMHCA" },
      {
        name: "description",
        content: "Browse all paediatrics courses, fellowships, and certifications at DMHCA.",
      },
    ],
  }),
...
function SpecialtyCourses() {
  const categorySlug = "pediatrics";
  const displayName = "Paediatrics";
