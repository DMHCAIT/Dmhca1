            ...
            <div className="mt-20 p-10 bg-gradient-to-r from-violet-600/95 to-indigo-600/95 dark:from-violet-700 dark:to-indigo-700 rounded-2xl border border-violet-400/20 dark:border-violet-500/30 shadow-lg not-prose">
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="text-slate-100 dark:text-slate-300 mb-6 leading-relaxed text-lg">Don't hesitate to reach out to our expert counselors who can provide personalized guidance for your neurology specialization career journey.</p>
