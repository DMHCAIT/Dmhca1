  ...
  return (
    <div className="container-x py-20 grid place-items-center">
      <div className="w-full max-w-md bg-card border border-border rounded-md p-8">
        <div className="text-xs uppercase tracking-[0.25em] text-navy-deep gold-rule">Learner portal</div>
        <h1 className="font-display text-3xl text-navy-deep mt-3">Welcome back.</h1>
        <form onSubmit={(e) => e.preventDefault()} className="mt-6 space-y-4">
          ...
          <button className="w-full px-5 py-3 bg-navy-deep text-primary-foreground text-sm rounded-sm hover:bg-navy">Log in</button>
        </form>
