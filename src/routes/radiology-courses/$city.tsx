...
export const Route = createFileRoute("/radiology-courses/$city")({
  component: RadiologyCityPage,
});

function RadiologyCityPage() {
  const { city } = useParams({
    from: "/radiology-courses/$city",
  });

  const specialty = "radiology";
